...
## Result
![Relative date](https://img.shields.io/date/1747347176?label=Updated)
...
|ab-download-manager|1.5.5|1.6.1|app-web|Compliance mode enabled, was '1.6.1'|
...
|ast-grep|0.36.2|0.38.1|app-devel|Compliance mode enabled, was '0.38.1'|
...
|babl|0.1.112|0.1.114|runtime-imaging|Compliance mode enabled, was '0.1.114'|
...
|boto3|1.20.26|1.38.17|lang-python|Compliance mode enabled, was '1.38.17'|
|botocore|1.34.133|1.38.17|lang-python|Compliance mode enabled, was '1.38.17'|
...
|click|8.1.7|8.2.0|lang-python|Compliance mode enabled, was '8.2.0'|
...
|cython|3.0.10|3.1.0|lang-python|Compliance mode enabled, was '3.1.0'|
|cython-0.29|0.29.36|3.1.0|lang-python|Compliance mode enabled, was '3.1.0'|
|czmq|4.2.0|4.2.1|runtime-common|Compliance mode enabled, was '4.2.1'|
|damo|2.4.7|2.8.0|app-admin|Compliance mode enabled, was '2.8.0'|
...
|dnscontrol|4.18.0|4.20.0|app-network|Compliance mode enabled, was '4.20.0'|
...
|dotnet-sdk-8.0|8.0.403|8.0.409|lang-dotnet|Compliance mode enabled, was '8.0.409'|
...
|dua|2.30.0|2.30.1|app-utils|Compliance mode enabled, was '2.30.1'|
...
|edencommon|2025.03.24.00|2025.05.12.00|runtime-common|Compliance mode enabled, was '2025.05.12.00'|
...
|fastfetch|2.42.0|2.43.0|app-utils|Compliance mode enabled, was '2.43.0'|
...
|fb303|2025.03.24.00|2025.05.12.00|runtime-network|Compliance mode enabled, was '2025.05.12.00'|
|fbthrift|2025.03.10.00|2025.05.12.00|app-network|Compliance mode enabled, was '2025.05.12.00'|
...
|feishin|0.12.6|0.12.7|app-multimedia|Compliance mode enabled, was '0.12.7'|
...
|fizz|2025.03.24.00|2025.05.12.00|app-network|Compliance mode enabled, was '2025.05.12.00'|
...
|folly|2025.03.24.00|2025.05.12.00|runtime-common|Compliance mode enabled, was '2025.05.12.00'|
...
|fractal|11|11.1|desktop-gnome|Compliance mode enabled, was '11.1'|
|frameworkintegration|5.115.0|6.14.0|desktop-kde|Compliance mode enabled, was '6.14.0'|
|freecad|1.0.0|1.0.1|app-creativity|Compliance mode enabled, was '1.0.1'|
...
|gegl-0.4|0.4.58|0.4.62|runtime-imaging|Compliance mode enabled, was '0.4.62'|
...
|google-chrome|136.0.7103.92|136.0.7103.113|app-web|Compliance mode enabled, was '136.0.7103.113'|
...
|gpsd|3.25|3.26|app-scientific|Compliance mode enabled, was '3.26'|
...
|hugo|0.147.2|0.147.3|app-web|Compliance mode enabled, was '0.147.3'|
...
|intel-oneapi-basekit|2025.1.0|2025.1.2|app-devel|Compliance mode enabled, was '2025.1.2'|
...
|jenkins|2.468|2.510|app-admin|Compliance mode enabled, was '2.510'|
...
|jmol|14.30.0|16.3.21|app-scientific|Compliance mode enabled, was '16.3.21'|
...
|kernel-tools|6.14.6|5.19.17|app-admin|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.14.6 -> 5.19.17)|
...
|libguestfs|1.54.1|1.55.11|runtime-virtualization|Compliance mode enabled, was '1.55.11'|
...
|linux+api|6.12.23|6.12.28|core-devel|Compliance mode enabled, was '6.12.28'|
|linux+api+32|6.12.7|6.12.28|runtime-optenv32|Compliance mode enabled, was '6.12.28'|
|linux+kernel|6.14.6|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.14.6 -> 5.19.17)|
...
|linux+kernel+lts|6.12.28|5.10.237|runtime-kernel|Compliance mode enabled, was '5.10.237'<br>Possible downgrade from the current version (6.12.28 -> 5.10.237)|
...
|linux-kernel|6.14.6|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.14.6 -> 5.19.17)|
|linux-kernel-lts|6.12.28|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.12.28 -> 5.19.17)|
|linux-kernel-rc|6.15.0|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.15.0 -> 5.19.17)|
|linux-kernel-retro|5.10.204|5.10.237|runtime-kernel|Compliance mode enabled, was '5.10.237'|
|linux-kernel-retro-minimal|5.15.17|5.10.237|runtime-kernel|Compliance mode enabled, was '5.10.237'<br>Possible downgrade from the current version (5.15.17 -> 5.10.237)|
...
|llama.cpp|5298|5400|runtime-creativity|Compliance mode enabled, was '5400'|
...
|llvm-20|20.1.4|20.1.5|app-devel|Compliance mode enabled, was '20.1.5'|
...
|mihomo|1.19.7|1.19.8|app-network|Compliance mode enabled, was '1.19.8'|
...
|mise|2025.2.8|2025.5.5|app-devel|Compliance mode enabled, was '2025.5.5'|
...
|mupdf|1.24.10|1.26.0|app-doc|Compliance mode enabled, was '1.26.0'|
...
|mvfst|2025.03.24.00|2025.05.12.00|runtime-network|Compliance mode enabled, was '2025.05.12.00'|
...
|ncurses|6.4|6.5+20250510|runtime-common|Compliance mode enabled, was '6.5-20250510'|
|ncurses+32|6.4|6.5+20250510|runtime-optenv32|Compliance mode enabled, was '6.5-20250510'|
...
|oma|1.17.2|1.17.3|app-admin|Compliance mode enabled, was '1.17.3'|
...
|openjdk-8|8u452-ga|8u462-b02|groups||
...
|pcsx2|1.6.0<br>+git20210825|2.3.348|app-games|Compliance mode enabled, was '2.3.348'|
...
|pmbootstrap|3.3.2|3.4.0|app-utils|Compliance mode enabled, was '3.4.0'|
...
|podman|5.4.2|5.5.0|app-containers||
|podofo|0.10.3|0.10.4|runtime-doc|Compliance mode enabled, was '0.10.4'|
|poedit|3.4.1|3.6.2-oss|app-i18n|Compliance mode enabled, was '3.6.2-oss'|
...
|qpwgraph|0.9.0|0.9.1|app-multimedia|Compliance mode enabled, was '0.9.1'|
...
|s-tui|1.1.6|1.2.0|app-utils|Compliance mode enabled, was '1.2.0'|
...
|setuptools-python2|44.1.0|80.7.1|lang-python|Compliance mode enabled, was '80.7.1'|
|setuptools-python3|75.8.0|80.7.1|lang-python|Compliance mode enabled, was '80.7.1'|
...
|shadowsocks-rust|1.23.3|1.23.4|app-network|Compliance mode enabled, was '1.23.4'|
...
|soci|4.0.1|4.1.1|runtime-database|Compliance mode enabled, was '4.1.1'|
...
|teams-for-linux|1.13.0|2.0.13|app-web|Compliance mode enabled, was '2.0.13'|
...
|thunderbird|138.0|138.0.1|app-web|Compliance mode enabled, was '138.0.1'|
...
|tornado|6.4.1|6.5|lang-python|Compliance mode enabled, was '6.5'|
...
|uv|0.7.3|0.7.4|lang-python|Compliance mode enabled, was '0.7.4'|
|v2ray-rules-dat|202501302211|202505142211|runtime-data|Compliance mode enabled, was '202505142211'<br>Versions not comparable: `202501302211` and `202505142211`|
...
|vim|9.1.1343|9.1.1393|app-editors|Compliance mode enabled, was '9.1.1393'|
...
|vpl-gpu-rt|25.2.1|25.2.2|runtime-multimedia|Compliance mode enabled, was '25.2.2'|
...
|xdg-desktop-portal|1.20.0|1.20.1|app-admin|Compliance mode enabled, was '1.20.1'|
...
|zed|0.185.12|0.186.9|app-editors|Compliance mode enabled, was '0.186.9'|
...
|zfs|2.3.1|2.3.99|app-admin|Compliance mode enabled, was '2.3.99'|
