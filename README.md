...
## Result
![Relative date](https://img.shields.io/date/1773999194?label=Updated)
...
|boto3|1.42.54|1.42.72|lang-python|Compliance mode enabled, was '1.42.72'|
|botocore|1.42.54|1.42.72|lang-python|Compliance mode enabled, was '1.42.72'|
...
|crush|0.29.1|0.51.1|app-utils|Compliance mode enabled, was '0.51.1'|
...
|epiphany|49.2|50.1|desktop-gnome|Compliance mode enabled, was '50.1'|
...
|jaraco.context|6.0.1|6.1.1|lang-python|Compliance mode enabled, was '6.1.1'|
...
|jmol|14.30.0|16.3.51|app-scientific|Compliance mode enabled, was '16.3.51'|
...
|kitty|0.45.0|0.46.1|app-utils|Compliance mode enabled, was '0.46.1'|
...
|llama.cpp|8400|8429|runtime-creativity|Compliance mode enabled, was '8429'|
...
|oma|1.25.0|1.24.4|app-admin|Compliance mode enabled, was '1.24.4'<br>Possible downgrade from the current version (1.25.0 -> 1.24.4)|
...
|pbs-installer|2026.2.11|2026.3.10|lang-python|Compliance mode enabled, was '2026.3.10'|
...
|pcsx2|2.7.181|2.7.196|app-games||
...
|perl-xml-parser|2.44|2.49|lang-perl|Compliance mode enabled, was '2.49'|
...
|pipx|1.8.0|1.10.0|lang-python|Compliance mode enabled, was '1.10.0'|
...
|python-protobuf|6.32.1|7.34.0|lang-python|Compliance mode enabled, was '7.34.0'|
...
|rocm-llama-cpp|7.0.1|8429|runtime-rocm|Compliance mode enabled, was '8429'|
...
|snapd|2.74.1|2.75|app-admin|Compliance mode enabled, was '2.75'|
...
|v2ray-rules-dat|202601042214|202603192222|runtime-data|Compliance mode enabled, was '202603192222'<br>Versions not comparable: `202601042214` and `202603192222`|
...
|zen-browser|1.19.2~beta|1.12.10b|app-web|Compliance mode enabled, was '1.12.10b'<br>Possible downgrade from the current version (1.19.2~beta -> 1.12.10b)|
