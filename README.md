...
## Result
![Relative date](https://img.shields.io/date/1760984218?label=Updated)
...
|bash-pinyin-completion-rs|0.3.2|1.0.0|app-shells|Compliance mode enabled, was '1.0.0'|
|basket-trinity|14.1.2|14.1.4|desktop-trinity|Compliance mode enabled, was '14.1.4'|
|bat|0.25.0|0.26.0|app-utils|Compliance mode enabled, was '0.26.0'|
...
|code-server|4.93.1|4.105.0|app-utils|Compliance mode enabled, was '4.105.0'|
...
|devscripts|2.24.5|2.25.20|app-devel|Compliance mode enabled, was '2.25.20'|
...
|dotnet|8.0.403|8.0.415|lang-dotnet|Compliance mode enabled, was '8.0.415'|
...
|edencommon|2025.09.01.00|2025.10.13.00|runtime-common|Compliance mode enabled, was '2025.10.13.00'|
...
|lact|0.8.1|0.8.2|app-admin|Compliance mode enabled, was '0.8.2'|
...
|libevdev|1.13.4|1.13.5|runtime-devices|Compliance mode enabled, was '1.13.5'|
...
|libreoffice|25.8.0.4|25.8.2.2|app-productivity|Compliance mode enabled, was '25.8.2.2'|
...
|llama.cpp|6615|6808|runtime-creativity|Compliance mode enabled, was '6808'|
...
|numix-icon-theme|25.10.04.2|25.10.17.2|desktop-themes|Compliance mode enabled, was '25.10.17.2'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.236|app-games|Compliance mode enabled, was '2.5.236'|
...
|rocm-llama-cpp|7.0.1|6808|runtime-rocm|Compliance mode enabled, was '6808'|
...
|stalonetray|0.8.4|1.0.0|desktop-wm|Compliance mode enabled, was '1.0.0'|
...
|v2ray-rules-dat|202510042211|202510192212|runtime-data|Compliance mode enabled, was '202510192212'<br>Versions not comparable: `202510042211` and `202510192212`|
...
|wangle|2025.09.01.00|2025.10.13.00|runtime-network|Compliance mode enabled, was '2025.10.13.00'|
|warpinator|1.6.3|1.8.10|desktop-cinnamon|Compliance mode enabled, was '1.8.10'|
|warzone2100|4.5.5|4.6.1|app-games||
|watchman|2025.09.01.00|2025.10.13.00|app-utils|Compliance mode enabled, was '2025.10.13.00'|
...
|wine|10.16|10.17|app-emulation||
...
|xfsprogs|6.16.0|6.17.0|app-admin|Compliance mode enabled, was '6.17.0'|
...
|xterm|390|403|app-utils|Compliance mode enabled, was '403'|
...
|zed|0.207.4|0.208.5|app-editors|Compliance mode enabled, was '0.208.5'|
