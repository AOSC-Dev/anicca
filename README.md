...
## Result
![Relative date](https://img.shields.io/date/1758242735?label=Updated)
...
|bcachefs-tools|1.9.4|1.31.1|app-admin|Compliance mode enabled, was '1.31.1'|
...
|boto3|1.40.25|1.40.34|lang-python|Compliance mode enabled, was '1.40.34'|
|botocore|1.40.25|1.40.34|lang-python|Compliance mode enabled, was '1.40.34'|
...
|chromium|135.0.7049.95|140.0.7339.185|app-web|Compliance mode enabled, was '140.0.7339.185'|
...
|cinnamon|5.8.3|6.4.12|groups|Compliance mode enabled, was '6.4.12'|
...
|code-server|4.93.1|4.104.0|app-utils|Compliance mode enabled, was '4.104.0'|
...
|dart-sass-js|1.89.2|1.92.1|app-devel|Compliance mode enabled, was '1.92.1'|
...
|element-desktop|1.11.111|1.11.112|app-web|Compliance mode enabled, was '1.11.112'|
...
|expat|2.7.0|2.7.2|runtime-common|Compliance mode enabled, was '2.7.2'|
|expat+32|2.6.2|2.7.2|runtime-optenv32|Compliance mode enabled, was '2.7.2'|
...
|eza|0.23.1|0.23.3|app-utils|Compliance mode enabled, was '0.23.3'|
...
|fish|4.0.6|4.0.8|app-shells|Compliance mode enabled, was '4.0.8'|
...
|forgejo|11.0.0|12.0.3|app-web|Compliance mode enabled, was '12.0.3'|
...
|gdk-pixbuf|2.42.12|2.44.1|runtime-imaging|Compliance mode enabled, was '2.44.1'|
|gdk-pixbuf+32|2.42.12|2.44.1|runtime-optenv32|Compliance mode enabled, was '2.44.1'|
...
|ghostty|1.1.2|1.2.0|app-utils|Compliance mode enabled, was '1.2.0'|
...
|gnome-mahjongg|3.38.3|49.0|desktop-gnome|Compliance mode enabled, was '49.0'|
...
|google-api-python-client|1.7.11|2.182.0|lang-python|Compliance mode enabled, was '2.182.0'|
...
|google-chrome|140.0.7339.127|140.0.7339.185|app-web|Compliance mode enabled, was '140.0.7339.185'|
...
|gst-plugins-rs|0.14.1|0.14.2|runtime-multimedia|Compliance mode enabled, was '0.14.2'|
...
|hugo|0.149.0|0.150.0|app-web|Compliance mode enabled, was '0.150.0'|
...
|hypothesis-python|6.97.4|6.139.2|lang-python|Compliance mode enabled, was '6.139.2'|
...
|iosevka-fonts|33.2.9|33.3.0|desktop-fonts|Compliance mode enabled, was '33.3.0'|
...
|json-glib|1.8.0|1.10.8|runtime-common|Compliance mode enabled, was '1.10.8'|
...
|kernel-tools|6.16.7|5.19.17|app-admin|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.16.7 -> 5.19.17)|
...
|linux+kernel|6.16.7|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.16.7 -> 5.19.17)|
...
|llama.cpp|5298|6517|runtime-creativity|Compliance mode enabled, was '6517'|
...
|lxgwcleargothic-font|0.503|0.505|desktop-fonts|Compliance mode enabled, was '0.505'|
|lxgwneoxihei-font|1.218.1|1.220|desktop-fonts|Compliance mode enabled, was '1.220'|
|lximage-qt|1.4.0|2.2.0|desktop-lxqt|Compliance mode enabled, was '2.2.0'|
|lxml|6.0.0|6.0.1|lang-python|Compliance mode enabled, was '6.0.1'|
...
|mesa|25.1.6|25.2.3|runtime-display||
...
|mise|2025.8.9|2025.9.12|app-devel|Compliance mode enabled, was '2025.9.12'|
...
|netbird|0.55.1|0.57.1|app-network|Compliance mode enabled, was '0.57.1'|
...
|openai-python|1.63.2|1.108.0|lang-python|Compliance mode enabled, was '1.108.0'|
...
|orca|42.3|49.0|desktop-gnome|Compliance mode enabled, was '49.0'|
...
|passt|2024_10_30.ee7d0b6|2025_09_11.6cbcccc|app-network||
...
|pavucontrol|6.1|6.2|app-multimedia|Compliance mode enabled, was '6.2'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.163|app-games|Compliance mode enabled, was '2.5.163'|
...
|praat|6.4.42|6.4.43|app-scientific|Compliance mode enabled, was '6.4.43'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20250911|lang-python|Compliance mode enabled, was '1.0.2.20250911'|
...
|pypsutil|5.8.0|7.1.0|lang-python|Compliance mode enabled, was '7.1.0'|
...
|q|0.19.8|0.19.9|app-network|Compliance mode enabled, was '0.19.9'|
...
|rdflib|6.2.0|7.2.0|lang-python|Compliance mode enabled, was '7.2.0'|
...
|rocm-llama-cpp|6.4.3|6517|runtime-rocm|Compliance mode enabled, was '6517'|
...
|sarasa-gothic-fonts|1.0.32|1.0.33|desktop-fonts|Compliance mode enabled, was '1.0.33'|
...
|teams-for-linux|1.13.0|2.5.7|app-web|Compliance mode enabled, was '2.5.7'|
...
|tree-sitter|0.25.3|0.25.9|groups|Compliance mode enabled, was '0.25.9'|
...
|uv|0.8.16|0.8.18|lang-python|Compliance mode enabled, was '0.8.18'|
|v2ray|5.37.0|5.39.0|app-proxy|Compliance mode enabled, was '5.39.0'|
|v2ray-rules-dat|202508312212|202509172211|runtime-data|Compliance mode enabled, was '202509172211'<br>Versions not comparable: `202508312212` and `202509172211`|
...
|vim|9.1.1766|9.1.1775|app-editors|Compliance mode enabled, was '9.1.1775'|
...
|vscode|1.104.0|1.104.1|app-editors|Compliance mode enabled, was '1.104.1'|
...
|yaru|25.10.1|25.10.2-0ubuntu1|desktop-themes|Compliance mode enabled, was '25.10.2-0ubuntu1'|
...
|zed|0.203.5|0.204.1|app-editors|Compliance mode enabled, was '0.204.1'|
|zellij|0.42.2|0.43.1|app-utils|Compliance mode enabled, was '0.43.1'|
|zenity|4.0.5|4.2.0|desktop-gnome|Compliance mode enabled, was '4.2.0'|
...
|zope-interface|7.2|8.0|lang-python|Compliance mode enabled, was '8.0'|
|zotero|7.0.24|7.0.25|app-productivity|Compliance mode enabled, was '7.0.25'|
