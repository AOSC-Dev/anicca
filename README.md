...
## Result
![Relative date](https://img.shields.io/date/1763547221?label=Updated)
...
|aosc-os-repository-data|20251115|20251119|runtime-data|Compliance mode enabled, was '20251119'|
...
|boto3|1.40.25|1.40.76|lang-python|Compliance mode enabled, was '1.40.76'|
|botocore|1.40.25|1.40.76|lang-python|Compliance mode enabled, was '1.40.76'|
...
|box64|0.3.9<br>+git20251113|0.3.8|app-emulation|Compliance mode enabled, was '0.3.8'<br>Possible downgrade from the current version (0.3.9+git20251113 -> 0.3.8)|
...
|cmake|3.31.6|4.1.3|app-devel|Compliance mode enabled, was '4.1.3'|
...
|crush|0.17.0|0.18.2|app-utils|Compliance mode enabled, was '0.18.2'|
...
|devscripts|2.25.20|2.25.25|app-devel|Compliance mode enabled, was '2.25.25'|
...
|discord|0.0.114|0.0.115|app-web|Compliance mode enabled, was '0.0.115'|
...
|gimp|3.0.4|3.2.0|app-creativity|Compliance mode enabled, was '3.2.0'|
...
|intel-ucode|20250812|20251111|runtime-data|Compliance mode enabled, was '20251111'|
...
|llama.cpp|6670|7100|runtime-creativity|Compliance mode enabled, was '7100'|
...
|maturin|1.9.6|1.10.1|lang-python|Compliance mode enabled, was '1.10.1'|
...
|netbird|0.59.7|0.60.0|app-network|Compliance mode enabled, was '0.60.0'|
...
|networkmanager|1.54.1|1.54.2|app-network|Compliance mode enabled, was '1.54.2'|
...
|pcp|6.0.1|7.0.3|app-utils|Compliance mode enabled, was '7.0.3'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.310|app-games|Compliance mode enabled, was '2.5.310'|
...
|rocm-llama-cpp|7.0.1|7100|runtime-rocm|Compliance mode enabled, was '7100'|
...
|thunderbird|144.0|145.0|app-web|Compliance mode enabled, was '145.0'|
...
|vscode|1.106.0|1.106.1|app-editors|Compliance mode enabled, was '1.106.1'|
...
|zed|0.212.3|0.212.7|app-editors|Compliance mode enabled, was '0.212.7'|
