...
## Result
![Relative date](https://img.shields.io/date/1755929804?label=Updated)
...
|apicula|0.14|0.22|app-electronics|Compliance mode enabled, was '0.22'|
...
|apt|3.0.2|3.1.4|app-admin|Compliance mode enabled, was '3.1.4'|
...
|bitwarden|2025.7.0|2025.8.0|app-utils|Compliance mode enabled, was '2025.8.0'|
...
|boto3|1.20.26|1.40.16|lang-python|Compliance mode enabled, was '1.40.16'|
|botocore|1.34.133|1.40.16|lang-python|Compliance mode enabled, was '1.40.16'|
...
|bulky|3.4|3.8|desktop-cinnamon|Compliance mode enabled, was '3.8'|
...
|caddy|2.10.0|2.10.2|app-web|Compliance mode enabled, was '2.10.2'|
...
|catch2|3.8.1|3.9.1|runtime-common|Compliance mode enabled, was '3.9.1'|
...
|chromium|135.0.7049.95|139.0.7258.138|app-web|Compliance mode enabled, was '139.0.7258.138'|
...
|damo|2.4.7|2.9.3|app-admin|Compliance mode enabled, was '2.9.3'|
...
|edencommon|2025.03.24.00|2025.08.18.00|runtime-common|Compliance mode enabled, was '2025.08.18.00'|
...
|fb303|2025.03.24.00|2025.08.18.00|runtime-network|Compliance mode enabled, was '2025.08.18.00'|
|fbthrift|2025.03.10.00|2025.08.18.00|app-network|Compliance mode enabled, was '2025.08.18.00'|
...
|fizz|2025.03.24.00|2025.08.18.00|app-network|Compliance mode enabled, was '2025.08.18.00'|
...
|folly|2025.03.24.00|2025.08.18.00|runtime-common|Compliance mode enabled, was '2025.08.18.00'|
...
|gmic|3.2.6|3.6.0|runtime-imaging|Compliance mode enabled, was '3.6.0'|
...
|google-api-python-client|1.7.11|2.179.0|lang-python|Compliance mode enabled, was '2.179.0'|
...
|harfbuzz|8.4.0|11.4.2|runtime-desktop|Compliance mode enabled, was '11.4.2'|
|harfbuzz+32|8.4.0|11.4.2|runtime-optenv32|Compliance mode enabled, was '11.4.2'|
|haruna|0.12.3|1.4.0|desktop-kde|Compliance mode enabled, was '1.4.0'|
|hashcat|6.2.6|7.1.1|app-penetration|Compliance mode enabled, was '7.1.1'|
...
|hmcl|3.6.15|3.6.16|app-games|Compliance mode enabled, was '3.6.16'|
...
|hypothesis-python|6.97.4|6.138.2|lang-python|Compliance mode enabled, was '6.138.2'|
...
|ibus-chewing|1.6.1|2.1.5|app-i18n|Compliance mode enabled, was '2.1.5'|
...
|imagemagick|6.9.13<br>+16|6.9.13+27|app-utils|Compliance mode enabled, was '6.9.13-27'|
|imagemagick+7|7.1.1<br>+32|7.1.2+1|app-utils|Compliance mode enabled, was '7.1.2-1'|
...
|intel-compute-runtime|25.27.34303.5|25.31.34666.3|runtime-scientific|Compliance mode enabled, was '25.31.34666.3'|
|intel-media-driver|25.2.6|25.3.1|runtime-multimedia|Compliance mode enabled, was '25.3.1'|
|intel-oneapi-basekit|2025.2.0|2025.2.1|app-devel|Compliance mode enabled, was '2025.2.1'|
...
|kea|2.6.3|3.1.0|app-network|Compliance mode enabled, was '3.1.0'|
...
|libchewing|0.5.1|0.10.2|runtime-i18n|Compliance mode enabled, was '0.10.2'|
...
|libxfce4ui|4.20.1|4.20.2|desktop-xfce|Compliance mode enabled, was '4.20.2'|
|libxfce4windowing|4.20.3|4.20.4|desktop-xfce|Compliance mode enabled, was '4.20.4'|
...
|llama.cpp|5298|6250|runtime-creativity|Compliance mode enabled, was '6250'|
...
|lychee|0.18.1|0.20.0|app-web|Compliance mode enabled, was '0.20.0'|
...
|maturin|1.8.1|1.9.3|lang-python|Compliance mode enabled, was '1.9.3'|
...
|ncurses|6.4|6.5+20250816|runtime-common|Compliance mode enabled, was '6.5-20250816'|
|ncurses+32|6.4|6.5+20250816|runtime-optenv32|Compliance mode enabled, was '6.5-20250816'|
...
|networkmanager-openvpn|1.8.12|1.12.2|app-network|Compliance mode enabled, was '1.12.2'|
...
|nuclei|3.4.2|3.4.9|app-utils|Compliance mode enabled, was '3.4.9'|
...
|oma|1.20.0|1.20.0-ci-test11|app-admin|Compliance mode enabled, was '1.20.0-ci-test11'<br>Possible downgrade from the current version (1.20.0 -> 1.20.0-ci-test11)|
...
|oolite|1.90|1.91.0.7693-250822-f90d84a|app-games|Compliance mode enabled, was '1.91.0.7693-250822-f90d84a'|
...
|orage|4.20.1|4.20.2|desktop-xfce|Compliance mode enabled, was '4.20.2'|
...
|osu-lazer|2025.724.0|2025.822.0-tachyon|app-games|Compliance mode enabled, was '2025.822.0-tachyon'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.120|app-games|Compliance mode enabled, was '2.5.120'|
...
|qemu|9.2.2|10.0.3|app-virtualization|Compliance mode enabled, was '10.0.3'|
...
|rocm-llama-cpp|6.4.3|6250|runtime-rocm|Compliance mode enabled, was '6250'|
...
|svt-av1|3.1.0|3.1.1|runtime-multimedia|Compliance mode enabled, was '3.1.1'|
...
|syncthing|1.30.0|2.0.3|app-network|Compliance mode enabled, was '2.0.3'|
...
|teams-for-linux|1.13.0|2.3.0|app-web|Compliance mode enabled, was '2.3.0'|
...
|timeshift|24.06.6|25.07.5|app-utils|Compliance mode enabled, was '25.07.5'|
...
|trove-classifiers|2024.1.31|2025.8.6.13|lang-python|Compliance mode enabled, was '2025.8.6.13'|
...
|v2ray-rules-dat|202501302211|202508222213|runtime-data|Compliance mode enabled, was '202508222213'<br>Versions not comparable: `202501302211` and `202508222213`|
...
|vim|9.1.1623|9.1.1665|app-editors|Compliance mode enabled, was '9.1.1665'|
...
|wangle|2025.03.24.00|2025.08.18.00|runtime-network|Compliance mode enabled, was '2025.08.18.00'|
|warpinator|1.6.3|1.8.10|desktop-cinnamon|Compliance mode enabled, was '1.8.10'|
|watchman|2025.03.24.00|2025.08.18.00|groups|Compliance mode enabled, was '2025.08.18.00'|
...
|xreader|4.2.2|4.2.9|app-doc|Compliance mode enabled, was '4.2.9'|
...
|xviewer|3.4.6|3.4.11|app-imaging|Compliance mode enabled, was '3.4.11'|
...
|yt-dlp|2025.08.20|2025.08.22|app-multimedia|Compliance mode enabled, was '2025.08.22'|
