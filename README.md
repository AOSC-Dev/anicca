...
## Result
![Relative date](https://img.shields.io/date/1761325976?label=Updated)
...
|autobuild4|4.12.13|4.12.16|app-devel|Compliance mode enabled, was '4.12.16'|
...
|boto3|1.40.25|1.40.58|lang-python|Compliance mode enabled, was '1.40.58'|
|botocore|1.40.25|1.40.58|lang-python|Compliance mode enabled, was '1.40.58'|
...
|copyq|12.0.1|13.0.0|app-utils|Compliance mode enabled, was '13.0.0'|
...
|crush|0.11.1|0.12.2|app-utils|Compliance mode enabled, was '0.12.2'|
...
|feishin|0.20.1|0.21.2|app-multimedia|Compliance mode enabled, was '0.21.2'|
...
|graphviz|14.0.1|14.0.2|app-doc|Compliance mode enabled, was '14.0.2'|
...
|hugo|0.151.0|0.152.1|app-web|Compliance mode enabled, was '0.152.1'|
...
|hypothesis-python|6.97.4|6.142.3|lang-python|Compliance mode enabled, was '6.142.3'|
...
|libdecor|0.2.3|0.2.4|runtime-desktop|Compliance mode enabled, was '0.2.4'|
...
|llama.cpp|6615|6833|runtime-creativity|Compliance mode enabled, was '6833'|
...
|mise|2025.8.9|2025.10.16|app-devel|Compliance mode enabled, was '2025.10.16'|
...
|openssh|10.0p1|10.2p1|app-network|Compliance mode enabled, was '10.2p1'|
...
|osu-lazer|2025.816.0-lazer|2025.1022.0-tachyon|app-games||
...
|pcsx2|1.6.0<br>+git20210825|2.5.246|app-games|Compliance mode enabled, was '2.5.246'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20251018|lang-python|Compliance mode enabled, was '1.0.2.20251018'|
...
|qutebrowser|3.5.1|3.6.0|app-web||
...
|rocm-llama-cpp|7.0.1|6833|runtime-rocm|Compliance mode enabled, was '6833'|
...
|tailscale|1.88.3|1.90.1|app-network|Compliance mode enabled, was '1.90.1'|
...
|usage|2.2.2|2.4.0|app-utils|Compliance mode enabled, was '2.4.0'|
...
|v2ray-rules-dat|202510042211|202510232213|runtime-data|Compliance mode enabled, was '202510232213'<br>Versions not comparable: `202510042211` and `202510232213`|
...
|vim|9.1.1837|9.1.1868|app-editors|Compliance mode enabled, was '9.1.1868'|
...
|vulkan-extensionlayer|1.4.328.1|1.4.329|runtime-display|Compliance mode enabled, was '1.4.329'|
|vulkan-headers|1.4.328.1|1.4.329|runtime-display|Compliance mode enabled, was '1.4.329'|
|vulkan-headers+32|1.4.328.1|1.4.329|runtime-optenv32|Compliance mode enabled, was '1.4.329'|
|vulkan-loader|1.4.328.1|1.4.329|runtime-display|Compliance mode enabled, was '1.4.329'|
|vulkan-loader+32|1.4.328.1|1.4.329|runtime-optenv32|Compliance mode enabled, was '1.4.329'|
...
|vulkan-utility-libraries|1.4.328.1|1.4.329|runtime-display|Compliance mode enabled, was '1.4.329'|
|vulkan-validationlayers|1.4.328.1|1.4.329|runtime-display|Compliance mode enabled, was '1.4.329'|
...
|yt-dlp|2025.10.14|2025.10.22|app-multimedia|Compliance mode enabled, was '2025.10.22'|
...
|zed|0.207.4|0.209.5|app-editors|Compliance mode enabled, was '0.209.5'|
...
|zig|0.14.1|0.15.2|lang-ziglang|Compliance mode enabled, was '0.15.2'|
...
|zvm|0.8.8|0.8.10|lang-ziglang|Compliance mode enabled, was '0.8.10'|
