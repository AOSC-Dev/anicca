...
## Result
![Relative date](https://img.shields.io/date/1787354160?label=Updated)
...
|acbs|20260729|20260821|app-devel|Compliance mode enabled, was '20260821'|
...
|boto3|1.43.62|1.43.78|lang-python|Compliance mode enabled, was '1.43.78'|
|botocore|1.43.62|1.43.78|lang-python|Compliance mode enabled, was '1.43.78'|
...
|camlp5|8.05.02|6023|lang-ocaml|Compliance mode enabled, was '6023'|
...
|httrack|3.49.2|3.49.23|app-web|Compliance mode enabled, was '3.49.23'|
...
|libreoffice|26.8.0.1|26.8.0.3|groups|Compliance mode enabled, was '26.8.0.3'|
...
|llama.cpp|10453|0.2.0|runtime-creativity|Compliance mode enabled, was '0.2.0'<br>Possible downgrade from the current version (10453 -> 0.2.0)|
...
|localsend|1.17.0|1.18.2|app-network|Compliance mode enabled, was '1.18.2'|
...
|netbird|0.68.1|0.77.1|app-network|Compliance mode enabled, was '0.77.1'|
...
|pcsx2|2.7.181|2.7.524|app-games||
...
|reasonix|1.17.21|1.31.2|app-vibe|Compliance mode enabled, was '1.31.2'|
...
|rocm-llama-cpp|7.0.1|0.2.0|runtime-rocm|Compliance mode enabled, was '0.2.0'<br>Possible downgrade from the current version (7.0.1 -> 0.2.0)|
...
|v2ray-rules-dat|202601042214|202608212217|runtime-data|Compliance mode enabled, was '202608212217'<br>Versions not comparable: `202601042214` and `202608212217`|
...
|vim|9.2.0976|9.2.0993|app-editors|Compliance mode enabled, was '9.2.0993'|
