...
## Result
![Relative date](https://img.shields.io/date/1788931753?label=Updated)
...
|ab-download-manager|1.10.2|1.10.4|app-web|Compliance mode enabled, was '1.10.4'|
...
|aria2-next|2.5.5|2.7.4|app-web|Compliance mode enabled, was '2.7.4'|
...
|ast-serialize|0.8.0|0.11.0|lang-python|Compliance mode enabled, was '0.11.0'|
...
|autobuild4|4.22.0|4.22.2|app-devel|Compliance mode enabled, was '4.22.2'|
...
|bleachbit|6.0.3|6.0.4|app-utils|Compliance mode enabled, was '6.0.4'|
...
|boto3|1.43.62|1.43.90|lang-python|Compliance mode enabled, was '1.43.90'|
|botocore|1.43.62|1.43.90|lang-python|Compliance mode enabled, was '1.43.90'|
...
|chromium|148.0.7778.180|153.0.8010.36|app-web|Compliance mode enabled, was '153.0.8010.36'|
...
|code-server|4.107.0|4.136.2|app-utils|Compliance mode enabled, was '4.136.2'|
...
|croc|10.4.3|11.5.1|app-utils|Compliance mode enabled, was '11.5.1'|
...
|dank-greeter|1.6.0|1.6.1|desktop-displaymanagers|Compliance mode enabled, was '1.6.1'|
|dankcalendar|1.6.0|1.6.1|app-utils|Compliance mode enabled, was '1.6.1'|
|dankmaterialshell|1.6.0|1.6.1|runtime-desktop|Compliance mode enabled, was '1.6.1'|
...
|dnscontrol|4.41.0|5.0.4|app-network|Compliance mode enabled, was '5.0.4'|
...
|dotnet-runtime-8.0|8.0.30|8.0.31|lang-dotnet|Compliance mode enabled, was '8.0.31'|
|dotnet-runtime-deps-8.0|8.0.30|8.0.31|lang-dotnet|Compliance mode enabled, was '8.0.31'|
|dotnet-sdk-8.0|8.0.424|8.0.425|lang-dotnet|Compliance mode enabled, was '8.0.425'|
...
|dotnet8|8.0.424|8.0.425|lang-dotnet|Compliance mode enabled, was '8.0.425'|
...
|dpkg|1.23.5|1.23.10|app-admin|Compliance mode enabled, was '1.23.10'|
...
|fish|4.9.2|4.9.3|app-shells|Compliance mode enabled, was '4.9.3'|
...
|glab|1.102.0|1.117.0|app-devel|Compliance mode enabled, was '1.117.0'|
...
|libclc|22.1.8|23.1.1|runtime-devices|Compliance mode enabled, was '23.1.1'|
...
|libmaxminddb|1.4.3|1.14.0|runtime-web|Compliance mode enabled, was '1.14.0'|
...
|librsvg|2.61.3|2.63.0|runtime-imaging|Compliance mode enabled, was '2.63.0'|
|librsvg+32|2.61.3|2.63.0|runtime-optenv32|Compliance mode enabled, was '2.63.0'|
...
|llvm+32|20.1.8|23.1.1|runtime-optenv32|Compliance mode enabled, was '23.1.1'|
|llvm-20|20.1.8|23.1.1|app-devel|Compliance mode enabled, was '23.1.1'|
|llvm-21|21.1.8|23.1.1|app-devel|Compliance mode enabled, was '23.1.1'|
|llvm-22|22.1.8|23.1.1|app-devel|Compliance mode enabled, was '23.1.1'|
|llvm-runtime+wasi|22.1.8|23.1.1|runtime-wasi|Compliance mode enabled, was '23.1.1'|
...
|mise|2026.1.1|2026.9.3|app-devel|Compliance mode enabled, was '2026.9.3'|
...
|nim|2.2.10|2.2.12|lang-nim|Compliance mode enabled, was '2.2.12'|
...
|obs-build|20260328|20260908|app-devel|Compliance mode enabled, was '20260908'|
...
|openai-python|2.26.0|3.10.0|lang-python|Compliance mode enabled, was '3.10.0'|
...
|openjdk-11|11.0.28-ga|11.0.33+3|lang-java||
...
|openjdk-8|8u462-ga|8u512-b02|groups||
...
|platformdirs|4.11.3|4.11.8|lang-python|Compliance mode enabled, was '4.11.8'|
...
|py-filelock|3.32.4|3.32.6|lang-python|Compliance mode enabled, was '3.32.6'|
...
|reasonix|1.17.21|1.38.2|app-vibe|Compliance mode enabled, was '1.38.2'|
...
|repo|2.66.1|2.67|app-devel|Compliance mode enabled, was '2.67'|
...
|tor|0.4.8.19|0.4.9.12|app-proxy|Compliance mode enabled, was '0.4.9.12'|
...
|uv|0.12.6|0.12.11|lang-python|Compliance mode enabled, was '0.12.11'|
|v2ray-rules-dat|202601042214|202609082347|runtime-data|Compliance mode enabled, was '202609082347'<br>Versions not comparable: `202601042214` and `202609082347`|
...
|vim|9.2.1046|9.2.1054|app-editors|Compliance mode enabled, was '9.2.1054'|
|virtiofsd|1.13.2|1.14.0|app-virtualization|Compliance mode enabled, was '1.14.0'|
|virtualenv|21.7.4|21.7.9|lang-python|Compliance mode enabled, was '21.7.9'|
