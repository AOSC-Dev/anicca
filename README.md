...
## Result
![Relative date](https://img.shields.io/date/1741000238?label=Updated)
...
|abdownloadmanager|1.5.2|1.5.3|app-web|Compliance mode enabled, was '1.5.3'|
...
|at-spi2-core+32|2.52.0|2.55.2|runtime-optenv32|Compliance mode enabled, was '2.55.2'|
...
|deb-installer|0.1.6|0.1.5|app-admin|Compliance mode enabled, was '0.1.5'<br>Possible downgrade from the current version (0.1.6 -> 0.1.5)|
...
|fastfetch|2.37.0|2.38.0|app-utils|Compliance mode enabled, was '2.38.0'|
...
|fluidsynth+32|2.3.6|2.4.3|runtime-optenv32|Compliance mode enabled, was '2.4.3'|
...
|fzf|0.55.0|0.60.3|app-utils|Compliance mode enabled, was '0.60.3'|
...
|harfbuzz+32|8.4.0|10.4.0|runtime-optenv32|Compliance mode enabled, was '10.4.0'|
...
|hypothesis-python|6.97.4|6.127.5|lang-python|Compliance mode enabled, was '6.127.5'|
...
|icu+32|74.2|76.1|runtime-optenv32|Compliance mode enabled, was '76-1'|
...
|keepassxc|2.7.9|2.7.10|app-utils|Compliance mode enabled, was '2.7.10'|
...
|libcap|2.73|2.74|runtime-common|Compliance mode enabled, was '2.74'|
|libcap+32|2.73|2.74|runtime-optenv32|Compliance mode enabled, was '2.74'|
...
|libgpg-error+32|1.50|1.51|runtime-optenv32|Compliance mode enabled, was '1.51'|
...
|libheif|1.19.5|1.19.6|runtime-imaging|Compliance mode enabled, was '1.19.6'|
...
|linux+api+32|6.12.7|6.12.17|runtime-optenv32|Compliance mode enabled, was '6.12.17'|
...
|llama.cpp|4615|4800|runtime-creativity|Compliance mode enabled, was '4800'|
...
|mesa+32|24.3.4|25.0.0|runtime-optenv32||
...
|mihomo|1.19.2|1.19.3|app-network|Compliance mode enabled, was '1.19.3'|
|mihomo-party|1.7.1|1.7.2|app-network|Compliance mode enabled, was '1.7.2'|
...
|neatvnc|0.9.3|0.9.4|runtime-network|Compliance mode enabled, was '0.9.4'|
...
|nvidia-open|570.124.04<br>+utils570.124.04|570.124.04|runtime-display|Compliance mode enabled, was '570.124.04'|
...
|openimageio|2.4.17.0|3.0.4.0|runtime-imaging|Compliance mode enabled, was '3.0.4.0'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.198|app-games|Compliance mode enabled, was '2.3.198'|
...
|pypdf2|1.26.0|5.3.1|lang-python|Compliance mode enabled, was '5.3.1'|
...
|qownnotes|22.6.1|25.3.0|app-web|Compliance mode enabled, was '25.3.0'|
...
|racket|8.15|8.16|lang-lisp|Compliance mode enabled, was '8.16'|
...
|scons|4.8.1|4.9.0|app-devel|Compliance mode enabled, was '4.9.0'|
...
|sdl2+32|2.30.4|3.2.4|runtime-optenv32|Compliance mode enabled, was '3.2.4'|
...
|suitesparse|7.6.1|7.10.0|runtime-scientific|Compliance mode enabled, was '7.10.0'|
...
|vpl-gpu-rt|25.1.2|25.1.3|runtime-multimedia|Compliance mode enabled, was '25.1.3'|
...
|xz+32|5.6.3|5.6.4|runtime-optenv32|Compliance mode enabled, was '5.6.4'|
