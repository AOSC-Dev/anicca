...
## Result
![Relative date](https://img.shields.io/date/1726942352?label=Updated)
...
|android-platform-tools|35.0.1|35.0.2|app-devices|Compliance mode enabled, was '35.0.2'|
...
|bitwarden|2024.8.2|2024.9.0|app-utils|Compliance mode enabled, was '2024.9.0'|
...
|boto3|1.20.26|1.35.24|lang-python|Compliance mode enabled, was '1.35.24'|
|botocore|1.34.133|1.35.24|lang-python|Compliance mode enabled, was '1.35.24'|
...
|chromium|127.0.6533.119|129.0.6668.58|app-web|Compliance mode enabled, was '129.0.6668.58'|
...
|cmake|3.30.1|3.30.3|app-devel|Compliance mode enabled, was '3.30.3'|
...
|ctags|20191203|6.1.20240915.0|app-devel|Compliance mode enabled, was '6.1.20240915.0'<br>Possible downgrade from the current version (20191203 -> 6.1.20240915.0)|
...
|curl|8.10.0|8.10.1|app-web|Compliance mode enabled, was '8.10.1'|
|curl+32|8.10.0|8.10.1|runtime-optenv32|Compliance mode enabled, was '8.10.1'|
...
|docker|27.1.1|27.3.1|app-containers||
|docker-compose|2.29.1|2.29.7|app-containers|Compliance mode enabled, was '2.29.7'|
...
|fastfetch|2.24.0|2.25.0|app-utils|Compliance mode enabled, was '2.25.0'|
...
|fzf|0.54.1|0.55.0|app-utils|Compliance mode enabled, was '0.55.0'|
...
|helm|3.15.0|3.16.1|app-containers|Compliance mode enabled, was '3.16.1'|
...
|hugo|0.131.0|0.134.3|app-web|Compliance mode enabled, was '0.134.3'|
...
|iosevka-fonts|31.6.1|31.7.0|desktop-fonts|Compliance mode enabled, was '31.7.0'|
...
|jenkins|2.468|2.477|app-admin|Compliance mode enabled, was '2.477'|
...
|kcptun|20240107|20240919|app-network|Compliance mode enabled, was '20240919'|
...
|lazygit|0.43.1|0.44.1|app-vcs|Compliance mode enabled, was '0.44.1'|
...
|libarchive|3.7.4|3.7.5|runtime-common|Compliance mode enabled, was '3.7.5'|
...
|libtool|2.4.7|2.5.2|app-devel|Compliance mode enabled, was '2.5.2'|
|libtool+32|2.4.6|2.5.2|runtime-optenv32|Compliance mode enabled, was '2.5.2'|
...
|minikube|1.33.1|1.34.0|app-containers|Compliance mode enabled, was '1.34.0'|
...
|nss|3.103|3.104|runtime-cryptography|Compliance mode enabled, was '3.104'|
|nss+32|3.78|3.104|runtime-optenv32|Compliance mode enabled, was '3.104'|
...
|oolite|1.90|1.91.0.7631-240919-d09c75b|app-games|Compliance mode enabled, was '1.91.0.7631-240919-d09c75b'|
...
|perl-image-exiftool|12.50|12.96|lang-perl|Compliance mode enabled, was '12.96'|
...
|praat|6.4.19|6.4.20|app-scientific|Compliance mode enabled, was '6.4.20'|
...
|pylint|2.14.4|3.3.0|lang-python|Compliance mode enabled, was '3.3.0'|
...
|restic|0.16.4|0.17.1|app-utils|Compliance mode enabled, was '0.17.1'|
...
|ruby-bundler|2.1.4|2.5.19|lang-ruby|Compliance mode enabled, was '2.5.19'|
...
|runc|1.1.12|1.1.14|app-admin|Compliance mode enabled, was '1.1.14'|
...
|shotcut|21.08.11|24.09.13|app-creativity|Compliance mode enabled, was '24.09.13'|
|shotwell|0.31.4|0.32.9|desktop-gnome|Compliance mode enabled, was '0.32.9'|
|showmethekey|1.12.0|1.14.0|app-utils|Compliance mode enabled, was '1.14.0'|
...
|vim|9.1.0707|9.1.0733|app-editors|Compliance mode enabled, was '9.1.0733'|
|virglrenderer|0.10.4|1.1.0|app-virtualization|Compliance mode enabled, was '1.1.0'|
|virtualenv|20.25.0|20.26.5|lang-python|Compliance mode enabled, was '20.26.5'|
...
|watchman|4.9.0|2024.09.16.00|app-utils|Compliance mode enabled, was '2024.09.16.00'|
...
|xray|1.8.4|24.9.16|app-network|Compliance mode enabled, was '24.9.16'|
...
|zed|0.152.3|0.152.4|app-editors|Compliance mode enabled, was '0.152.4'|
