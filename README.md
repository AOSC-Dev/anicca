...
## Result
![Relative date](https://img.shields.io/date/1739326261?label=Updated)
...
|boto3|1.20.26|1.36.18|lang-python|Compliance mode enabled, was '1.36.18'|
|botocore|1.34.133|1.36.18|lang-python|Compliance mode enabled, was '1.36.18'|
...
|calibre|7.24.0|7.25.0|app-doc|Compliance mode enabled, was '7.25.0'|
...
|chromium|131.0.6778.264|133.0.6943.53|app-web|Compliance mode enabled, was '133.0.6943.53'|
...
|curl+32|8.11.0|8.12.0|runtime-optenv32|Compliance mode enabled, was '8.12.0'|
...
|difftastic|0.62.0|0.63.0|app-utils|Compliance mode enabled, was '0.63.0'|
...
|eza|0.19.0|0.20.20|app-utils|Compliance mode enabled, was '0.20.20'|
...
|fastfetch|2.36.0|2.36.1|app-utils|Compliance mode enabled, was '2.36.1'|
...
|freerdp|3.9.0|3.11.1|app-network|Compliance mode enabled, was '3.11.1'|
...
|fwupd|1.9.25|2.0.5|app-admin|Compliance mode enabled, was '2.0.5'|
...
|gh|2.66.1|2.67.0|app-devel|Compliance mode enabled, was '2.67.0'|
...
|hmcl|3.6.11|3.6.11.266|app-games|Compliance mode enabled, was '3.6.11.266'|
...
|hwloc|2.10.0|2.12-branch|app-admin|Compliance mode enabled, was '2.12-branch'|
...
|intel-ucode|20241112|20250211|runtime-data|Compliance mode enabled, was '20250211'|
...
|libei|1.3.0|1.3.901|runtime-desktop|Compliance mode enabled, was '1.3.901'|
...
|llama.cpp|4615|4689|runtime-creativity|Compliance mode enabled, was '4689'|
...
|mangohud|0.7.2|0.8.0|app-utils|Compliance mode enabled, was '0.8.0'|
...
|openjdk-8|8u442-ga|8u452-b01|lang-java||
...
|pandoc|3.6.2|3.6.3|app-doc|Compliance mode enabled, was '3.6.3'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.149|app-games|Compliance mode enabled, was '2.3.149'|
...
|podman|5.3.2|5.4.0|app-containers||
...
|qownnotes|22.6.1|25.2.3|app-web|Compliance mode enabled, was '25.2.3'|
...
|reportlab|3.5.50|4.3.0|lang-python|Compliance mode enabled, was '4.3.0'|
...
|translate-toolkit|2.3.1|3.14.7|lang-python|Compliance mode enabled, was '3.14.7'|
...
|v2ray-rules-dat|202501302211|202502102212|runtime-data|Compliance mode enabled, was '202502102212'<br>Versions not comparable: `202501302211` and `202502102212`|
...
|vim|9.1.1043|9.1.1105|app-editors|Compliance mode enabled, was '9.1.1105'|
...
|vscode|1.97.0|1.97.1|app-editors|Compliance mode enabled, was '1.97.1'|
...
|yazi|25.2.7|25.2.11|app-utils|Compliance mode enabled, was '25.2.11'|
...
|zeroconf|0.28.6|0.143.0|lang-python|Compliance mode enabled, was '0.143.0'|
