...
## Result
![Relative date](https://img.shields.io/date/1786082746?label=Updated)
...
|boto3|1.42.54|1.43.66|lang-python|Compliance mode enabled, was '1.43.66'|
|botocore|1.43.62|1.43.66|lang-python|Compliance mode enabled, was '1.43.66'|
...
|calibre|9.11.0|9.13.0|app-doc|Compliance mode enabled, was '9.13.0'|
...
|certbot|5.5.0|5.7.0|app-web|Compliance mode enabled, was '5.7.0'|
...
|cherry-studio|1.9.12|2.0.1|app-utils|Compliance mode enabled, was '2.0.1'|
...
|chromium|148.0.7778.180|151.0.7922.108|app-web|Compliance mode enabled, was '151.0.7922.108'|
...
|codex|0.144.1|0.147.0|app-utils|Compliance mode enabled, was '0.147.0'|
...
|coverage|7.14.1|7.15.4|lang-python|Compliance mode enabled, was '7.15.4'|
...
|croc|10.4.3|11.0.2|app-utils|Compliance mode enabled, was '11.0.2'|
...
|deno|2.9.4|2.9.5|lang-js|Compliance mode enabled, was '2.9.5'|
...
|docker|29.5.3|29.7.2|app-containers||
...
|doggo|1.2.0|1.2.1|app-network|Compliance mode enabled, was '1.2.1'|
...
|google-chrome|150.0.7871.186|151.0.7922.108|app-web|Compliance mode enabled, was '151.0.7922.108'|
...
|gradle|9.6.1|9.7.0|lang-java|Compliance mode enabled, was '9.7.0'|
...
|iana-etc|20260310|20260807|runtime-data|Compliance mode enabled, was '20260807'|
...
|libreoffice|26.8.0.1|26.8.0.2|app-productivity|Compliance mode enabled, was '26.8.0.2'|
...
|lightdm|1.32.0|1.33.0|desktop-displaymanagers|Compliance mode enabled, was '1.33.0'|
...
|linux+api|6.18.35|6.18.43|core-devel|Compliance mode enabled, was '6.18.43'|
...
|llama.cpp|9568|10298|runtime-creativity|Compliance mode enabled, was '10298'|
...
|netavark|1.13.0|2.1.0|runtime-containers|Compliance mode enabled, was '2.1.0'|
...
|ocrmypdf|17.8.1|17.10.0|app-doc|Compliance mode enabled, was '17.10.0'|
...
|openexr|3.4.13|3.4.14|runtime-imaging|Compliance mode enabled, was '3.4.14'|
...
|openjdk-8|8u462-ga|8u512-b00|lang-java||
...
|pcsx2|2.7.181|2.7.515|app-games||
...
|perl-sys-virt|12.1.0|12.6.0|lang-perl|Compliance mode enabled, was '12.6.0'|
...
|pybind11|3.0.2|3.1.0|lang-python|Compliance mode enabled, was '3.1.0'|
...
|rocm-llama-cpp|7.0.1|10298|runtime-rocm|Compliance mode enabled, was '10298'|
...
|spirv-llvm-translator|20.1.4|23.1.0|app-devel|Compliance mode enabled, was '23.1.0'|
|spirv-llvm-translator+32|20.1.4|23.1.0|runtime-optenv32|Compliance mode enabled, was '23.1.0'|
...
|tornado|6.5.5|6.5.8|lang-python|Compliance mode enabled, was '6.5.8'|
...
|tree-sitter|0.26.8|0.26.11|app-devel|Compliance mode enabled, was '0.26.11'|
...
|types-setuptools|80.9.0.20250822|83.0.0.20260807|lang-python|Compliance mode enabled, was '83.0.0.20260807'|
...
|udisks-2|2.11.0|2.11.2|app-admin|Compliance mode enabled, was '2.11.2'|
...
|v2ray-rules-dat|202601042214|202608070127|runtime-data|Compliance mode enabled, was '202608070127'<br>Versions not comparable: `202601042214` and `202608070127`|
...
|vim|9.2.0910|9.2.0920|app-editors|Compliance mode enabled, was '9.2.0920'|
...
|vulkan-headers|1.4.350.0|1.4.359|runtime-display|Compliance mode enabled, was '1.4.359'|
|vulkan-headers+32|1.4.350.0|1.4.359|runtime-optenv32|Compliance mode enabled, was '1.4.359'|
...
|watchman|2026.06.22.00|2026.08.03.00|app-utils|Compliance mode enabled, was '2026.08.03.00'|
...
|zed|1.13.2|1.14.2|app-editors|Compliance mode enabled, was '1.14.2'|
