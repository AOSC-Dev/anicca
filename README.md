...
## Result
![Relative date](https://img.shields.io/date/1734419492?label=Updated)
...
|ast-grep|0.30.0|0.31.1|app-devel|Compliance mode enabled, was '0.31.1'|
...
|boto3|1.20.26|1.35.82|lang-python|Compliance mode enabled, was '1.35.82'|
|botocore|1.34.133|1.35.82|lang-python|Compliance mode enabled, was '1.35.82'|
...
|cinnamon|5.8.3|6.4.2|groups|Compliance mode enabled, was '6.4.2'|
...
|cockpit|286.1|330|app-admin|Compliance mode enabled, was '330'|
|cockpit-machines|284.1|325|app-admin|Compliance mode enabled, was '325'|
...
|crun|1.16.1|1.19|app-admin|Compliance mode enabled, was '1.19'|
...
|cysignals|1.11.4|1.12.0|lang-python|Compliance mode enabled, was '1.12.0'|
...
|devscripts|2.24.5|2.24.7|app-devel|Compliance mode enabled, was '2.24.7'|
...
|dnscontrol|4.15.0|4.15.1|app-network|Compliance mode enabled, was '4.15.1'|
...
|eza|0.19.0|0.20.12|app-utils|Compliance mode enabled, was '0.20.12'|
...
|freerdp|3.9.0|3.10.2|app-network|Compliance mode enabled, was '3.10.2'|
...
|frp|0.61.0|0.61.1|app-network|Compliance mode enabled, was '0.61.1'|
...
|google-api-python-client|1.7.11|2.155.0|lang-python|Compliance mode enabled, was '2.155.0'|
...
|gzdoom|4.12.2|4.13.2|app-games|Compliance mode enabled, was '4.13.2'|
...
|hypothesis-python|6.97.4|6.122.3|lang-python|Compliance mode enabled, was '6.122.3'|
...
|intel-oneapi-basekit|2025.0.0|2025.0.1|app-devel|Compliance mode enabled, was '2025.0.1'|
...
|jsoncpp|1.9.5|1.9.6|runtime-common|Compliance mode enabled, was '1.9.6'|
...
|libpng|1.6.43|1.6.44|runtime-imaging|Compliance mode enabled, was '1.6.44'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.63|app-games|Compliance mode enabled, was '2.3.63'|
...
|perl-image-exiftool|12.50|13.08|lang-perl|Compliance mode enabled, was '13.08'|
...
|php|8.3.13|8.4.1|app-devel|Compliance mode enabled, was '8.4.1'|
...
|repo|2.45|2.50.0|app-devel|Compliance mode enabled, was '2.50.0'|
...
|ruby-bundler|2.1.4|2.6.0|lang-ruby|Compliance mode enabled, was '2.6.0'|
...
|stress-ng|0.18.06|0.18.07|app-benchmarks|Compliance mode enabled, was '0.18.07'|
...
|translate-toolkit|2.3.1|3.14.2|lang-python|Compliance mode enabled, was '3.14.2'|
...
|v2ray-rules-dat|202412012212|202412162211|runtime-data|Compliance mode enabled, was '202412162211'<br>Versions not comparable: `202412012212` and `202412162211`|
...
|vim|9.1.0906|9.1.0938|app-editors|Compliance mode enabled, was '9.1.0938'|
...
|webkit2gtk|2.44.2|2.46.4|runtime-web|Compliance mode enabled, was '2.46.4'|
...
|wesnoth|1.16.10|1.19.6|app-games|Compliance mode enabled, was '1.19.6'|
...
|xray|24.11.30|24.12.15|app-network|Compliance mode enabled, was '24.12.15'|
...
|ytmusicapi|1.7.2|1.8.2|lang-python|Compliance mode enabled, was '1.8.2'|
