...
## Result
![Relative date](https://img.shields.io/date/1772288072?label=Updated)
...
|boto3|1.42.54|1.42.59|lang-python|Compliance mode enabled, was '1.42.59'|
|botocore|1.42.54|1.42.59|lang-python|Compliance mode enabled, was '1.42.59'|
...
|calibre|8.15.0|9.4.0|app-doc|Compliance mode enabled, was '9.4.0'|
...
|chisel|1.10.1|1.11.4|app-network|Compliance mode enabled, was '1.11.4'|
...
|crush|0.29.1|0.46.1|app-utils|Compliance mode enabled, was '0.46.1'|
...
|directx-headers|1.618.2|1.619.0|runtime-display|Compliance mode enabled, was '1.619.0'|
|directx-headers+32|1.618.2|1.619.0|runtime-optenv32|Compliance mode enabled, was '1.619.0'|
...
|file|5.45|5.47|app-utils|Compliance mode enabled, was '5.47'|
...
|fwupd|2.0.19|2.0.20|app-admin|Compliance mode enabled, was '2.0.20'|
...
|gearlever|4.3.0|4.4.7|app-utils|Compliance mode enabled, was '4.4.7'|
...
|intel-media-driver|25.3.4|25.4.6|runtime-multimedia|Compliance mode enabled, was '25.4.6'|
...
|iosevka-fonts|34.1.0|34.2.0|desktop-fonts|Compliance mode enabled, was '34.2.0'|
...
|keystoneclient|5.7.0|5.8.0|lang-python|Compliance mode enabled, was '5.8.0'|
...
|kodi-inputstream-adaptive|21.5.14|22.3.9-piers|app-multimedia|Compliance mode enabled, was '22.3.9-Piers'|
...
|kubo|0.39.0|0.40.1|app-proxy|Compliance mode enabled, was '0.40.1'|
...
|labwc|0.9.3|0.9.4|desktop-wm|Compliance mode enabled, was '0.9.4'|
...
|libreoffice|26.2.0.3|26.2.1.2|app-productivity|Compliance mode enabled, was '26.2.1.2'|
...
|llama.cpp|7966|8179|runtime-creativity|Compliance mode enabled, was '8179'|
...
|mise|2026.1.1|2026.2.22|app-devel|Compliance mode enabled, was '2026.2.22'|
...
|mycli|1.42.0|1.58.0|app-database|Compliance mode enabled, was '1.58.0'|
...
|openjdk-11|11.0.28-ga|11.0.31+4|lang-java||
...
|openjdk-8|8u462-ga|8u492-b04|lang-java||
...
|osu-lazer|2025.1029.1-lazer|2026.226.0-tachyon|app-games||
...
|pcsx2|1.6.0<br>+git20210825|2.7.144|app-games|Compliance mode enabled, was '2.7.144'|
...
|poedit|3.4.1|3.8.2-oss|app-i18n|Compliance mode enabled, was '3.8.2-oss'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20260228|lang-python|Compliance mode enabled, was '1.0.2.20260228'|
...
|pygobject-3|3.54.3|3.56.0|lang-python|Compliance mode enabled, was '3.56.0'|
...
|pypdf|6.5.0|6.7.4|lang-python|Compliance mode enabled, was '6.7.4'|
...
|q|0.19.11|0.19.12|app-network|Compliance mode enabled, was '0.19.12'|
...
|renderdoc|1.42|1.43|app-devel|Compliance mode enabled, was '1.43'|
...
|rocm-llama-cpp|7.0.1|8179|runtime-rocm|Compliance mode enabled, was '8179'|
...
|scikit-build-core|0.11.6|0.12.1|lang-python|Compliance mode enabled, was '0.12.1'|
...
|shotcut|25.12.30|26.2.26|app-creativity|Compliance mode enabled, was '26.2.26'|
...
|sing-box|1.12.20|1.13.0|app-proxy|Compliance mode enabled, was '1.13.0'|
...
|sunshine|2025.924.154138|2026.228.25700|app-multimedia|Compliance mode enabled, was '2026.228.25700'|
...
|systemd|259|259.2|app-admin|Compliance mode enabled, was '259.2'|
...
|typos|1.42.0|1.44.0|app-utils|Compliance mode enabled, was '1.44.0'|
...
|uv|0.10.6|0.10.7|lang-python|Compliance mode enabled, was '0.10.7'|
|v2ray|5.44.1|5.46.0|app-proxy|Compliance mode enabled, was '5.46.0'|
|v2ray-rules-dat|202601042214|202602272217|runtime-data|Compliance mode enabled, was '202602272217'<br>Versions not comparable: `202601042214` and `202602272217`|
...
|vacuumtube|1.3.21|1.5.8|app-multimedia|Compliance mode enabled, was '1.5.8'|
...
|vim|9.2.0|9.2.0078|app-editors|Compliance mode enabled, was '9.2.0078'|
...
|virtualenv|20.35.4|21.1.0|lang-python|Compliance mode enabled, was '21.1.0'|
...
|xstreamingdesktop|1.8.2|1.9.7|app-games|Compliance mode enabled, was '1.9.7'|
...
|zed|0.222.4|0.225.10|app-editors|Compliance mode enabled, was '0.225.10'|
