...
## Result
![Relative date](https://img.shields.io/date/1769152749?label=Updated)
...
|assimp|5.4.0|6.0.3|runtime-multimedia|Compliance mode enabled, was '6.0.3'|
...
|babl|0.1.116|0.1.120|runtime-imaging|Compliance mode enabled, was '0.1.120'|
...
|benchmark|1.8.2|1.9.5|runtime-common|Compliance mode enabled, was '1.9.5'|
...
|bind|9.20.13|9.20.18|app-network|Compliance mode enabled, was '9.20.18'|
|binsider|0.2.1|0.3.1|app-devel|Compliance mode enabled, was '0.3.1'|
...
|boto3|1.40.25|1.42.33|lang-python|Compliance mode enabled, was '1.42.33'|
|botocore|1.42.6|1.42.33|lang-python|Compliance mode enabled, was '1.42.33'|
...
|buf|1.63.0|1.64.0|app-devel|Compliance mode enabled, was '1.64.0'|
...
|cava|0.10.6|0.10.7|app-multimedia|Compliance mode enabled, was '0.10.7'|
...
|chromium|142.0.7444.134|144.0.7559.96|app-web|Compliance mode enabled, was '144.0.7559.96'|
...
|cinnamon|5.8.3|6.6.5|desktop-cinnamon|Compliance mode enabled, was '6.6.5'|
...
|cinnamon-settings-daemon|5.8.1|6.6.2|desktop-cinnamon|Compliance mode enabled, was '6.6.2'|
...
|code-server|4.107.0|4.108.1|app-utils|Compliance mode enabled, was '4.108.1'|
...
|crush|0.29.1|0.34.0|app-utils|Compliance mode enabled, was '0.34.0'|
...
|dart-sass|1.97.2|1.97.3|app-devel|Compliance mode enabled, was '1.97.3'|
|dart-sass-js|1.97.2|1.97.3|app-devel|Compliance mode enabled, was '1.97.3'|
...
|ddcutil|2.2.1|2.2.4|app-utils|Compliance mode enabled, was '2.2.4'|
...
|deno|2.6.5|2.6.6|lang-js|Compliance mode enabled, was '2.6.6'|
...
|dnscontrol|4.30.0|4.31.1|app-network|Compliance mode enabled, was '4.31.1'|
...
|docker|29.1.2|29.1.5|app-containers||
|docker-buildx|0.22.0|0.31.0|app-containers|Compliance mode enabled, was '0.31.0'|
...
|edencommon|2025.09.01.00|2026.01.19.00|runtime-common|Compliance mode enabled, was '2026.01.19.00'|
...
|element-desktop|1.12.7|1.12.8|app-web|Compliance mode enabled, was '1.12.8'|
...
|fastfetch|2.57.1|2.58.0|app-utils|Compliance mode enabled, was '2.58.0'|
...
|fb303|2025.09.01.00|2026.01.19.00|runtime-network|Compliance mode enabled, was '2026.01.19.00'|
|fbthrift|2025.09.01.00|2026.01.19.00|app-network|Compliance mode enabled, was '2026.01.19.00'|
...
|firefox|147.0|147.0.1|app-web|Compliance mode enabled, was '147.0.1'|
...
|fisher|4.4.5|4.4.6|app-shells|Compliance mode enabled, was '4.4.6'|
|five-or-more|3.32.3|48.1|desktop-gnome|Compliance mode enabled, was '48.1'|
|fizz|2025.09.01.00|2026.01.19.00|app-network|Compliance mode enabled, was '2026.01.19.00'|
...
|folly|2025.09.01.00|2026.01.19.00|runtime-common|Compliance mode enabled, was '2026.01.19.00'|
...
|gearlever|4.2.2|4.3.0|app-utils|Compliance mode enabled, was '4.3.0'|
...
|gh|2.83.2|2.86.0|app-devel|Compliance mode enabled, was '2.86.0'|
...
|git-cliff|2.11.0|2.12.0|app-vcs|Compliance mode enabled, was '2.12.0'|
|git-lfs|3.6.1|3.7.1|app-devel|Compliance mode enabled, was '3.7.1'|
|gitea|1.25.1|1.25.4|app-vcs|Compliance mode enabled, was '1.25.4'|
...
|google-chrome|143.0.7499.192|144.0.7559.96|app-web|Compliance mode enabled, was '144.0.7559.96'|
|goreleaser|2.13.1|2.13.3|lang-golang|Compliance mode enabled, was '2.13.3'|
|goverlay|1.2|1.7.1|app-utils|Compliance mode enabled, was '1.7.1'|
...
|harfbuzz|12.3.0|12.3.1|runtime-desktop|Compliance mode enabled, was '12.3.1'|
|harfbuzz+32|12.3.0|12.3.1|runtime-optenv32|Compliance mode enabled, was '12.3.1'|
...
|httplib2|0.22.0|0.31.1|lang-python|Compliance mode enabled, was '0.31.1'|
...
|hugo|0.154.3|0.154.5|app-web|Compliance mode enabled, was '0.154.5'|
...
|hypothesis-python|6.97.4|6.150.2|lang-python|Compliance mode enabled, was '6.150.2'|
...
|incus|6.20.0|6.21.0|app-containers|Compliance mode enabled, was '6.21.0'|
|incus-ui-canonical|0.18.2|0.19.1|app-containers|Compliance mode enabled, was '0.19.1'|
...
|iotop|1.30|1.31|app-utils|Compliance mode enabled, was '1.31'|
...
|kcm-wacomtablet|3.2.0|6.5.90|desktop-kde|Compliance mode enabled, was '6.5.90'|
...
|libguestfs|1.54.1|1.59.1|runtime-virtualization|Compliance mode enabled, was '1.59.1'|
...
|libreoffice|25.8.4.2|26.2.0.2|groups|Compliance mode enabled, was '26.2.0.2'|
...
|llama.cpp|7600|7814|runtime-creativity|Compliance mode enabled, was '7814'|
...
|luanti|5.14.0|5.15.0|app-games|Compliance mode enabled, was '5.15.0'|
...
|meson|1.10.0|1.10.1|app-devel|Compliance mode enabled, was '1.10.1'|
...
|mihomo|1.19.18|1.19.19|app-proxy|Compliance mode enabled, was '1.19.19'|
...
|mise|2026.1.1|2026.1.6|app-devel|Compliance mode enabled, was '2026.1.6'|
...
|muffin|5.8.0|6.6.2|desktop-cinnamon|Compliance mode enabled, was '6.6.2'|
...
|mycli|1.42.0|1.46.0|app-database|Compliance mode enabled, was '1.46.0'|
...
|ncurses|6.4|6.6+20260117|runtime-common|Compliance mode enabled, was '6.6-20260117'|
|ncurses+32|6.4|6.6+20260117|runtime-optenv32|Compliance mode enabled, was '6.6-20260117'|
...
|netbird|0.63.0|0.64.0|app-network|Compliance mode enabled, was '0.64.0'|
...
|nvtop|3.2.0|3.3.1|app-admin|Compliance mode enabled, was '3.3.1'|
...
|openai-python|1.63.2|2.15.0|lang-python|Compliance mode enabled, was '2.15.0'|
...
|osu-lazer|2025.1029.1-lazer|2026.123.0-tachyon|app-games||
...
|partclone|0.3.38|0.3.42|app-admin|Compliance mode enabled, was '0.3.42'|
...
|pcsx2|1.6.0<br>+git20210825|2.7.58|app-games|Compliance mode enabled, was '2.7.58'|
...
|perl-net-server|2.009|2.015|lang-perl|Compliance mode enabled, was '2.015'|
...
|pipewire|1.4.9|1.4.10|app-multimedia|Compliance mode enabled, was '1.4.10'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20260121|lang-python|Compliance mode enabled, was '1.0.2.20260121'|
...
|pypdf|6.5.0|6.6.0|lang-python|Compliance mode enabled, was '6.6.0'|
|pypdf2|1.26.0|6.6.0|lang-python|Compliance mode enabled, was '6.6.0'|
...
|qpdf|12.2.0|12.3.1|app-doc|Compliance mode enabled, was '12.3.1'|
...
|rocm-llama-cpp|7.0.1|7814|runtime-rocm|Compliance mode enabled, was '7814'|
...
|setuptools-python2|44.1.0|80.10.1|lang-python|Compliance mode enabled, was '80.10.1'|
|setuptools-python3|80.9.0|80.10.1|lang-python|Compliance mode enabled, was '80.10.1'|
...
|showmethekey|1.18.4|1.19.0|app-utils|Compliance mode enabled, was '1.19.0'|
...
|sof-tools|2.13.1|2.14.2|app-multimedia|Compliance mode enabled, was '2.14.2'|
...
|sunshine|2025.924.154138|2026.122.133140|app-multimedia|Compliance mode enabled, was '2026.122.133140'|
...
|thunderbird|146.0.1|147.0|app-web|Compliance mode enabled, was '147.0'|
...
|typos|1.42.0|1.42.1|app-utils|Compliance mode enabled, was '1.42.1'|
...
|uv|0.9.25|0.9.26|lang-python|Compliance mode enabled, was '0.9.26'|
|v2ray|5.43.0|5.44.1|app-proxy|Compliance mode enabled, was '5.44.1'|
|v2ray-rules-dat|202601042214|202601222217|runtime-data|Compliance mode enabled, was '202601222217'<br>Versions not comparable: `202601042214` and `202601222217`|
...
|vacuumtube|1.3.21|1.5.4|app-multimedia|Compliance mode enabled, was '1.5.4'|
...
|vim|9.1.2006|9.1.2103|app-editors|Compliance mode enabled, was '9.1.2103'|
...
|vulkan-extensionlayer|1.4.335.0|1.4.339|runtime-display|Compliance mode enabled, was '1.4.339'|
|vulkan-headers|1.4.335.0|1.4.340|runtime-display|Compliance mode enabled, was '1.4.340'|
|vulkan-headers+32|1.4.335.0|1.4.340|runtime-optenv32|Compliance mode enabled, was '1.4.340'|
|vulkan-loader|1.4.335.0|1.4.340|runtime-display|Compliance mode enabled, was '1.4.340'|
|vulkan-loader+32|1.4.335.0|1.4.340|runtime-optenv32|Compliance mode enabled, was '1.4.340'|
|vulkan-tools|1.4.335.0|1.4.338|app-utils|Compliance mode enabled, was '1.4.338'|
|vulkan-tools+32|1.4.335.0|1.4.338|runtime-optenv32|Compliance mode enabled, was '1.4.338'|
|vulkan-utility-libraries|1.4.335.0|1.4.340|runtime-display|Compliance mode enabled, was '1.4.340'|
|vulkan-validationlayers|1.4.335.0|1.4.339|runtime-display|Compliance mode enabled, was '1.4.339'|
|waffle|1.8.0|1.8.1|runtime-common|Compliance mode enabled, was '1.8.1'|
|wangle|2025.09.01.00|2026.01.19.00|runtime-network|Compliance mode enabled, was '2026.01.19.00'|
|warpinator|1.6.3|2.0.3|desktop-cinnamon|Compliance mode enabled, was '2.0.3'|
|warzone2100|4.5.5|4.6.2|app-games||
|watchman|2025.09.01.00|2026.01.19.00|app-utils|Compliance mode enabled, was '2026.01.19.00'|
...
|wcwidth|0.2.14|0.3.1|lang-python|Compliance mode enabled, was '0.3.1'|
...
|witr|0.2.5|0.2.6|app-utils|Compliance mode enabled, was '0.2.6'|
...
|xray|25.8.31|26.1.18|app-proxy|Compliance mode enabled, was '26.1.18'|
...
|zed|0.219.4|0.220.3|app-editors|Compliance mode enabled, was '0.220.3'|
...
|zotero|7.0.30|8.0.0|app-productivity|Compliance mode enabled, was '8.0.0'|
...
|zvm|0.8.11|0.8.12|lang-ziglang|Compliance mode enabled, was '0.8.12'|
