...
## Result
![Relative date](https://img.shields.io/date/1759493972?label=Updated)
...
|apt|3.0.3|3.1.7|app-admin|Compliance mode enabled, was '3.1.7'|
...
|ast-grep|0.38.2|0.39.5|app-devel|Compliance mode enabled, was '0.39.5'|
...
|boto3|1.40.25|1.40.44|lang-python|Compliance mode enabled, was '1.40.44'|
|botocore|1.40.25|1.40.44|lang-python|Compliance mode enabled, was '1.40.44'|
...
|bpftrace|0.23.5|0.24.0|app-admin|Compliance mode enabled, was '0.24.0'|
...
|cargo-release|0.25.10|0.25.19|lang-rust|Compliance mode enabled, was '0.25.19'|
...
|ctags|20191203|6.2.20250928.0|app-devel|Compliance mode enabled, was '6.2.20250928.0'<br>Possible downgrade from the current version (20191203 -> 6.2.20250928.0)|
...
|damo|2.4.7|2.9.8|app-admin|Compliance mode enabled, was '2.9.8'|
...
|deno|2.5.2|2.5.3|lang-js|Compliance mode enabled, was '2.5.3'|
...
|dialog|1.3<br>+20240619|1.3+20250817|app-utils|Compliance mode enabled, was '1.3-20250817'|
...
|dnsdiag|2.6.0|2.8.0|app-network|Compliance mode enabled, was '2.8.0'|
...
|docker-buildx|0.22.0|0.29.0|app-containers|Compliance mode enabled, was '0.29.0'|
...
|duckdb|1.3.2|1.4.0|app-database|Compliance mode enabled, was '1.4.0'|
...
|folly|2025.09.01.00|2025.09.29.00|runtime-common|Compliance mode enabled, was '2025.09.29.00'|
...
|frei0r-plugins|2.3.3|2.4.0|runtime-multimedia|Compliance mode enabled, was '2.4.0'|
...
|fwupd-efi|1.7|1.8|app-admin|Compliance mode enabled, was '1.8'|
...
|gwenhywfar|5.12.1|5.12.2|runtime-network|Compliance mode enabled, was '5.12.2'|
...
|hmcl|3.6.18|3.7.0.298|app-games|Compliance mode enabled, was '3.7.0.298'|
...
|hwdata|0.399|0.400|runtime-data|Compliance mode enabled, was '0.400'|
...
|kernel-tools|6.16.9|5.19.17|app-admin|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.16.9 -> 5.19.17)|
...
|libjcat|0.2.3|0.2.4|runtime-common|Compliance mode enabled, was '0.2.4'|
...
|libunistring|1.3|1.4|runtime-common|Compliance mode enabled, was '1.4'|
...
|linux+api|6.12.30|6.12.50|core-devel|Compliance mode enabled, was '6.12.50'|
|linux+api+32|6.12.7|6.12.50|runtime-optenv32|Compliance mode enabled, was '6.12.50'|
|linux+kernel|6.16.9|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.16.9 -> 5.19.17)|
...
|llama.cpp|6615|6673|runtime-creativity|Compliance mode enabled, was '6673'|
...
|lxgwneoxihei-font|1.218.1|1.223|desktop-fonts|Compliance mode enabled, was '1.223'|
...
|mate-panel|1.28.4|1.28.6|desktop-mate|Compliance mode enabled, was '1.28.6'|
...
|mise|2025.8.9|2025.10.1|app-devel|Compliance mode enabled, was '2025.10.1'|
...
|netbird|0.55.1|0.59.2|app-network|Compliance mode enabled, was '0.59.2'|
...
|nss+32|3.113|3.116|runtime-optenv32|Compliance mode enabled, was '3.116'|
...
|nvidia|580.82.07|580.95.05|groups|Compliance mode enabled, was '580.95.05'|
|nvidia-open|580.82.07|580.95.05|runtime-display|Compliance mode enabled, was '580.95.05'|
...
|octave|9.2.0|10.3.0|app-scientific|Compliance mode enabled, was '10.3.0'|
...
|openai-python|1.63.2|2.1.0|lang-python|Compliance mode enabled, was '2.1.0'|
...
|pandoc|3.6.3|3.8.1|app-doc|Compliance mode enabled, was '3.8.1'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.197|app-games|Compliance mode enabled, was '2.5.197'|
...
|pmbootstrap|3.5.2|3.6.0|app-utils|Compliance mode enabled, was '3.6.0'|
...
|poppler|25.07.0|25.09.1|runtime-doc|Compliance mode enabled, was '25.09.1'|
...
|pydantic|2.6.0|2.11.9|lang-python|Compliance mode enabled, was '2.11.9'|
|pydantic-core|2.16.1|2.40.1|lang-python|Compliance mode enabled, was '2.40.1'|
...
|python-3|3.10.18|3.13.7|lang-python|Compliance mode enabled, was '3.13.7'|
...
|pytools|2019.1|2025.2.4|lang-python|Compliance mode enabled, was '2025.2.4'|
...
|rocm-llama-cpp|6.4.3|6673|runtime-rocm|Compliance mode enabled, was '6673'|
...
|scons|4.9.1|4.10.0|app-devel|Compliance mode enabled, was '4.10.0'|
...
|sqlmap|1.9.5|1.9.9|app-penetration|Compliance mode enabled, was '1.9.9'|
...
|steam|1.0.0.83|1.0.0.85|app-games|Compliance mode enabled, was '1.0.0.85'|
...
|sunshine|2025.924.154138|2025.930.130407|app-multimedia|Compliance mode enabled, was '2025.930.130407'|
...
|teams-for-linux|2.2.1|2.5.10|app-web|Compliance mode enabled, was '2.5.10'|
...
|thermald|2.5.9|2.15.10|app-admin|Compliance mode enabled, was '2.15.10'|
|thin-provisioning-tools|1.0.10|1.2.1|app-admin|Compliance mode enabled, was '1.2.1'|
...
|tor|0.4.8.13|0.4.8.18|app-proxy|Compliance mode enabled, was '0.4.8.18'|
...
|typos|1.36.2|1.37.1|app-utils|Compliance mode enabled, was '1.37.1'|
...
|v2ray-rules-dat|202508312212|202510022212|runtime-data|Compliance mode enabled, was '202510022212'<br>Versions not comparable: `202508312212` and `202510022212`|
...
|vim|9.1.1788|9.1.1821|app-editors|Compliance mode enabled, was '9.1.1821'|
...
|vscodium|1.104.16282|1.104.26450|app-editors|Compliance mode enabled, was '1.104.26450'|
...
|wangle|2025.09.01.00|2025.09.29.00|runtime-network|Compliance mode enabled, was '2025.09.29.00'|
|warpinator|1.6.3|1.8.10|desktop-cinnamon|Compliance mode enabled, was '1.8.10'|
|warzone2100|4.5.5|4.6.1|app-games||
|watchman|2025.09.01.00|2025.09.29.00|app-utils|Compliance mode enabled, was '2025.09.29.00'|
...
|yaru|25.10.2-0ubuntu1|25.10.3-0ubuntu1|desktop-themes||
