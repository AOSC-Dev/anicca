...
## Result
![Relative date](https://img.shields.io/date/1762400719?label=Updated)
...
|anubis|1.21.3|1.23.0|app-web|Compliance mode enabled, was '1.23.0'|
...
|boto3|1.40.25|1.40.67|lang-python|Compliance mode enabled, was '1.40.67'|
|botocore|1.40.25|1.40.67|lang-python|Compliance mode enabled, was '1.40.67'|
...
|calibre|8.5.0|8.13.0|app-doc|Compliance mode enabled, was '8.13.0'|
...
|cherry-studio|1.6.6|1.6.61|app-utils|Compliance mode enabled, was '1.6.61'|
...
|cinny-desktop|4.10.1|4.10.2|app-web|Compliance mode enabled, was '4.10.2'|
...
|cloudflared|2025.7.0|2025.10.1|app-proxy|Compliance mode enabled, was '2025.10.1'|
...
|containerd|2.1.4|2.1.5|app-containers|Compliance mode enabled, was '2.1.5'|
...
|crush|0.13.7|0.15.1|app-utils|Compliance mode enabled, was '0.15.1'|
...
|ctags|6.2.20251005.0|6.2.20251102.0|app-devel|Compliance mode enabled, was '6.2.20251102.0'|
...
|devscripts|2.25.20|2.25.24|app-devel|Compliance mode enabled, was '2.25.24'|
...
|dtk6core|6.0.37|6.0.44|desktop-dde|Compliance mode enabled, was '6.0.44'|
|dtk6gui|6.0.37|6.0.44|desktop-dde|Compliance mode enabled, was '6.0.44'|
...
|element-desktop|1.12.2|1.12.3|app-web|Compliance mode enabled, was '1.12.3'|
...
|fex|2510|2511|app-emulation|Compliance mode enabled, was '2511'|
...
|fwupd|2.0.16|2.0.17|app-admin|Compliance mode enabled, was '2.0.17'|
...
|gh|2.82.1|2.83.0|app-devel|Compliance mode enabled, was '2.83.0'|
...
|gitea|1.25.0|1.25.1|app-vcs|Compliance mode enabled, was '1.25.1'|
...
|glab|1.72.0|1.76.2|app-devel|Compliance mode enabled, was '1.76.2'|
|glances|4.0.5|4.4.1|app-admin|Compliance mode enabled, was '4.4.1'|
...
|glycin|1.1.4|2.0.5|desktop-gnome|Compliance mode enabled, was '2.0.5'|
...
|google-chrome|142.0.7444.59|142.0.7444.134|app-web|Compliance mode enabled, was '142.0.7444.134'|
...
|gst-plugins-rs|0.14.2|0.14.3|runtime-multimedia|Compliance mode enabled, was '0.14.3'|
...
|hypothesis-python|6.97.4|6.146.0|lang-python|Compliance mode enabled, was '6.146.0'|
...
|libcap|2.73|2.77|runtime-common|Compliance mode enabled, was '2.77'|
...
|libphonenumber|8.13.38|9.0.17|runtime-i18n|Compliance mode enabled, was '9.0.17'|
...
|linyaps|1.6.3|1.10.0|app-admin|Compliance mode enabled, was '1.10.0'|
...
|llama.cpp|6670|6962|runtime-creativity|Compliance mode enabled, was '6962'|
...
|mise|2025.8.9|2025.11.2|app-devel|Compliance mode enabled, was '2025.11.2'|
...
|mstflint|4.29.0-1|4.33.0-3-gb|app-admin|Compliance mode enabled, was '4.33.0-3-GB'|
...
|osu-lazer|2025.816.0-lazer|2025.1105.0|app-games||
...
|pcsx2|1.6.0<br>+git20210825|2.5.276|app-games|Compliance mode enabled, was '2.5.276'|
...
|pixi|0.58.0|0.59.0|app-devel|Compliance mode enabled, was '0.59.0'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20251031|lang-python|Compliance mode enabled, was '1.0.2.20251031'|
...
|pyglet|1.3.2|2.1.10|lang-python|Compliance mode enabled, was '2.1.10'|
...
|redis|8.2.2|8.2.3|app-database|Compliance mode enabled, was '8.2.3'|
...
|rocm-llama-cpp|7.0.1|6962|runtime-rocm|Compliance mode enabled, was '6962'|
...
|tauri-cli|2.8.4|2.9.3|lang-rust|Compliance mode enabled, was '2.9.3'|
...
|v2ray-rules-dat|202510042211|202511052213|runtime-data|Compliance mode enabled, was '202511052213'<br>Versions not comparable: `202510042211` and `202511052213`|
...
|vacuumtube|1.3.21|1.3.23|app-multimedia|Compliance mode enabled, was '1.3.23'|
...
|vim|9.1.1837|9.1.1896|app-editors|Compliance mode enabled, was '9.1.1896'|
...
|zed|0.209.6|0.211.4|app-editors|Compliance mode enabled, was '0.211.4'|
