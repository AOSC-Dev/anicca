...
## Result
![Relative date](https://img.shields.io/date/1741706078?label=Updated)
...
|ab-download-manager|1.5.3|1.5.4|app-web|Compliance mode enabled, was '1.5.4'|
...
|ada|2.9.1|3.2.1|runtime-web|Compliance mode enabled, was '3.2.1'|
...
|alsa-ucm-conf-asahi|6|7|runtime-multimedia|Compliance mode enabled, was '7'|
...
|apt|2.6.1|2.9.32|app-admin|Compliance mode enabled, was '2.9.32'|
...
|argcomplete|3.5.0|3.6.0|lang-python|Compliance mode enabled, was '3.6.0'|
...
|asahi-audio|3.0|3.1|runtime-multimedia|Compliance mode enabled, was '3.1'|
...
|babl|0.1.108|0.1.112|runtime-imaging|Compliance mode enabled, was '0_1_112'|
...
|boto3|1.20.26|1.37.10|lang-python|Compliance mode enabled, was '1.37.10'|
|botocore|1.34.133|1.37.10|lang-python|Compliance mode enabled, was '1.37.10'|
...
|buildah|1.39.1|1.39.2|app-containers|Compliance mode enabled, was '1.39.2'|
...
|ccache|4.10.2|4.11|app-devel|Compliance mode enabled, was '4.11'|
...
|chromium|131.0.6778.264|134.0.6998.88|app-web|Compliance mode enabled, was '134.0.6998.88'|
...
|containers-common|0.61.1|0.62.1|runtime-containers||
...
|damo|2.4.7|2.7.1|app-admin|Compliance mode enabled, was '2.7.1'|
...
|debconf|1.5.87|1.5.91|app-admin|Compliance mode enabled, was '1.5.91'|
...
|deno|1.44.1|2.2.3|lang-js|Compliance mode enabled, was '2.2.3'|
...
|dnscontrol|4.16.0|4.17.0|app-network|Compliance mode enabled, was '4.17.0'|
...
|docker-buildx|0.18.0|0.21.2|app-containers|Compliance mode enabled, was '0.21.2'|
...
|edencommon|2024.12.30.00|2025.03.10.00|runtime-common|Compliance mode enabled, was '2025.03.10.00'|
...
|fast-float|7.0.0|8.0.1|runtime-common|Compliance mode enabled, was '8.0.1'|
...
|folly|2024.12.30.00|2025.03.10.00|runtime-common|Compliance mode enabled, was '2025.03.10.00'|
...
|hmcl|3.6.11|3.6.11.271|app-games|Compliance mode enabled, was '3.6.11.271'|
...
|hypothesis-python|6.97.4|6.128.2|lang-python|Compliance mode enabled, was '6.128.2'|
...
|icewm|3.6.0|3.7.2|desktop-wm|Compliance mode enabled, was '3.7.2'|
...
|jenkins|2.468|2.500|app-admin|Compliance mode enabled, was '2.500'|
...
|just|1.39.0|1.40.0|app-devel|Compliance mode enabled, was '1.40.0'|
...
|kmod|31|34.1|app-admin|Compliance mode enabled, was '34.1'|
...
|lfortran|0.47.0|0.48.0|app-devel|Compliance mode enabled, was '0.48.0'|
...
|libical|3.0.18|20221025-f9ed452c1d|runtime-productivity|Compliance mode enabled, was '20221025-f9ed452c1d'|
...
|llama.cpp|4827|4871|runtime-creativity|Compliance mode enabled, was '4871'|
...
|lxgwcleargothic-font|0.300.4|0.339|desktop-fonts|Compliance mode enabled, was '0.339'|
...
|mdbook|0.4.40|0.4.47|app-doc|Compliance mode enabled, was '0.4.47'|
...
|mold|2.36.0|2.37.0|app-devel|Compliance mode enabled, was '2.37.0'|
...
|mpd|0.23.17|0.24|app-multimedia|Compliance mode enabled, was '0.24'|
...
|nuclei|3.3.9|3.3.10|app-utils|Compliance mode enabled, was '3.3.10'|
...
|openjdk-8|8u442-ga|8u452-b04|lang-java||
...
|pcsx2|1.6.0<br>+git20210825|2.3.212|app-games|Compliance mode enabled, was '2.3.212'|
...
|perl-image-exiftool|12.50|13.25|lang-perl|Compliance mode enabled, was '13.25'|
...
|protobuf|25.2|30.0|runtime-common|Compliance mode enabled, was '30.0'|
...
|pygccxml|2.1.0|3.0.0|lang-python|Compliance mode enabled, was '3.0.0'|
...
|pylint|2.14.4|3.3.5|lang-python|Compliance mode enabled, was '3.3.5'|
...
|pynput|1.7.6|1.8.0|lang-python|Compliance mode enabled, was '1.8.0'|
...
|rpi-firmware-boot|1.20250127|1.20250305|runtime-kernel||
...
|sdl2|2.30.4|2.32.2|runtime-multimedia|Compliance mode enabled, was '2.32.2'|
|sdl2+32|2.30.4|2.32.2|runtime-optenv32|Compliance mode enabled, was '2.32.2'|
...
|sunshine|2025.122.141614|0.23.1|app-multimedia|Compliance mode enabled, was '0.23.1'<br>Possible downgrade from the current version (2025.122.141614 -> 0.23.1)|
...
|tinyxml2|10.0.0|10.1.0|runtime-common|Compliance mode enabled, was '10.1.0'|
...
|typos|1.29.10|1.30.2|app-utils|Compliance mode enabled, was '1.30.2'|
...
|vim|9.1.1179|9.1.1194|app-editors|Compliance mode enabled, was '9.1.1194'|
...
|virtualenv|20.27.1|20.29.3|lang-python|Compliance mode enabled, was '20.29.3'|
...
|vscodium|1.97.0.25037|1.98.0.25067|app-editors|Compliance mode enabled, was '1.98.0.25067'|
...
|vulkan-headers|1.3.283.0|1.4.310|runtime-display|Compliance mode enabled, was '1.4.310'|
|vulkan-headers+32|1.3.283.0|1.4.310|runtime-optenv32|Compliance mode enabled, was '1.4.310'|
|vulkan-loader|1.3.283.0|1.4.310|runtime-display|Compliance mode enabled, was '1.4.310'|
|vulkan-loader+32|1.3.283.0|1.4.310|runtime-optenv32|Compliance mode enabled, was '1.4.310'|
...
|vulkan-utility-libraries|1.3.283.0|1.4.310|runtime-display|Compliance mode enabled, was '1.4.310'|
...
|wangle|2024.12.30.00|2025.03.10.00|runtime-network|Compliance mode enabled, was '2025.03.10.00'|
|warpinator|1.6.3|1.8.8|desktop-cinnamon|Compliance mode enabled, was '1.8.8'|
|warzone2100|4.5.3|4.5.5|app-games||
|watchman|2024.12.30.00|2025.03.10.00|app-utils|Compliance mode enabled, was '2025.03.10.00'|
...
|xpra|6.1.2|6.2.4|app-network|Compliance mode enabled, was '6.2.4'|
...
|z3|4.14.0|4.14.1|app-devel|Compliance mode enabled, was '4.14.1'|
