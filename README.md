...
## Result
![Relative date](https://img.shields.io/date/1763622795?label=Updated)
...
|bitwarden|2025.10.0|2025.11.1|app-utils|Compliance mode enabled, was '2025.11.1'|
...
|boto3|1.40.25|1.41.0|lang-python|Compliance mode enabled, was '1.41.0'|
|botocore|1.40.25|1.41.0|lang-python|Compliance mode enabled, was '1.41.0'|
...
|box64|0.3.9<br>+git20251119|0.3.8|app-emulation|Compliance mode enabled, was '0.3.8'<br>Possible downgrade from the current version (0.3.9+git20251119 -> 0.3.8)|
...
|buf|1.57.2|1.60.0|app-devel|Compliance mode enabled, was '1.60.0'|
...
|calibre|8.13.0|8.14.0|app-doc|Compliance mode enabled, was '8.14.0'|
...
|cppcheck|2.18.0|2.18.3|app-devel|Compliance mode enabled, was '2.18.3'|
...
|croc|10.2.7|10.3.0|app-utils|Compliance mode enabled, was '10.3.0'|
...
|crush|0.17.0|0.18.4|app-utils|Compliance mode enabled, was '0.18.4'|
...
|ctags|6.2.20251005.0|6.2.20251116.0|app-devel|Compliance mode enabled, was '6.2.20251116.0'|
...
|damo|2.4.7|3.0.5|app-admin|Compliance mode enabled, was '3.0.5'|
...
|dart-sass|1.94.0|1.94.2|app-devel|Compliance mode enabled, was '1.94.2'|
|dart-sass-js|1.94.0|1.94.2|app-devel|Compliance mode enabled, was '1.94.2'|
...
|devscripts|2.25.20|2.25.26|app-devel|Compliance mode enabled, was '2.25.26'|
...
|element-desktop|1.12.3|1.12.4|app-web|Compliance mode enabled, was '1.12.4'|
...
|fb303|2025.09.01.00|2025.11.17.00|runtime-network|Compliance mode enabled, was '2025.11.17.00'|
|fbthrift|2025.09.01.00|2025.11.17.00|app-network|Compliance mode enabled, was '2025.11.17.00'|
...
|firefox|145.0|145.0.1|app-web|Compliance mode enabled, was '145.0.1'|
...
|fizz|2025.09.01.00|2025.11.17.00|app-network|Compliance mode enabled, was '2025.11.17.00'|
...
|folly|2025.09.01.00|2025.11.17.00|runtime-common|Compliance mode enabled, was '2025.11.17.00'|
...
|forgejo|11.0.0|13.0.2|app-web|Compliance mode enabled, was '13.0.2'|
...
|gapless|4.5|4.6|app-multimedia|Compliance mode enabled, was '4.6'|
...
|git|2.51.1|2.52.0|app-vcs|Compliance mode enabled, was '2.52.0'|
...
|glab|1.76.0|1.77.0|app-devel|Compliance mode enabled, was '1.77.0'|
...
|gnome-control-center|42.10|49.1|desktop-gnome|Compliance mode enabled, was '49.1'|
...
|gnutls|3.8.10|3.8.11|runtime-cryptography|Compliance mode enabled, was '3.8.11'|
|gnutls+32|3.8.7|3.8.11|runtime-optenv32|Compliance mode enabled, was '3.8.11'|
...
|graphviz|14.0.2|14.0.4|app-doc|Compliance mode enabled, was '14.0.4'|
...
|gstreamer|1.26.4|1.26.8|runtime-multimedia|Compliance mode enabled, was '1.26.8'|
...
|helm|3.17.1|4.0.0|app-containers|Compliance mode enabled, was '4.0.0'|
...
|hmcl|3.7.5|3.6.18|app-games|Compliance mode enabled, was '3.6.18'<br>Possible downgrade from the current version (3.7.5 -> 3.6.18)|
|hotdoc|0.13.7|0.17.4|app-doc|Compliance mode enabled, was '0.17.4'|
|hplip|3.25.2|3.25.8|app-doc|Compliance mode enabled, was '3.25.8'|
...
|hugo|0.151.0|0.152.2|app-web|Compliance mode enabled, was '0.152.2'|
...
|intel-compute-runtime|25.35.35096.9|25.40.35563.4|runtime-scientific|Compliance mode enabled, was '25.40.35563.4'|
...
|kcptun|20241227|20251118|app-proxy|Compliance mode enabled, was '20251118'|
...
|libutf8proc|2.11.0|2.11.1|runtime-i18n|Compliance mode enabled, was '2.11.1'|
...
|linux-firmware|20251014|20251111|runtime-kernel||
|linux-kernel|6.17.7|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.17.7 -> 5.19.17)|
...
|llama.cpp|6670|7108|runtime-creativity|Compliance mode enabled, was '7108'|
...
|mariadb|11.7.2|12.1.2|app-database|Compliance mode enabled, was '12.1.2'|
...
|melonds|1.0|1.1|app-games|Compliance mode enabled, was '1.1'|
...
|mise|2025.8.9|2025.11.7|app-devel|Compliance mode enabled, was '2025.11.7'|
...
|mvfst|2025.09.01.00|2025.11.17.00|runtime-network|Compliance mode enabled, was '2025.11.17.00'|
|mxml|3.2|4.0.4|runtime-common|Compliance mode enabled, was '4.0.4'|
|mycli|1.23.2|1.41.1|app-database|Compliance mode enabled, was '1.41.1'|
...
|ncurses|6.4|6.5+20251115|runtime-common|Compliance mode enabled, was '6.5-20251115'|
|ncurses+32|6.4|6.5+20251115|runtime-optenv32|Compliance mode enabled, was '6.5-20251115'|
...
|netbird|0.59.7|0.60.1|app-network|Compliance mode enabled, was '0.60.1'|
...
|pcp|6.0.1|7.0.4|app-utils|Compliance mode enabled, was '7.0.4'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.315|app-games|Compliance mode enabled, was '2.5.315'|
...
|postfix|3.7.3|3.10.5|app-web|Compliance mode enabled, was '3.10.5'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20251119|lang-python|Compliance mode enabled, was '1.0.2.20251119'|
...
|pv|1.6.20|1.10.1|app-utils|Compliance mode enabled, was '1.10.1'|
...
|qbittorrent|5.1.3|5.1.4|app-web|Compliance mode enabled, was '5.1.4'|
...
|qtcreator|17.0.1|18.0.0|app-devel|Compliance mode enabled, was '18.0.0'|
...
|rclone|1.71.1|1.71.2|app-web|Compliance mode enabled, was '1.71.2'|
...
|rocm-llama-cpp|7.0.1|7108|runtime-rocm|Compliance mode enabled, was '7108'|
...
|starship|1.24.0|1.24.1|app-utils|Compliance mode enabled, was '1.24.1'|
...
|tailscale|1.90.6|1.90.8|app-network|Compliance mode enabled, was '1.90.8'|
...
|teams-for-linux|2.2.1|2.6.15|app-web|Compliance mode enabled, was '2.6.15'|
...
|telegram-desktop|6.1.3|6.3.1|app-web|Compliance mode enabled, was '6.3.1'|
...
|tinycss2|1.0.2|1.5.0|lang-python|Compliance mode enabled, was '1.5.0'|
...
|types-psutil|7.0.0.20251001|7.0.0.20251116|lang-python|Compliance mode enabled, was '7.0.0.20251116'|
...
|v2ray-rules-dat|202510042211|202511192214|runtime-data|Compliance mode enabled, was '202511192214'<br>Versions not comparable: `202510042211` and `202511192214`|
...
|vscode|1.106.0|1.106.2|app-editors|Compliance mode enabled, was '1.106.2'|
...
|vulkan-extensionlayer|1.4.328.1|1.4.333|runtime-display|Compliance mode enabled, was '1.4.333'|
|vulkan-headers|1.4.328.1|1.4.333|runtime-display|Compliance mode enabled, was '1.4.333'|
|vulkan-headers+32|1.4.328.1|1.4.333|runtime-optenv32|Compliance mode enabled, was '1.4.333'|
|vulkan-loader|1.4.328.1|1.4.333|runtime-display|Compliance mode enabled, was '1.4.333'|
|vulkan-loader+32|1.4.328.1|1.4.333|runtime-optenv32|Compliance mode enabled, was '1.4.333'|
...
|vulkan-utility-libraries|1.4.328.1|1.4.333|runtime-display|Compliance mode enabled, was '1.4.333'|
...
|webkit2gtk|2.50.1|2.50.2|runtime-web|Compliance mode enabled, was '2.50.2'|
...
|wsproto|1.2.0|1.3.1|lang-python|Compliance mode enabled, was '1.3.1'|
...
|yq|4.48.1|4.48.2|app-devel|Compliance mode enabled, was '4.48.2'|
...
|zed|0.212.3|0.213.3|app-editors|Compliance mode enabled, was '0.213.3'|
...
|zope-interface|7.2|8.1.1~a1|lang-python|Compliance mode enabled, was '8.1.1a1'|
