...
## Result
![Relative date](https://img.shields.io/date/1773087772?label=Updated)
...
|b2sdk|2.5.0|2.10.4|lang-python|Compliance mode enabled, was '2.10.4'|
...
|boto3|1.42.54|1.42.64|lang-python|Compliance mode enabled, was '1.42.64'|
|botocore|1.42.54|1.42.64|lang-python|Compliance mode enabled, was '1.42.64'|
...
|cachetools|3.1.0|7.0.4|lang-python|Compliance mode enabled, was '7.0.4'|
...
|ccache|4.12.2|4.13|app-devel|Compliance mode enabled, was '4.13'|
...
|clpeak|1.1.4|1.1.6|app-benchmarks|Compliance mode enabled, was '1.1.6'|
...
|code-server|4.107.0|4.109.5|app-utils|Compliance mode enabled, was '4.109.5'|
...
|configargparse|1.7.1|1.7.3|lang-python|Compliance mode enabled, was '1.7.3'|
...
|croc|10.2.7|10.4.1|app-utils|Compliance mode enabled, was '10.4.1'|
...
|damo|2.4.7|3.1.8|app-admin|Compliance mode enabled, was '3.1.8'|
...
|e2fsprogs|1.47.2|1.47.4|app-admin|Compliance mode enabled, was '1.47.4'|
|easy-rsa|3.2.4|3.2.5|app-cryptography|Compliance mode enabled, was '3.2.5'|
|easyeffects|7.2.5|8.1.3|app-multimedia|Compliance mode enabled, was '8.1.3'|
...
|fd|10.3.0|10.4.1|app-utils|Compliance mode enabled, was '10.4.1'|
...
|feishin|1.6.0|1.7.0|app-multimedia|Compliance mode enabled, was '1.7.0'|
...
|google-api-python-client|1.7.11|2.192.0|lang-python|Compliance mode enabled, was '2.192.0'|
...
|harfbuzz|12.3.0|13.0.1|runtime-desktop|Compliance mode enabled, was '13.0.1'|
|harfbuzz+32|12.3.0|13.0.1|runtime-optenv32|Compliance mode enabled, was '13.0.1'|
...
|libqofono|0.98|0.126|runtime-network|Compliance mode enabled, was '0.126'|
...
|llama.cpp|8232|8250|runtime-creativity|Compliance mode enabled, was '8250'|
...
|mihomo|1.19.20|1.19.21|app-proxy|Compliance mode enabled, was '1.19.21'|
...
|mise|2026.1.1|2026.3.6|app-devel|Compliance mode enabled, was '2026.3.6'|
...
|netbird|0.65.1|0.66.2|app-network|Compliance mode enabled, was '0.66.2'|
...
|noctalia-qs|0.0.4|0.0.6|runtime-desktop|Compliance mode enabled, was '0.0.6'|
...
|nvme-cli|2.16|3.0-a.1|app-admin|Compliance mode enabled, was '3.0-a.1'|
...
|openjdk-11|11.0.28-ga|11.0.31+5|lang-java||
|openjdk-17|17.0.16-ga|17.0.19+5|lang-java||
|openjdk-21|21.0.8-ga|21.0.11+5|lang-java||
|openjdk-22|22.0.2-ga|22.0.2+9|lang-java||
|openjdk-23|23.0.2-ga|23.0.2+7|lang-java||
|openjdk-24|24.0.2-ga|24.0.2+12|lang-java||
|openjdk-8|8u462-ga|8u492-b05|lang-java||
...
|osu-lazer|2026.305.0-lazer|2026.307.0-tachyon|app-games||
...
|partclone|0.3.38|0.3.46|app-admin|Compliance mode enabled, was '0.3.46'|
...
|pbs-installer|2026.2.11|2026.3.3|lang-python|Compliance mode enabled, was '2026.3.3'|
...
|pcsx2|1.6.0<br>+git20210825|2.7.168|app-games|Compliance mode enabled, was '2.7.168'|
...
|postfix|3.7.3|3.11.0|app-web|Compliance mode enabled, was '3.11.0'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20260307|lang-python|Compliance mode enabled, was '1.0.2.20260307'|
...
|puremagic|1.30|2.0.1|lang-python|Compliance mode enabled, was '2.0.1'|
...
|pypkgconfig|1.4.0|1.6.0|lang-python|Compliance mode enabled, was '1.6.0'|
...
|rocm-aqlprofile|7.2.0|7.12.60610|runtime-rocm|Compliance mode enabled, was '7.12.60610'|
|rocm-bandwidth-test|6.4.3|20250912.42|runtime-rocm|Compliance mode enabled, was '20250912-42'|
|rocm-clr|7.2.0|7.12.60610|runtime-rocm|Compliance mode enabled, was '7.12.60610'|
...
|rocm-core|7.2.0|7.12.60610|runtime-rocm|Compliance mode enabled, was '7.12.60610'|
...
|rocm-llama-cpp|7.0.1|8250|runtime-rocm|Compliance mode enabled, was '8250'|
...
|rocm-rocprofiler-register|7.2.0|7.12.60610|runtime-rocm|Compliance mode enabled, was '7.12.60610'|
...
|rocm-roctracer|7.2.0|7.12.60610|runtime-rocm|Compliance mode enabled, was '7.12.60610'|
|rocm-smi-lib|7.2.0|7.12.60610|runtime-rocm|Compliance mode enabled, was '7.12.60610'|
|rocminfo|7.2.0|7.12.60610|runtime-rocm|Compliance mode enabled, was '7.12.60610'|
|rocr-runtime|7.2.0|7.12.60610|runtime-rocm|Compliance mode enabled, was '7.12.60610'|
...
|squashfs-tools|4.7.4|4.7.5|app-admin|Compliance mode enabled, was '4.7.5'|
...
|sunshine|2025.924.154138|2026.309.21603|app-multimedia|Compliance mode enabled, was '2026.309.21603'|
...
|topgrade|16.2.1|17.0.0|app-admin|Compliance mode enabled, was '17.0.0'|
...
|v2ray|5.46.0|5.47.0|app-proxy|Compliance mode enabled, was '5.47.0'|
|v2ray-rules-dat|202601042214|202603082217|runtime-data|Compliance mode enabled, was '202603082217'<br>Versions not comparable: `202601042214` and `202603082217`|
...
|vim|9.2.0|9.2.0127|app-editors|Compliance mode enabled, was '9.2.0127'|
...
|vpl-gpu-rt|26.1.2|26.1.3|runtime-multimedia|Compliance mode enabled, was '26.1.3'|
...
|xapian-core|1.4.18|1.5.1|runtime-common|Compliance mode enabled, was '1.5.1'|
...
|xonsh|0.22.2|0.22.6|lang-python|Compliance mode enabled, was '0.22.6'|
...
|zed|0.222.4|0.226.5|app-editors|Compliance mode enabled, was '0.226.5'|
