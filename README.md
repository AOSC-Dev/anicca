...
## Result
![Relative date](https://img.shields.io/date/1769851255?label=Updated)
...
|aarty|0.6.1|0.8.0|app-utils|Compliance mode enabled, was '0.8.0'|
...
|assimp|5.4.0|6.0.4|runtime-multimedia|Compliance mode enabled, was '6.0.4'|
...
|cachetools|3.1.0|6.2.6|lang-python|Compliance mode enabled, was '6.2.6'|
...
|calibre|8.15.0|9.0.0|app-doc|Compliance mode enabled, was '9.0.0'|
...
|cloudflared|2025.11.1|2026.1.2|app-proxy|Compliance mode enabled, was '2026.1.2'|
...
|crush|0.29.1|0.37.0|app-utils|Compliance mode enabled, was '0.37.0'|
...
|curl|8.17.0|8.18.0|app-web|Compliance mode enabled, was '8.18.0'|
...
|dnscontrol|4.30.0|4.32.0|app-network|Compliance mode enabled, was '4.32.0'|
...
|docker|29.1.2|29.2.0|app-containers||
...
|edencommon|2025.09.01.00|2026.01.26.00|runtime-common|Compliance mode enabled, was '2026.01.26.00'|
...
|fb303|2025.09.01.00|2026.01.26.00|runtime-network|Compliance mode enabled, was '2026.01.26.00'|
|fbthrift|2025.09.01.00|2026.01.26.00|app-network|Compliance mode enabled, was '2026.01.26.00'|
...
|fizz|2025.09.01.00|2026.01.26.00|app-network|Compliance mode enabled, was '2026.01.26.00'|
...
|folly|2025.09.01.00|2026.01.26.00|runtime-common|Compliance mode enabled, was '2026.01.26.00'|
...
|gnome-terminal|3.44.1|3.58.1|desktop-gnome|Compliance mode enabled, was '3.58.1'|
...
|google-chrome|144.0.7559.96|144.0.7559.109|app-web|Compliance mode enabled, was '144.0.7559.109'|
...
|halloy|2025.8|2026.1|app-web|Compliance mode enabled, was '2026.1'|
...
|linux+api|6.12.50|6.12.68|core-devel|Compliance mode enabled, was '6.12.68'|
...
|llama.cpp|7600|7898|runtime-creativity|Compliance mode enabled, was '7898'|
...
|lxgwcleargothic-font|0.508|0.523|desktop-fonts|Compliance mode enabled, was '0.523'|
|lxgwneoxihei-font|1.226|1.239|desktop-fonts|Compliance mode enabled, was '1.239'|
...
|multipath-tools|0.13.0|0.14.1|app-admin|Compliance mode enabled, was '0.14.1'|
...
|mvfst|2025.09.01.00|2026.01.26.00|runtime-network|Compliance mode enabled, was '2026.01.26.00'|
...
|nautilus|42.2|49.3|desktop-gnome|Compliance mode enabled, was '49.3'|
...
|ncurses|6.4|6.6+20260124|runtime-common|Compliance mode enabled, was '6.6-20260124'|
|ncurses+32|6.4|6.6+20260124|runtime-optenv32|Compliance mode enabled, was '6.6-20260124'|
...
|numpy|2.0.1|2.4.1|lang-python|Compliance mode enabled, was '2.4.1'|
|nushell|0.109.1|0.110.0|app-shells|Compliance mode enabled, was '0.110.0'|
...
|ocrmypdf|16.5.0|17.0.1|app-doc|Compliance mode enabled, was '17.0.1'|
|ocserv|1.3.0|1.4.0|app-network|Compliance mode enabled, was '1.4.0'|
|ogre|14.4.1|14.5.1|runtime-imaging|Compliance mode enabled, was '14.5.1'|
...
|pcsx2|1.6.0<br>+git20210825|2.7.85|app-games|Compliance mode enabled, was '2.7.85'|
...
|perl-image-exiftool|13.30|13.47|lang-perl|Compliance mode enabled, was '13.47'|
...
|pmbootstrap|3.6.0|3.9.0|app-utils|Compliance mode enabled, was '3.9.0'|
...
|poetry|2.1.3|2.3.1|lang-python|Compliance mode enabled, was '2.3.1'|
|poetry-core|2.1.3|2.3.0|lang-python|Compliance mode enabled, was '2.3.0'|
...
|rich|13.7.1|14.3.1|lang-python|Compliance mode enabled, was '14.3.1'|
...
|rocm-llama-cpp|7.0.1|7898|runtime-rocm|Compliance mode enabled, was '7898'|
...
|shadow|4.17.2|4.19.2|app-admin|Compliance mode enabled, was '4.19.2'|
...
|sing-box|1.12.17|1.12.18|app-proxy|Compliance mode enabled, was '1.12.18'|
...
|sqlglot|28.1.0|28.7.0|lang-python|Compliance mode enabled, was '28.7.0'|
...
|strawberry|1.2.14|1.2.17|app-multimedia|Compliance mode enabled, was '1.2.17'|
...
|sunshine|2025.924.154138|2026.131.3509|app-multimedia|Compliance mode enabled, was '2026.131.3509'|
...
|tailscale|1.92.5|1.94.1|app-network|Compliance mode enabled, was '1.94.1'|
...
|tree|2.1.1|2.3.0|app-utils|Compliance mode enabled, was '2.3.0'|
...
|usage|2.10.0|2.16.0|app-utils|Compliance mode enabled, was '2.16.0'|
...
|v2ray-rules-dat|202601042214|202601302219|runtime-data|Compliance mode enabled, was '202601302219'<br>Versions not comparable: `202601042214` and `202601302219`|
...
|vacuumtube|1.3.21|1.5.5|app-multimedia|Compliance mode enabled, was '1.5.5'|
...
|vim|9.1.2103|9.1.2119|app-editors|Compliance mode enabled, was '9.1.2119'|
...
|yq|4.50.1|4.52.1|app-devel|Compliance mode enabled, was '4.52.1'|
