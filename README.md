...
## Result
![Relative date](https://img.shields.io/date/1768494332?label=Updated)
...
|alsa-lib|1.2.15.2|1.2.15.3|runtime-multimedia|Compliance mode enabled, was '1.2.15.3'|
|alsa-lib+32|1.2.15.1|1.2.15.3|runtime-optenv32|Compliance mode enabled, was '1.2.15.3'|
|alsa-ucm-conf|1.2.15.1|1.2.15.3|runtime-multimedia|Compliance mode enabled, was '1.2.15.3'|
...
|bash-pinyin-completion-rs|1.0.3|1.0.4|app-shells|Compliance mode enabled, was '1.0.4'|
|bazel|8.5.0|8.5.1|app-devel|Compliance mode enabled, was '8.5.1'|
...
|bear|3.1.6|4.0.1|app-devel|Compliance mode enabled, was '4.0.1'|
...
|boto3|1.40.25|1.42.28|lang-python|Compliance mode enabled, was '1.42.28'|
|botocore|1.42.6|1.42.28|lang-python|Compliance mode enabled, was '1.42.28'|
...
|chromium|142.0.7444.134|144.0.7559.59|app-web|Compliance mode enabled, was '144.0.7559.59'|
...
|cinnamon|5.8.3|6.6.4|desktop-cinnamon|Compliance mode enabled, was '6.6.4'|
...
|code-server|4.107.0|4.108.0|app-utils|Compliance mode enabled, was '4.108.0'|
...
|coolercontrol|3.0.2|3.1.1|app-utils|Compliance mode enabled, was '3.1.1'|
|coreboot-utils|24.08|25.12|app-admin|Compliance mode enabled, was '25.12'|
|corefreq|2.0.9|2.1.0|app-utils|Compliance mode enabled, was '2.1.0'|
...
|crush|0.29.1|0.32.1|app-utils|Compliance mode enabled, was '0.32.1'|
...
|deno|2.6.4|2.6.5|lang-js|Compliance mode enabled, was '2.6.5'|
...
|discord|0.0.119|0.0.120|app-web|Compliance mode enabled, was '0.0.120'|
...
|docker|29.1.2|29.1.4|app-containers||
...
|dust|1.2.3|1.2.4|app-utils|Compliance mode enabled, was '1.2.4'|
...
|edencommon|2025.09.01.00|2026.01.12.00|runtime-common|Compliance mode enabled, was '2026.01.12.00'|
...
|fastfetch|2.56.1|2.57.1|app-utils|Compliance mode enabled, was '2.57.1'|
...
|fb303|2025.09.01.00|2026.01.12.00|runtime-network|Compliance mode enabled, was '2026.01.12.00'|
|fbthrift|2025.09.01.00|2026.01.12.00|app-network|Compliance mode enabled, was '2026.01.12.00'|
...
|fcitx5-pinyin-moegirl|20251210|20260109|app-i18n|Compliance mode enabled, was '20260109'|
...
|firefox|146.0.1|147.0|app-web|Compliance mode enabled, was '147.0'|
...
|fizz|2025.09.01.00|2026.01.12.00|app-network|Compliance mode enabled, was '2026.01.12.00'|
...
|folly|2025.09.01.00|2026.01.12.00|runtime-common|Compliance mode enabled, was '2026.01.12.00'|
...
|forgejo|11.0.0|14.0.0|app-web|Compliance mode enabled, was '14.0.0'|
...
|freerdp|3.17.2|3.20.2|app-network|Compliance mode enabled, was '3.20.2'|
...
|gh|2.83.2|2.85.0|app-devel|Compliance mode enabled, was '2.85.0'|
...
|git-credential-oauth|0.17.1|0.17.2|app-vcs|Compliance mode enabled, was '0.17.2'|
...
|google-chrome|143.0.7499.192|144.0.7559.59|app-web|Compliance mode enabled, was '144.0.7559.59'|
...
|helm|3.17.1|4.0.5|app-containers|Compliance mode enabled, was '4.0.5'|
...
|libreoffice|25.8.0.4|26.2.0.2|groups|Compliance mode enabled, was '26.2.0.2'|
...
|linux+api|6.12.50|6.12.65|core-devel|Compliance mode enabled, was '6.12.65'|
|linux+api+32|6.12.7|6.12.65|runtime-optenv32|Compliance mode enabled, was '6.12.65'|
...
|llama.cpp|7600|7743|runtime-creativity|Compliance mode enabled, was '7743'|
...
|mimalloc|2.2.4|3.2.6|runtime-common|Compliance mode enabled, was '3.2.6'|
...
|mise|2026.1.1|2026.1.2|app-devel|Compliance mode enabled, was '2026.1.2'|
...
|muffin|5.8.0|6.6.1|desktop-cinnamon|Compliance mode enabled, was '6.6.1'|
...
|mvfst|2025.09.01.00|2026.01.12.00|runtime-network|Compliance mode enabled, was '2026.01.12.00'|
...
|netbird|0.59.10|0.62.3|app-network|Compliance mode enabled, was '0.62.3'|
...
|ogre|14.4.1|14.5.0|runtime-imaging|Compliance mode enabled, was '14.5.0'|
...
|openfortivpn|1.24.0|1.24.1|app-network|Compliance mode enabled, was '1.24.1'|
...
|opentofu|1.11.2|1.11.3|app-admin|Compliance mode enabled, was '1.11.3'|
...
|pbs-installer|2025.7.12|2026.1.13|lang-python|Compliance mode enabled, was '2026.1.13'|
...
|pixi|0.59.0|0.63.0|app-devel|Compliance mode enabled, was '0.63.0'|
...
|praat|6.4.49|6.4.55|app-scientific|Compliance mode enabled, was '6.4.55'|
...
|prismlauncher|9.4|10.0.2|app-games|Compliance mode enabled, was '10.0.2'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20260114|lang-python|Compliance mode enabled, was '1.0.2.20260114'|
...
|pywbem|1.7.3|1.8.2|lang-python|Compliance mode enabled, was '1.8.2'|
...
|qpdf|12.2.0|12.3.0|app-doc|Compliance mode enabled, was '12.3.0'|
...
|repo|2.60.1|2.61|app-devel|Compliance mode enabled, was '2.61'|
...
|rocm-llama-cpp|7.0.1|7743|runtime-rocm|Compliance mode enabled, was '7743'|
...
|sunshine|2025.924.154138|2026.115.2907|app-multimedia|Compliance mode enabled, was '2026.115.2907'|
...
|v2ray|5.43.0|5.44.0|app-proxy|Compliance mode enabled, was '5.44.0'|
|v2ray-rules-dat|202601042214|202601142217|runtime-data|Compliance mode enabled, was '202601142217'<br>Versions not comparable: `202601042214` and `202601142217`|
...
|vim|9.1.2006|9.1.2085|app-editors|Compliance mode enabled, was '9.1.2085'|
...
|vulkan-headers|1.4.335.0|1.4.338|runtime-display|Compliance mode enabled, was '1.4.338'|
|vulkan-headers+32|1.4.335.0|1.4.338|runtime-optenv32|Compliance mode enabled, was '1.4.338'|
|vulkan-loader|1.4.335.0|1.4.338|runtime-display|Compliance mode enabled, was '1.4.338'|
|vulkan-loader+32|1.4.335.0|1.4.338|runtime-optenv32|Compliance mode enabled, was '1.4.338'|
...
|vulkan-utility-libraries|1.4.335.0|1.4.338|runtime-display|Compliance mode enabled, was '1.4.338'|
|vulkan-validationlayers|1.4.335.0|1.4.338|runtime-display|Compliance mode enabled, was '1.4.338'|
|waffle|1.8.0|1.8.1|runtime-common|Compliance mode enabled, was '1.8.1'|
|wangle|2025.09.01.00|2026.01.12.00|runtime-network|Compliance mode enabled, was '2026.01.12.00'|
|warpinator|1.6.3|2.0.3|desktop-cinnamon|Compliance mode enabled, was '2.0.3'|
|warzone2100|4.5.5|4.6.2|app-games||
|watchman|2025.09.01.00|2026.01.12.00|app-utils|Compliance mode enabled, was '2026.01.12.00'|
...
|whisper.cpp|1.8.2|1.8.3|runtime-creativity|Compliance mode enabled, was '1.8.3'|
...
|witr|0.2.3|0.2.4|app-utils|Compliance mode enabled, was '0.2.4'|
...
|zed|0.218.6|0.219.4|app-editors|Compliance mode enabled, was '0.219.4'|
...
|zola|0.21.0|0.22.0|app-web|Compliance mode enabled, was '0.22.0'|
