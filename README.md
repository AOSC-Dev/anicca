...
## Result
![Relative date](https://img.shields.io/date/1736425025?label=Updated)
...
|aegisub|3.2.2<br>+git20231203|3.4.1|app-multimedia|Compliance mode enabled, was '3.4.1'|
...
|bat|0.24.0|0.25.0|app-utils|Compliance mode enabled, was '0.25.0'|
|bc|1.07.1|1.08.1|app-utils|Compliance mode enabled, was '1.08.1'|
...
|boto3|1.20.26|1.35.95|lang-python|Compliance mode enabled, was '1.35.95'|
|botocore|1.34.133|1.35.95|lang-python|Compliance mode enabled, was '1.35.95'|
...
|bpftrace|0.21.1|0.22.0|app-admin|Compliance mode enabled, was '0.22.0'|
...
|chromium|131.0.6778.204|131.0.6778.264|app-web|Compliance mode enabled, was '131.0.6778.264'|
...
|cinnamon|5.8.3|6.4.4|groups|Compliance mode enabled, was '6.4.4'|
...
|cpp-utilities|5.20.0|5.27.1|runtime-common|Compliance mode enabled, was '5.27.1'|
...
|ctags|20191203|6.1.20250105.0|app-devel|Compliance mode enabled, was '6.1.20250105.0'<br>Possible downgrade from the current version (20191203 -> 6.1.20250105.0)|
...
|damo|2.4.7|2.6.3|app-admin|Compliance mode enabled, was '2.6.3'|
...
|ddrescue|1.28|1.29|app-utils|Compliance mode enabled, was '1.29'|
...
|dnscontrol|4.15.2|4.15.3|app-network|Compliance mode enabled, was '4.15.3'|
...
|ed|1.20.2|1.21|app-editors|Compliance mode enabled, was '1.21'|
...
|fastfetch|2.33.0|2.34.0|app-utils|Compliance mode enabled, was '2.34.0'|
...
|gh|2.64.0|2.65.0|app-devel|Compliance mode enabled, was '2.65.0'|
...
|gnome-software|42.4|47.3|desktop-gnome|Compliance mode enabled, was '47.3'|
...
|gnupg|2.4.6|2.5.3|app-cryptography|Compliance mode enabled, was '2.5.3'|
...
|gst-plugins-ugly-1-0+32|1.16.2|1.24.11|runtime-optenv32|Compliance mode enabled, was '1.24.11'|
...
|hypothesis-python|6.97.4|6.123.11|lang-python|Compliance mode enabled, was '6.123.11'|
...
|intel-compute-runtime|24.48.31907.7|24.52.32224.5|runtime-scientific|Compliance mode enabled, was '24.52.32224.5'|
...
|intel-graphics-compiler|2.2.3|2.5.6|app-devel|Compliance mode enabled, was '2.5.6'|
...
|jenkins|2.468|2.492|app-admin|Compliance mode enabled, was '2.492'|
...
|libintl-perl|1.29|1.34|lang-perl|Compliance mode enabled, was '1.34'|
...
|marshmallow|3.20.2|3.24.2|lang-python|Compliance mode enabled, was '3.24.2'|
...
|mold|2.35.1|2.36.0|app-devel|Compliance mode enabled, was '2.36.0'|
...
|ncurses|6.4|6.5+20250104|runtime-common|Compliance mode enabled, was '6.5-20250104'|
|ncurses+32|6.4|6.5+20250104|runtime-optenv32|Compliance mode enabled, was '6.5-20250104'|
...
|neomutt|20241114|20250109|app-web|Compliance mode enabled, was '20250109'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.97|app-games|Compliance mode enabled, was '2.3.97'|
...
|praat|6.4.25|6.4.26|app-scientific|Compliance mode enabled, was '6.4.26'|
...
|qownnotes|22.6.1|25.1.3|app-web|Compliance mode enabled, was '25.1.3'|
...
|stress-ng|0.18.07|0.18.09|app-benchmarks|Compliance mode enabled, was '0.18.09'|
...
|syncthing|1.28.1|1.29.0|app-network|Compliance mode enabled, was '1.29.0'|
...
|telegram-desktop|5.10.1|5.10.2|app-web|Compliance mode enabled, was '5.10.2'|
...
|tsukimi|0.18.0|0.18.1|app-multimedia|Compliance mode enabled, was '0.18.1'|
...
|v2ray|5.21.0|5.24.0|app-network|Compliance mode enabled, was '5.24.0'|
|v2ray-rules-dat|202412282210|202501082211|runtime-data|Compliance mode enabled, was '202501082211'<br>Versions not comparable: `202412282210` and `202501082211`|
...
|watchman|4.9.0|2025.01.06.00|app-utils|Compliance mode enabled, was '2025.01.06.00'|
...
|xcffib|0.7.0|1.6.2|lang-python|Compliance mode enabled, was '1.6.2'|
...
|zed|0.167.1|0.168.2|app-editors|Compliance mode enabled, was '0.168.2'|
|zenity|3.42.1|4.0.3|desktop-gnome|Compliance mode enabled, was '4.0.3'|
|zeroconf|0.28.6|0.139.0|lang-python|Compliance mode enabled, was '0.139.0'|
