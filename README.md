...
## Result
![Relative date](https://img.shields.io/date/1743711148?label=Updated)
...
|apt|2.6.1|2.9.35|app-admin|Compliance mode enabled, was '2.9.35'|
...
|bitwarden|2025.2.1|2025.3.0|app-utils|Compliance mode enabled, was '2025.3.0'|
...
|boto3|1.20.26|1.37.26|lang-python|Compliance mode enabled, was '1.37.26'|
|botocore|1.34.133|1.37.26|lang-python|Compliance mode enabled, was '1.37.26'|
...
|cloudflared|2025.2.1|2025.4.0|app-network|Compliance mode enabled, was '2025.4.0'|
...
|composer|2.8.5|2.8.7|app-devel|Compliance mode enabled, was '2.8.7'|
...
|devscripts|2.24.5|2.25.7|app-devel|Compliance mode enabled, was '2.25.7'|
...
|fastfetch|2.40.0|2.40.1|app-utils|Compliance mode enabled, was '2.40.1'|
...
|frescobaldi|3.3.0|4.0.0|app-multimedia|Compliance mode enabled, was '4.0.0'|
...
|fzf|0.55.0|0.61.0|app-utils|Compliance mode enabled, was '0.61.0'|
...
|gawk|5.3.1|5.3.2|app-utils|Compliance mode enabled, was '5.3.2'|
...
|hypothesis-python|6.97.4|6.130.8|lang-python|Compliance mode enabled, was '6.130.8'|
...
|inkscape|1.4|1.4.1|app-creativity|Compliance mode enabled, was '1_4_1'|
...
|lact|0.7.0|0.7.2|app-admin|Compliance mode enabled, was '0.7.2'|
...
|latx|1.5.3-rc1|1.6.0|app-emulation||
...
|libguestfs|1.54.0|1.55.7|runtime-virtualization|Compliance mode enabled, was '1.55.7'|
...
|linux+api+32|6.12.7|6.12.21|runtime-optenv32|Compliance mode enabled, was '6.12.21'|
...
|llama.cpp|4879|5041|runtime-creativity|Compliance mode enabled, was '5041'|
...
|llvm-20|20.1.1|20.1.2|app-devel|Compliance mode enabled, was '20.1.2'|
...
|ncurses|6.4|6.5+20250329|runtime-common|Compliance mode enabled, was '6.5-20250329'|
|ncurses+32|6.4|6.5+20250329|runtime-optenv32|Compliance mode enabled, was '6.5-20250329'|
...
|oolite|1.90|1.91.0.7656-250403-38eccf5|app-games|Compliance mode enabled, was '1.91.0.7656-250403-38eccf5'|
...
|openvpn|2.5.4|2.6.14|app-network|Compliance mode enabled, was '2.6.14'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.251|app-games|Compliance mode enabled, was '2.3.251'|
...
|podman|5.4.1|5.4.2|app-containers||
...
|qownnotes|22.6.1|25.4.0|app-web|Compliance mode enabled, was '25.4.0'|
...
|teams-for-linux|1.13.0|2.0.0|app-web|Compliance mode enabled, was '2.0.0'|
...
|typos|1.30.3|1.31.1|app-utils|Compliance mode enabled, was '1.31.1'|
...
|uv|0.6.11|0.6.12|lang-python|Compliance mode enabled, was '0.6.12'|
|v2ray|5.29.0|5.29.3|app-network|Compliance mode enabled, was '5.29.3'|
|v2ray-rules-dat|202501302211|202504022212|runtime-data|Compliance mode enabled, was '202504022212'<br>Versions not comparable: `202501302211` and `202504022212`|
...
|vim|9.1.1198|9.1.1270|app-editors|Compliance mode enabled, was '9.1.1270'|
...
|xz|5.8.0|5.8.1|app-utils|Compliance mode enabled, was '5.8.1'|
|xz+32|5.8.0|5.8.1|runtime-optenv32|Compliance mode enabled, was '5.8.1'|
...
|zed|0.178.5|0.180.2|app-editors|Compliance mode enabled, was '0.180.2'|
