...
## Result
![Relative date](https://img.shields.io/date/1773401243?label=Updated)
...
|boto3|1.42.54|1.42.67|lang-python|Compliance mode enabled, was '1.42.67'|
|botocore|1.42.54|1.42.67|lang-python|Compliance mode enabled, was '1.42.67'|
...
|chromium|142.0.7444.134|146.0.7680.75|app-web|Compliance mode enabled, was '146.0.7680.75'|
...
|crush|0.29.1|0.48.0|app-utils|Compliance mode enabled, was '0.48.0'|
...
|fonttools|4.53.1|4.62.0|desktop-fonts|Compliance mode enabled, was '4.62.0'|
...
|freerdp|3.23.0|3.24.0|app-network|Compliance mode enabled, was '3.24.0'|
...
|gh|2.87.3|2.88.1|app-devel|Compliance mode enabled, was '2.88.1'|
...
|ghostty|1.2.3|1.3.0|app-utils|Compliance mode enabled, was '1.3.0'|
...
|glances|4.4.0|4.5.1|app-admin|Compliance mode enabled, was '4.5.1'|
...
|gnome-control-center|49.4|49.5|desktop-gnome|Compliance mode enabled, was '49.5'|
...
|google-chrome|145.0.7632.159|146.0.7680.75|app-web|Compliance mode enabled, was '146.0.7680.75'|
...
|groff|1.23.0|1.24.0|app-utils|Compliance mode enabled, was '1.24.0'|
...
|gtk-4|4.20.3|4.22.0|desktop-gnome|Compliance mode enabled, was '4.22.0'|
...
|gvfs|1.58.1|1.59.90|desktop-gnome|Compliance mode enabled, was '1.59.90'|
...
|iana-etc|20260310|20260313|runtime-data|Compliance mode enabled, was '20260313'|
...
|isort|4.3.21|8.0.1|lang-python|Compliance mode enabled, was '8.0.1'|
...
|kweathercore|0.7|25.12.3|desktop-kde|Compliance mode enabled, was '25.12.3'|
...
|libphonenumber|8.13.38|9.0.25|runtime-i18n|Compliance mode enabled, was '9.0.25'|
...
|linux+api|6.12.74|6.12.76|core-devel|Compliance mode enabled, was '6.12.76'|
|linux+api+32|6.12.7|6.12.76|runtime-optenv32|Compliance mode enabled, was '6.12.76'|
...
|llama.cpp|8232|8300|runtime-creativity|Compliance mode enabled, was '8300'|
...
|mise|2026.1.1|2026.3.8|app-devel|Compliance mode enabled, was '2026.3.8'|
...
|mycli|1.42.0|1.63.0|app-database|Compliance mode enabled, was '1.63.0'|
...
|nfs-utils|2.8.4|2.8.6|app-utils|Compliance mode enabled, was '2.8.6'|
...
|nuclei|3.4.2|3.7.1|app-utils|Compliance mode enabled, was '3.7.1'|
...
|openai-python|1.63.2|2.26.0|lang-python|Compliance mode enabled, was '2.26.0'|
...
|papers|49.4|49.5|desktop-gnome|Compliance mode enabled, was '49.5'|
...
|pcsx2|1.6.0<br>+git20210825|2.7.182|app-games|Compliance mode enabled, was '2.7.182'|
...
|perl-image-exiftool|13.30|13.52|lang-perl|Compliance mode enabled, was '13.52'|
...
|plasma-angelfish|22.06|25.12.3|desktop-kde|Compliance mode enabled, was '25.12.3'|
...
|plasma-settings|22.06|26.02.0|desktop-kde|Compliance mode enabled, was '26.02.0'|
...
|pyjwt|2.3.0|2.12.0|lang-python|Compliance mode enabled, was '2.12.0'|
...
|rocm-llama-cpp|7.0.1|8300|runtime-rocm|Compliance mode enabled, was '8300'|
...
|spacebar|23.01.0|25.12.3|desktop-kde|Compliance mode enabled, was '25.12.3'|
...
|sunshine|2025.924.154138|2026.311.154809|app-multimedia|Compliance mode enabled, was '2026.311.154809'|
...
|systemd|259|259.4|app-admin|Compliance mode enabled, was '259.4'|
...
|usage|2.10.0|2.18.2|app-utils|Compliance mode enabled, was '2.18.2'|
...
|v2ray-rules-dat|202601042214|202603122219|runtime-data|Compliance mode enabled, was '202603122219'<br>Versions not comparable: `202601042214` and `202603122219`|
...
|vim|9.2.0|9.2.0148|app-editors|Compliance mode enabled, was '9.2.0148'|
...
|vulkan-extensionlayer|1.4.341.0|1.4.345|runtime-display|Compliance mode enabled, was '1.4.345'|
...
|vulkan-loader|1.4.341.0|1.4.345|runtime-display|Compliance mode enabled, was '1.4.345'|
|vulkan-loader+32|1.4.341.0|1.4.345|runtime-optenv32|Compliance mode enabled, was '1.4.345'|
...
|vulkan-utility-libraries|1.4.341.0|1.4.345|runtime-display|Compliance mode enabled, was '1.4.345'|
|vulkan-validationlayers|1.4.341.0|1.4.345|runtime-display|Compliance mode enabled, was '1.4.345'|
...
|yt-dlp|2026.03.03|2026.03.13|app-multimedia|Compliance mode enabled, was '2026.03.13'|
...
|zen-browser|1.19.1~beta|1.12.10b|app-web|Compliance mode enabled, was '1.12.10b'<br>Possible downgrade from the current version (1.19.1~beta -> 1.12.10b)|
