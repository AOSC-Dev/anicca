...
## Result
![Relative date](https://img.shields.io/date/1777152489?label=Updated)
...
|ab-download-manager|1.8.6|1.8.8|app-web|Compliance mode enabled, was '1.8.8'|
...
|acme|5.3.1|5.5.0|lang-python|Compliance mode enabled, was '5.5.0'|
...
|ccache|4.12.2|4.13.4|app-devel|Compliance mode enabled, was '4.13.4'|
...
|certbot|5.3.1|5.5.0|groups|Compliance mode enabled, was '5.5.0'|
|certbot-apache|5.3.1|5.5.0|app-web|Compliance mode enabled, was '5.5.0'|
|certbot-dns-cloudflare|5.3.1|5.5.0|app-web|Compliance mode enabled, was '5.5.0'|
|certbot-nginx|5.3.1|5.5.0|app-web|Compliance mode enabled, was '5.5.0'|
...
|ctags|6.2.20251005.0|6.2.20260419.0|app-devel|Compliance mode enabled, was '6.2.20260419.0'|
...
|dankmaterialshell|1.4.4|1.4.4.1|runtime-desktop|Compliance mode enabled, was '1.4.4.1'|
...
|fzf|0.66.0|0.71.0|app-utils|Compliance mode enabled, was '0.71.0'|
...
|llama.cpp|8642|8931|runtime-creativity|Compliance mode enabled, was '8931'|
...
|minizip|4.0.10|4.1.2|runtime-common|Compliance mode enabled, was '4.1.2'|
|minuet|23.08.5|26.04.0|desktop-kde|Compliance mode enabled, was '26.04.0'|
|mise|2026.1.1|2026.4.20|app-devel|Compliance mode enabled, was '2026.4.20'|
...
|ncurses|6.6|6.6+20260418|runtime-common|Compliance mode enabled, was '6.6-20260418'|
|ncurses+32|6.6|6.6+20260418|runtime-optenv32|Compliance mode enabled, was '6.6-20260418'|
...
|niri|25.11|26.04|desktop-wm|Compliance mode enabled, was '26.04'|
...
|pathspec|0.11.0|1.1.0|lang-python|Compliance mode enabled, was '1.1.0'|
...
|pcsx2|2.7.181|2.7.289|app-games||
...
|perl-yaml-libyaml|0.85|0.905.0|lang-perl|Compliance mode enabled, was '0.905.0'|
...
|qemu|10.2.2|11.0.0|app-virtualization|Compliance mode enabled, was '11.0.0'|
...
|rdiscount|2.2.7.3|2.2.7.4|lang-ruby|Compliance mode enabled, was '2.2.7.4'|
...
|rocm-aqlprofile|7.2.0|7.13.61130|runtime-rocm|Compliance mode enabled, was '7.13.61130'|
|rocm-bandwidth-test|6.4.3|20250912.42|runtime-rocm|Compliance mode enabled, was '20250912-42'|
|rocm-clr|7.2.0|7.13.61130|runtime-rocm|Compliance mode enabled, was '7.13.61130'|
...
|rocm-core|7.2.0|7.13.61130|runtime-rocm|Compliance mode enabled, was '7.13.61130'|
...
|rocm-llama-cpp|7.0.1|8931|runtime-rocm|Compliance mode enabled, was '8931'|
...
|rocm-rocprofiler-register|7.2.0|7.13.61130|runtime-rocm|Compliance mode enabled, was '7.13.61130'|
...
|rocm-roctracer|7.2.0|7.13.61130|runtime-rocm|Compliance mode enabled, was '7.13.61130'|
|rocm-smi-lib|7.2.0|7.13.61130|runtime-rocm|Compliance mode enabled, was '7.13.61130'|
|rocminfo|7.2.0|7.13.61130|runtime-rocm|Compliance mode enabled, was '7.13.61130'|
|rocr-runtime|7.2.0|7.13.61130|runtime-rocm|Compliance mode enabled, was '7.13.61130'|
...
|sunshine|2025.924.154138|2026.423.21833|app-multimedia|Compliance mode enabled, was '2026.423.21833'|
...
|v2ray-rules-dat|202601042214|202604242234|runtime-data|Compliance mode enabled, was '202604242234'<br>Versions not comparable: `202601042214` and `202604242234`|
...
|vim|9.2.0387|9.2.0392|app-editors|Compliance mode enabled, was '9.2.0392'|
...
|xray|26.3.27|26.4.17|app-proxy|Compliance mode enabled, was '26.4.17'|
