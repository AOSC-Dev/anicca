...
## Result
![Relative date](https://img.shields.io/date/1776400982?label=Updated)
...
|apt|3.0.3|3.2.0|app-admin|Compliance mode enabled, was '3.2.0'|
...
|balz|1.20|.97|app-utils|Compliance mode enabled, was '.97'|
...
|blender|4.4.3|5.1.1|app-creativity|Compliance mode enabled, was '5.1.1'|
...
|boto3|1.42.54|1.42.90|lang-python|Compliance mode enabled, was '1.42.90'|
|botocore|1.42.54|1.42.90|lang-python|Compliance mode enabled, was '1.42.90'|
...
|buf|1.66.1|1.68.1|app-devel|Compliance mode enabled, was '1.68.1'|
...
|coherent.build|0.35.2|0.36.2|lang-python|Compliance mode enabled, was '0.36.2'|
...
|crush|0.56.0|0.59.0|app-utils|Compliance mode enabled, was '0.59.0'|
...
|dash|0.5.12|0.5.13.2|app-shells|Compliance mode enabled, was '0.5.13.2'|
...
|frei0r-plugins|2.5.1|3.1.2|runtime-multimedia|Compliance mode enabled, was '3.1.2'|
...
|gearlever|4.4.8|4.4.10|app-utils|Compliance mode enabled, was '4.4.10'|
...
|gh|2.89.0|2.90.0|app-devel|Compliance mode enabled, was '2.90.0'|
...
|gitea|1.25.4|1.25.5|app-vcs|Compliance mode enabled, was '1.25.5'|
...
|google-chrome|147.0.7727.55|147.0.7727.101|app-web|Compliance mode enabled, was '147.0.7727.101'|
...
|gtk-4|4.22.1|4.22.2|desktop-gnome|Compliance mode enabled, was '4.22.2'|
...
|iana-etc|20260310|20260416|runtime-data|Compliance mode enabled, was '20260416'|
...
|identify|2.6.12|2.6.18|lang-python|Compliance mode enabled, was '2.6.18'|
...
|libdwarf|20210305|2.3.1|runtime-common|Compliance mode enabled, was '2.3.1'<br>Possible downgrade from the current version (20210305 -> 2.3.1)|
...
|libguestfs|1.58.0|1.59.5|runtime-virtualization|Compliance mode enabled, was '1.59.5'|
...
|linux+api|6.12.74|6.12.81|core-devel|Compliance mode enabled, was '6.12.81'|
|linux+api+32|6.12.7|6.12.81|runtime-optenv32|Compliance mode enabled, was '6.12.81'|
...
|linux+kernel+retro|5.10.204|5.10.252|runtime-kernel|Compliance mode enabled, was '5.10.252'|
|linux+kernel+retro+minimal|5.15.17|5.10.252|runtime-kernel|Compliance mode enabled, was '5.10.252'<br>Possible downgrade from the current version (5.15.17 -> 5.10.252)|
...
|llama.cpp|8642|8826|runtime-creativity|Compliance mode enabled, was '8826'|
...
|lxml|6.0.2|6.0.4|lang-python|Compliance mode enabled, was '6.0.4'|
...
|mihomo|1.19.22|1.19.23|app-proxy|Compliance mode enabled, was '1.19.23'|
...
|mise|2026.1.1|2026.4.15|app-devel|Compliance mode enabled, was '2026.4.15'|
...
|motrix-next|3.6.10|3.7.0|app-web|Compliance mode enabled, was '3.7.0'|
...
|musicfox|4.7.1|4.8.4|app-multimedia|Compliance mode enabled, was '4.8.4'|
...
|nanobind|2.6.1|2.12.0|lang-python|Compliance mode enabled, was '2.12.0'|
...
|ncurses|6.6|6.6+20260411|runtime-common|Compliance mode enabled, was '6.6-20260411'|
|ncurses+32|6.6|6.6+20260411|runtime-optenv32|Compliance mode enabled, was '6.6-20260411'|
...
|nexttrace|1.6.1|1.6.2|app-network|Compliance mode enabled, was '1.6.2'|
...
|nvme-cli|2.16|3.0-a.3|app-admin|Compliance mode enabled, was '3.0-a.3'|
...
|openexr|3.1.8|3.4.9|runtime-imaging|Compliance mode enabled, was '3.4.9'|
...
|openrazer|3.11.0|3.12.1|app-devices|Compliance mode enabled, was '3.12.1'|
...
|osu-lazer|2026.305.0-lazer|2026.408.0-tachyon|app-games||
...
|passim|0.1.10|0.1.11|app-network|Compliance mode enabled, was '0.1.11'|
...
|pcsx2|2.7.181|2.7.263|app-games||
...
|perl-image-exiftool|13.52|13.56|lang-perl|Compliance mode enabled, was '13.56'|
...
|pmbootstrap|3.9.0|3.10.1|app-utils|Compliance mode enabled, was '3.10.1'|
...
|praat|6.4.60|6.4.63|app-scientific|Compliance mode enabled, was '6.4.63'|
...
|protonplus|0.5.17|0.5.19|app-utils|Compliance mode enabled, was '0.5.19'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20260412|lang-python|Compliance mode enabled, was '1.0.2.20260412'|
...
|pydantic|2.12.5|2.13.1|lang-python|Compliance mode enabled, was '2.13.1'|
|pydantic-core|2.41.5|2.46.1|lang-python|Compliance mode enabled, was '2.46.1'|
...
|python-daemonize|2.5.0|3.12.1|lang-python|Compliance mode enabled, was '3.12.1'|
...
|rocm-aqlprofile|7.2.0|7.13.61060|runtime-rocm|Compliance mode enabled, was '7.13.61060'|
|rocm-bandwidth-test|6.4.3|20250912.42|runtime-rocm|Compliance mode enabled, was '20250912-42'|
|rocm-clr|7.2.0|7.13.61060|runtime-rocm|Compliance mode enabled, was '7.13.61060'|
...
|rocm-core|7.2.0|7.13.61060|runtime-rocm|Compliance mode enabled, was '7.13.61060'|
...
|rocm-llama-cpp|7.0.1|8826|runtime-rocm|Compliance mode enabled, was '8826'|
...
|rocm-rocprofiler-register|7.2.0|7.13.61060|runtime-rocm|Compliance mode enabled, was '7.13.61060'|
...
|rocm-roctracer|7.2.0|7.13.61060|runtime-rocm|Compliance mode enabled, was '7.13.61060'|
|rocm-smi-lib|7.2.0|7.13.61060|runtime-rocm|Compliance mode enabled, was '7.13.61060'|
|rocminfo|7.2.0|7.13.61060|runtime-rocm|Compliance mode enabled, was '7.13.61060'|
|rocr-runtime|7.2.0|7.13.61060|runtime-rocm|Compliance mode enabled, was '7.13.61060'|
...
|sunshine|2025.924.154138|2026.415.34134|app-multimedia|Compliance mode enabled, was '2026.415.34134'|
...
|tea|0.12.0|0.13.0|app-devel|Compliance mode enabled, was '0.13.0'|
...
|tectonic|0.12.0|0.16.8|app-doc|Compliance mode enabled, was '0.16.8'|
...
|v2ray-rules-dat|202601042214|202604162234|runtime-data|Compliance mode enabled, was '202604162234'<br>Versions not comparable: `202601042214` and `202604162234`|
...
|vacuumtube|1.3.21|1.6.3|app-multimedia|Compliance mode enabled, was '1.6.3'|
...
|vim|9.2.0280|9.2.0360|app-editors|Compliance mode enabled, was '9.2.0360'|
...
|warzone2100|4.5.5|4.7.0|app-games||
...
|xray|26.3.27|26.4.15|app-proxy|Compliance mode enabled, was '26.4.15'|
...
|xstreamingdesktop|1.8.2|1.9.8|app-games|Compliance mode enabled, was '1.9.8'|
...
|yard|0.9.37|0.9.42|app-doc|Compliance mode enabled, was '0.9.42'|
...
|yq|4.52.4|4.52.5|app-devel|Compliance mode enabled, was '4.52.5'|
...
|yubikey-manager|5.9.0|5.9.1|app-devices|Compliance mode enabled, was '5.9.1'|
...
|zed|0.228.0|0.232.2|app-editors|Compliance mode enabled, was '0.232.2'|
