...
## Result
![Relative date](https://img.shields.io/date/1761797649?label=Updated)
...
|adguardhome|0.107.67|0.107.68|app-web|Compliance mode enabled, was '0.107.68'|
...
|archlinux-keyring|20251012|20251027|runtime-data|Compliance mode enabled, was '20251027'|
...
|breezy|3.3.12|3.3.15|app-vcs|Compliance mode enabled, was '3.3.15'|
|brltty|6.6|6.8|app-a11y|Compliance mode enabled, was '6.8'|
|brotli|1.1.0|1.2.0|app-utils|Compliance mode enabled, was '1.2.0'|
...
|cherry-studio|1.6.1|1.6.5|app-utils|Compliance mode enabled, was '1.6.5'|
...
|cloudflared|2025.7.0|2025.10.0|app-proxy|Compliance mode enabled, was '2025.10.0'|
...
|crush|0.12.3|0.13.5|app-utils|Compliance mode enabled, was '0.13.5'|
...
|deprecated|1.2.14|1.3.0|lang-python|Compliance mode enabled, was '1.3.0'|
...
|dnsdiag|2.6.0|2.9.0|app-network|Compliance mode enabled, was '2.9.0'|
...
|docker-compose|2.35.0|2.40.2|app-containers|Compliance mode enabled, was '2.40.2'|
...
|gh|2.82.0|2.82.1|app-devel|Compliance mode enabled, was '2.82.1'|
...
|glab|1.72.0|1.74.0|app-devel|Compliance mode enabled, was '1.74.0'|
...
|google-auth|1.6.3|2.42.0|lang-python|Compliance mode enabled, was '2.42.0'|
...
|gtk4-layer-shell|1.2.0|1.3.0|desktop-gnome|Compliance mode enabled, was '1.3.0'|
...
|kubo|0.33.2|0.38.2|app-proxy|Compliance mode enabled, was '0.38.2'|
...
|llama.cpp|6615|6880|runtime-creativity|Compliance mode enabled, was '6880'|
...
|man-pages|6.15|6.16|runtime-data||
...
|mesa|25.2.5|25.2.6|runtime-display|Compliance mode enabled, was '25.2.6'|
|mesa+32|25.2.5|25.2.6|runtime-optenv32||
...
|mise|2025.8.9|2025.10.20|app-devel|Compliance mode enabled, was '2025.10.20'|
...
|orocos-kdl|1.5.1|1.5.3|runtime-common|Compliance mode enabled, was '1.5.3'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.258|app-games|Compliance mode enabled, was '2.5.258'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20251030|lang-python|Compliance mode enabled, was '1.0.2.20251030'|
...
|pykdl|1.5.1|1.5.3|runtime-common|Compliance mode enabled, was '1.5.3'|
...
|rdflib|6.2.0|7.3.0|lang-python|Compliance mode enabled, was '7.3.0'|
...
|rocm-llama-cpp|7.0.1|6880|runtime-rocm|Compliance mode enabled, was '6880'|
...
|teams-for-linux|2.2.1|2.6.6|app-web|Compliance mode enabled, was '2.6.6'|
...
|unrar|6.2.2|7.2.1|app-utils|Compliance mode enabled, was '7.2.1'|
...
|usage|2.2.2|2.5.1|app-utils|Compliance mode enabled, was '2.5.1'|
...
|uv|0.9.5|0.9.6|lang-python|Compliance mode enabled, was '0.9.6'|
...
|vim|9.1.1837|9.1.1888|app-editors|Compliance mode enabled, was '9.1.1888'|
...
|vulkan-extensionlayer|1.4.328.1|1.4.330|runtime-display|Compliance mode enabled, was '1.4.330'|
|vulkan-headers|1.4.328.1|1.4.330|runtime-display|Compliance mode enabled, was '1.4.330'|
|vulkan-headers+32|1.4.328.1|1.4.330|runtime-optenv32|Compliance mode enabled, was '1.4.330'|
|vulkan-loader|1.4.328.1|1.4.330|runtime-display|Compliance mode enabled, was '1.4.330'|
|vulkan-loader+32|1.4.328.1|1.4.330|runtime-optenv32|Compliance mode enabled, was '1.4.330'|
...
|vulkan-utility-libraries|1.4.328.1|1.4.330|runtime-display|Compliance mode enabled, was '1.4.330'|
|vulkan-validationlayers|1.4.328.1|1.4.330|runtime-display|Compliance mode enabled, was '1.4.330'|
...
|z3|4.15.3|4.15.4|app-devel|Compliance mode enabled, was '4.15.4'|
...
|zathura-djvu|0.2.10|0.2.11|app-doc|Compliance mode enabled, was '0.2.11'|
|zathura-pdf-poppler|0.3.3|0.3.4|app-doc|Compliance mode enabled, was '0.3.4'|
|zathura-ps|0.2.8|0.2.9|app-doc|Compliance mode enabled, was '0.2.9'|
