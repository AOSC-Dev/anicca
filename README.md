...
## Result
![Relative date](https://img.shields.io/date/1743289817?label=Updated)
...
|apicula|0.14|0.17|app-electronics|Compliance mode enabled, was '0.17'|
...
|asahi-audio|3.0|3.2|runtime-multimedia|Compliance mode enabled, was '3.2'|
...
|bcachefs-tools|1.9.4|1.25.0|app-admin|Compliance mode enabled, was '1.25.0'|
...
|bluedevil|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
|blueprint-compiler|0.12.0|0.16.0|app-devel|Compliance mode enabled, was '0.16.0'|
|bluez|5.79|5.80|app-devices|Compliance mode enabled, was '5.80'|
...
|boto3|1.20.26|1.37.23|lang-python|Compliance mode enabled, was '1.37.23'|
|botocore|1.34.133|1.37.23|lang-python|Compliance mode enabled, was '1.37.23'|
...
|breeze|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
|breeze-grub|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
|breeze-gtk|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
|breeze-icons|5.115.0|6.12.0|desktop-kde|Compliance mode enabled, was '6.12.0'|
|breeze-plymouth|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|chromium|131.0.6778.264|134.0.6998.165|app-web|Compliance mode enabled, was '134.0.6998.165'|
...
|containers-common|0.62.2|0.62.3|runtime-containers||
...
|damo|2.4.7|2.7.2|app-admin|Compliance mode enabled, was '2.7.2'|
...
|devscripts|2.24.5|2.25.6|app-devel|Compliance mode enabled, was '2.25.6'|
...
|digikam|8.5.0|8.6.0|desktop-kde|Compliance mode enabled, was '8.6.0'|
...
|fb303|2024.12.30.00|2025.03.24.00|runtime-network|Compliance mode enabled, was '2025.03.24.00'|
|fbthrift|2024.12.30.00|2025.03.24.00|app-network|Compliance mode enabled, was '2025.03.24.00'|
...
|fizz|2024.12.30.00|2025.03.24.00|app-network|Compliance mode enabled, was '2025.03.24.00'|
...
|folly|2024.12.30.00|2025.03.24.00|runtime-common|Compliance mode enabled, was '2025.03.24.00'|
...
|fwupd|1.9.25|2.0.7|app-admin|Compliance mode enabled, was '2.0.7'|
...
|gsasl|1.10.0|2.2.1|runtime-admin|Compliance mode enabled, was '2.2.1'|
...
|hmcl|3.6.11|3.6.12|app-games|Compliance mode enabled, was '3.6.12'|
...
|hypothesis-python|6.97.4|6.130.5|lang-python|Compliance mode enabled, was '6.130.5'|
...
|imagemagick|6.9.13<br>+16|6.9.13+24|app-utils|Compliance mode enabled, was '6.9.13-24'|
|imagemagick+7|7.1.1<br>+32|7.1.1+46|app-utils|Compliance mode enabled, was '7.1.1-46'|
...
|iosevka-fonts|33.1.0|33.2.0|desktop-fonts|Compliance mode enabled, was '33.2.0'|
...
|iwd|3.2|3.5|app-network|Compliance mode enabled, was '3.5'|
...
|jenkins|2.468|2.503|app-admin|Compliance mode enabled, was '2.503'|
...
|kactivitymanagerd|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kddockwidgets|1.3.1|2.2.2|runtime-desktop|Compliance mode enabled, was '2.2.2'|
|kde-cli-tools|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kde-gtk-config|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kdecoration|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kdeplasma-addons|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kgamma|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|khotkeys|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kinfocenter|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kmenuedit|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kpipewire|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kscreen|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
|kscreenlocker|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|ksshaskpass|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|ksystemstats|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kwallet-pam|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|kwrited|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|layer-shell-qt|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|libcbor|0.8.0|0.12.0|runtime-common|Compliance mode enabled, was '0.12.0'|
...
|libclc|18.1.8|20.1.1|runtime-devices|Compliance mode enabled, was '20.1.1'|
...
|libinput|1.27.1|1.28.0|runtime-devices|Compliance mode enabled, was '1.28.0'|
...
|libkscreen|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|libksysguard|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|libreoffice|25.2.1.2|25.2.2.2|groups|Compliance mode enabled, was '25.2.2.2'|
...
|libusb|1.0.23|1.0.28|runtime-devices|Compliance mode enabled, was '1.0.28'|
...
|libxmlb|0.3.15|0.3.22|runtime-common|Compliance mode enabled, was '0.3.22'|
...
|linux+api|6.12.15|6.12.21|core-devel|Compliance mode enabled, was '6.12.21'|
...
|llama.cpp|4879|4991|runtime-creativity|Compliance mode enabled, was '4991'|
...
|llvm-18|18.1.8|20.1.1|app-devel|Compliance mode enabled, was '20.1.1'|
|llvm-19|19.1.6|20.1.1|app-devel|Compliance mode enabled, was '20.1.1'|
|llvm-runtime+wasi|18.1.8|20.1.1|runtime-wasi|Compliance mode enabled, was '20.1.1'|
...
|mise|2025.2.8|2025.3.11|app-devel|Compliance mode enabled, was '2025.3.11'|
...
|mousepad|0.6.3|0.6.4|desktop-xfce|Compliance mode enabled, was '0.6.4'|
...
|mpfr|4.2.1|4.2.2|core-libs|Compliance mode enabled, was '4.2.2'|
...
|mvfst|2024.12.30.00|2025.03.24.00|runtime-network|Compliance mode enabled, was '2025.03.24.00'|
...
|ncurses|6.4|6.5+20250322|runtime-common|Compliance mode enabled, was '6.5-20250322'|
|ncurses+32|6.4|6.5+20250322|runtime-optenv32|Compliance mode enabled, was '6.5-20250322'|
...
|nokogiri|1.18.4|1.18.6|lang-ruby|Compliance mode enabled, was '1.18.6'|
...
|nvtop|3.1.0<br>+git20250220|3.2.0|app-admin|Compliance mode enabled, was '3.2.0'|
|obconf-qt|0.16.4|0.16.5|desktop-lxqt|Compliance mode enabled, was '0.16.5'|
|obs-studio|31.0.2|31.0.3|app-multimedia|Compliance mode enabled, was '31.0.3'|
...
|oolite|1.90|1.91.0.7653-250327-526e5d5|app-games|Compliance mode enabled, was '1.91.0.7653-250327-526e5d5'|
...
|openrazer|3.10.0|3.10.1|app-devices|Compliance mode enabled, was '3.10.1'|
...
|oxygen-sounds|5.25.3|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|patch|2.7.6|2.8|app-devel|Compliance mode enabled, was '2.8'|
...
|plasma-firewall|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
|plasma-framework|5.115.0|6.12.0|desktop-kde|Compliance mode enabled, was '6.12.0'|
|plasma-integration|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|plymouth-kcm|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|pmbootstrap|3.3.1|3.3.2|app-utils|Compliance mode enabled, was '3.3.2'|
...
|polkit-kde-agent-1|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|powerdevil|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|pydantic-core|2.16.1|2.33.0|lang-python|Compliance mode enabled, was '2.33.0'|
...
|scrcpy|3.1|3.2|app-devices|Compliance mode enabled, was '3.2'|
...
|sddm-kcm|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|systemsettings|5.27.12|6.3.3|desktop-kde|Compliance mode enabled, was '6.3.3'|
...
|tauri-cli|2.2.4|2.4.0|lang-rust|Compliance mode enabled, was '2.4.0'|
...
|thunderbird|136.0|128.8.1|app-web|Compliance mode enabled, was '128.8.1'<br>Possible downgrade from the current version (136.0 -> 128.8.1)|
...
|typos|1.30.3|1.31.0|app-utils|Compliance mode enabled, was '1.31.0'|
...
|v2ray-rules-dat|202501302211|202503282213|runtime-data|Compliance mode enabled, was '202503282213'<br>Versions not comparable: `202501302211` and `202503282213`|
...
|waydroid|1.5.0|1.5.1|app-emulation|Compliance mode enabled, was '1.5.1'|
...
|zed|0.178.5|0.179.4|app-editors|Compliance mode enabled, was '0.179.4'|
