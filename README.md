...
## Result
![Relative date](https://img.shields.io/date/1748002772?label=Updated)
...
|ab-download-manager|1.6.1|1.6.2|app-web|Compliance mode enabled, was '1.6.2'|
...
|apt|3.0.1|3.1.0|app-admin|Compliance mode enabled, was '3.1.0'|
...
|audit|4.0.2|4.0.4b|app-admin|Compliance mode enabled, was '4.0.4b'|
...
|bird|2.15.1|3.1.1|app-network|Compliance mode enabled, was '3.1.1'|
...
|boto3|1.20.26|1.38.22|lang-python|Compliance mode enabled, was '1.38.22'|
|botocore|1.34.133|1.38.22|lang-python|Compliance mode enabled, was '1.38.22'|
...
|chezmoi|2.62.3|2.62.5|app-utils|Compliance mode enabled, was '2.62.5'|
...
|chromium|135.0.7049.95|136.0.7103.113|app-web|Compliance mode enabled, was '136.0.7103.113'|
...
|cockpit|286.1|339|app-admin|Compliance mode enabled, was '339'|
|cockpit-machines|284.1|332|app-admin|Compliance mode enabled, was '332'|
|cockpit-podman|63|106|app-admin|Compliance mode enabled, was '106'|
...
|corefreq|20170301|2.0.3|app-utils|Compliance mode enabled, was '2.0.3'<br>Possible downgrade from the current version (20170301 -> 2.0.3)|
...
|cryptography|40.0.0|45.0.2|lang-python|Compliance mode enabled, was '45.0.2'|
...
|cxxopts|3.2.0|3.3.0|runtime-common|Compliance mode enabled, was '3.3.0'|
...
|cython-0.29|0.29.36|3.1.1|lang-python|Compliance mode enabled, was '3.1.1'|
...
|deno|1.44.1|2.3.3|lang-js|Compliance mode enabled, was '2.3.3'|
...
|fastfetch|2.43.0|2.44.0|app-utils|Compliance mode enabled, was '2.44.0'|
...
|fb303|2025.03.24.00|2025.05.19.00|runtime-network|Compliance mode enabled, was '2025.05.19.00'|
|fbthrift|2025.03.10.00|2025.05.19.00|app-network|Compliance mode enabled, was '2025.05.19.00'|
...
|fizz|2025.03.24.00|2025.05.19.00|app-network|Compliance mode enabled, was '2025.05.19.00'|
...
|folly|2025.03.24.00|2025.05.19.00|runtime-common|Compliance mode enabled, was '2025.05.19.00'|
...
|fonttools|4.53.1|4.58.0|desktop-fonts|Compliance mode enabled, was '4.58.0'|
...
|helm|3.17.1|3.18.0|app-containers|Compliance mode enabled, was '3.18.0'|
...
|hugo|0.147.3|0.147.5|app-web|Compliance mode enabled, was '0.147.5'|
...
|hypothesis-python|6.97.4|6.131.23|lang-python|Compliance mode enabled, was '6.131.23'|
...
|jenkins|2.468|2.511|app-admin|Compliance mode enabled, was '2.511'|
...
|jmol|14.30.0|16.3.23|app-scientific|Compliance mode enabled, was '16.3.23'|
...
|kernel-tools|6.14.7|5.19.17|app-admin|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.14.7 -> 5.19.17)|
...
|libarchive|3.7.8|3.8.0|runtime-common|Compliance mode enabled, was '3.8.0'|
...
|libguestfs|1.54.1|1.55.13|runtime-virtualization|Compliance mode enabled, was '1.55.13'|
...
|libreoffice|25.2.3.2|25.2.4.1|app-productivity|Compliance mode enabled, was '25.2.4.1'|
...
|libxfce4windowing|4.20.2|4.20.3|desktop-xfce|Compliance mode enabled, was '4.20.3'|
...
|linux+api|6.12.23|6.12.30|core-devel|Compliance mode enabled, was '6.12.30'|
|linux+api+32|6.12.7|6.12.30|runtime-optenv32|Compliance mode enabled, was '6.12.30'|
|linux+kernel|6.14.7|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.14.7 -> 5.19.17)|
...
|linux+kernel+lts|6.12.29|5.10.237|runtime-kernel|Compliance mode enabled, was '5.10.237'<br>Possible downgrade from the current version (6.12.29 -> 5.10.237)|
...
|linux-kernel|6.14.7|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.14.7 -> 5.19.17)|
|linux-kernel-lts|6.12.29|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.12.29 -> 5.19.17)|
|linux-kernel-rc|6.15.0|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.15.0 -> 5.19.17)|
|linux-kernel-retro|5.10.204|5.10.237|runtime-kernel|Compliance mode enabled, was '5.10.237'|
|linux-kernel-retro-minimal|5.15.17|5.10.237|runtime-kernel|Compliance mode enabled, was '5.10.237'<br>Possible downgrade from the current version (5.15.17 -> 5.10.237)|
...
|llama.cpp|5298|5466|runtime-creativity|Compliance mode enabled, was '5466'|
...
|llvm-18|18.1.8|20.1.5|app-devel|Compliance mode enabled, was '20.1.5'|
|llvm-19|19.1.6|20.1.5|app-devel|Compliance mode enabled, was '20.1.5'|
|llvm-runtime+wasi|18.1.8|20.1.5|runtime-wasi|Compliance mode enabled, was '20.1.5'|
...
|lxgwcleargothic-font|0.300.4|0.501|desktop-fonts|Compliance mode enabled, was '0.501'|
|lxgwneoxihei-font|1.213|1.216.2|desktop-fonts|Compliance mode enabled, was '1.216.2'|
...
|matplotlib|3.8.0|3.10.3|lang-python|Compliance mode enabled, was '3.10.3'|
...
|mise|2025.5.6|2025.5.10|app-devel|Compliance mode enabled, was '2025.5.10'|
...
|mold|2.38.0|2.39.1|app-devel|Compliance mode enabled, was '2.39.1'|
...
|ncurses|6.4|6.5+20250517|runtime-common|Compliance mode enabled, was '6.5-20250517'|
|ncurses+32|6.4|6.5+20250517|runtime-optenv32|Compliance mode enabled, was '6.5-20250517'|
...
|netavark|1.13.0|1.15.0|runtime-containers|Compliance mode enabled, was '1.15.0'|
...
|openai-python|1.63.2|1.82.0|lang-python|Compliance mode enabled, was '1.82.0'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.364|app-games|Compliance mode enabled, was '2.3.364'|
...
|perl-encode-imaputf7|1.05|1.06|lang-perl|Compliance mode enabled, was '1.06'|
...
|pipewire|1.4.2|1.4.3|app-multimedia|Compliance mode enabled, was '1.4.3'|
...
|protobuf|25.2|31.0|runtime-common|Compliance mode enabled, was '31.0'|
...
|pypdf|4.0.1|5.5.0|lang-python|Compliance mode enabled, was '5.5.0'|
|pypdf2|1.26.0|5.5.0|lang-python|Compliance mode enabled, was '5.5.0'|
...
|pytools|2019.1|2025.1.5|lang-python|Compliance mode enabled, was '2025.1.5'|
...
|qmmp|1.6.5|2.2.6|app-multimedia|Compliance mode enabled, was '2.2.6'|
...
|scikit-build-core|0.11.1|0.11.3|lang-python|Compliance mode enabled, was '0.11.3'|
...
|setuptools-python2|44.1.0|80.8.0|lang-python|Compliance mode enabled, was '80.8.0'|
|setuptools-python3|75.8.0|80.8.0|lang-python|Compliance mode enabled, was '80.8.0'|
...
|sip|6.10.0|6.11.0|lang-python|Compliance mode enabled, was '6.11.0'|
...
|skopeo|1.18.0|1.19.0|app-containers|Compliance mode enabled, was '1.19.0'|
...
|sqlite|3490200|3.49.2|app-database|Possible downgrade from the current version (3490200 -> 3.49.2)|
...
|sunshine|2025.122.141614|2025.521.235641|app-multimedia|Compliance mode enabled, was '2025.521.235641'|
...
|tailscale|1.82.5|1.84.0|app-network|Compliance mode enabled, was '1.84.0'|
...
|thunar|4.20.2|4.20.3|desktop-xfce|Compliance mode enabled, was '4.20.3'|
|thunar-archive-plugin|0.5.3|0.6.0|desktop-xfce|Compliance mode enabled, was '0.6.0'|
...
|uv|0.7.6|0.7.7|lang-python|Compliance mode enabled, was '0.7.7'|
|v2ray|5.31.0|5.32.0|app-network|Compliance mode enabled, was '5.32.0'|
|v2ray-rules-dat|202501302211|202505222213|runtime-data|Compliance mode enabled, was '202505222213'<br>Versions not comparable: `202501302211` and `202505222213`|
...
|vim|9.1.1343|9.1.1404|app-editors|Compliance mode enabled, was '9.1.1404'|
...
|vscodium|1.100.03093|1.100.23258|app-editors|Compliance mode enabled, was '1.100.23258'|
...
|vulkan-extensionlayer|1.4.309.0|1.4.315|runtime-display|Compliance mode enabled, was '1.4.315'|
...
|vulkan-validationlayers|1.4.309.0|1.4.315|runtime-display|Compliance mode enabled, was '1.4.315'|
|waffle|1.8.0|1.8.1|runtime-common|Compliance mode enabled, was '1.8.1'|
|wangle|2025.03.24.00|2025.05.19.00|runtime-network|Compliance mode enabled, was '2025.05.19.00'|
|warpinator|1.6.3|1.8.8|desktop-cinnamon|Compliance mode enabled, was '1.8.8'|
|warzone2100|4.5.3|4.5.5|app-games||
|watchman|2025.03.24.00|2025.05.19.00|app-utils|Compliance mode enabled, was '2025.05.19.00'|
...
|xfce4-panel-profiles|1.0.15|1.1.1|desktop-xfce|Compliance mode enabled, was '1.1.1'|
|xfce4-pulseaudio-plugin|0.4.9|0.5.1|desktop-xfce|Compliance mode enabled, was '0.5.1'|
|xfce4-screenshooter|1.11.1|1.11.2|desktop-xfce|Compliance mode enabled, was '1.11.2'|
...
|xfce4-taskmanager|1.5.8|1.6.0|desktop-xfce|Compliance mode enabled, was '1.6.0'|
...
|yara|4.5.0|4.5.3|app-utils|Compliance mode enabled, was '4.5.3'|
...
|zed|0.186.8|0.187.6|app-editors|Compliance mode enabled, was '0.187.6'|
...
|zig|0.14.0|0.14.1|lang-ziglang|Compliance mode enabled, was '0.14.1'|
