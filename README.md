...
## Result
![Relative date](https://img.shields.io/date/1733303619?label=Updated)
...
|aiohttp|3.7.4.post0|3.11.9|lang-python|Compliance mode enabled, was '3.11.9'|
...
|ast-grep|0.30.0|0.30.1|app-devel|Compliance mode enabled, was '0.30.1'|
...
|boto3|1.20.26|1.35.74|lang-python|Compliance mode enabled, was '1.35.74'|
|botocore|1.34.133|1.35.74|lang-python|Compliance mode enabled, was '1.35.74'|
...
|chromium|127.0.6533.119|131.0.6778.108|app-web|Compliance mode enabled, was '131.0.6778.108'|
...
|cinnamon|5.8.3|6.4.1|groups|Compliance mode enabled, was '6.4.1'|
|cinnamon-control-center|5.8.1|6.4.0|desktop-cinnamon|Compliance mode enabled, was '6.4.0'|
...
|cockpit|286.1|329.1|app-admin|Compliance mode enabled, was '329.1'|
...
|damo|2.4.7|2.5.8|app-admin|Compliance mode enabled, was '2.5.8'|
...
|docker-buildx|0.18.0|0.19.1|app-containers|Compliance mode enabled, was '0.19.1'|
...
|fastfetch|2.30.1|2.31.0|app-utils|Compliance mode enabled, was '2.31.0'|
...
|fwupd|1.9.25|2.0.2|app-admin|Compliance mode enabled, was '2.0.2'|
...
|gh|2.63.0|2.63.1|app-devel|Compliance mode enabled, was '2.63.1'|
...
|gnupg|2.4.6|2.5.1|app-cryptography|Compliance mode enabled, was '2.5.1'|
...
|google-chrome|131.0.6778.85|131.0.6778.108|app-web|Compliance mode enabled, was '131.0.6778.108'|
...
|hwdata|0.389|0.390|runtime-data|Compliance mode enabled, was '0.390'|
...
|hypothesis-python|6.97.4|6.122.1|lang-python|Compliance mode enabled, was '6.122.1'|
...
|intel-gmmlib|22.5.2|22.5.4|runtime-devices|Compliance mode enabled, was '22.5.4'|
...
|linux-firmware|20241128|20241110|runtime-kernel|Possible downgrade from the current version (20241128 -> 20241110)|
|linux-kernel|6.11.10|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.11.10 -> 5.19.17)|
...
|lowdown|1.1.2|1.3.0|app-doc|Compliance mode enabled, was '1_3_0'|
...
|mako|1.1.4|1.3.7|lang-python|Compliance mode enabled, was '1.3.7'|
...
|maturin|1.7.4|1.7.7|lang-python|Compliance mode enabled, was '1.7.7'|
...
|mpd|0.23.15|0.23.16|app-multimedia|Compliance mode enabled, was '0.23.16'|
...
|ncurses|6.4|6.5+20241130|runtime-common|Compliance mode enabled, was '6.5-20241130'|
|ncurses+32|6.4|6.5+20241130|runtime-optenv32|Compliance mode enabled, was '6.5-20241130'|
|neatvnc|0.7.1|0.9.1|runtime-network|Compliance mode enabled, was '0.9.1'|
|nemo|5.8.3|6.4.2|desktop-cinnamon|Compliance mode enabled, was '6.4.2'|
...
|nodejs-22|22.11.0|22.12.0|lang-js|Compliance mode enabled, was '22.12.0'|
|noip|2.1.9|3.0.0|app-network|Compliance mode enabled, was '3.0.0'|
|nokogiri|1.16.7|1.16.8|lang-ruby|Compliance mode enabled, was '1.16.8'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.42|app-games|Compliance mode enabled, was '2.3.42'|
...
|perl-image-exiftool|12.50|13.04|lang-perl|Compliance mode enabled, was '13.04'|
...
|pv|1.6.20|1.9.7|app-utils|Compliance mode enabled, was '1.9.7'|
...
|pyglet|1.3.2|2.0.19|lang-python|Compliance mode enabled, was '2.0.19'|
...
|qownnotes|22.6.1|24.12.0|app-web|Compliance mode enabled, was '24.12.0'|
...
|strawberry|1.0.23|1.2.2|app-multimedia|Compliance mode enabled, was '1.2.2'|
...
|telegram-desktop|5.8.1|5.8.5|app-web|Compliance mode enabled, was '5.8.5'|
...
|thunderbird|128.5.0esr|128.5.1|app-web|Compliance mode enabled, was '128.5.1'|
...
|wireplumber|0.5.6|0.5.7|app-multimedia|Compliance mode enabled, was '0.5.7'|
...
|xray|24.11.21|24.11.30|app-network|Compliance mode enabled, was '24.11.30'|
...
|yt-dlp|2024.11.18|2024.12.03|app-multimedia|Compliance mode enabled, was '2024.12.03'|
...
|zed|0.163.2|0.163.3|app-editors|Compliance mode enabled, was '0.163.3'|
...
|zotero|6.0.26|7.0.10|app-productivity|Compliance mode enabled, was '7.0.10'|
