...
## Result
![Relative date](https://img.shields.io/date/1762064380?label=Updated)
...
|acbs|20250918|20251101|app-devel|Compliance mode enabled, was '20251101'|
...
|bluedevil|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|breeze-grub|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|breeze-gtk|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|cherry-studio|1.6.1|1.6.6|app-utils|Compliance mode enabled, was '1.6.6'|
...
|cpufetch|1.06|1.07|app-utils|Compliance mode enabled, was '1.07'|
...
|croc|10.2.4|10.2.7|app-utils|Compliance mode enabled, was '10.2.7'|
...
|ctags|6.2.20251005.0|6.2.20251026.0|app-devel|Compliance mode enabled, was '6.2.20251026.0'|
...
|damo|2.4.7|3.0.2|app-admin|Compliance mode enabled, was '3.0.2'|
...
|dart-sass|1.93.2|1.93.3|app-devel|Compliance mode enabled, was '1.93.3'|
|dart-sass-js|1.93.2|1.93.3|app-devel|Compliance mode enabled, was '1.93.3'|
...
|devscripts|2.25.20|2.25.22|app-devel|Compliance mode enabled, was '2.25.22'|
...
|discover|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|dnsdiag|2.6.0|2.9.1|app-network|Compliance mode enabled, was '2.9.1'|
...
|drkonqi|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|edencommon|2025.09.01.00|2025.10.27.00|runtime-common|Compliance mode enabled, was '2025.10.27.00'|
...
|fb303|2025.09.01.00|2025.10.27.00|runtime-network|Compliance mode enabled, was '2025.10.27.00'|
|fbthrift|2025.09.01.00|2025.10.27.00|app-network|Compliance mode enabled, was '2025.10.27.00'|
...
|fizz|2025.09.01.00|2025.10.27.00|app-network|Compliance mode enabled, was '2025.10.27.00'|
...
|fluidsynth|2.3.6|2.5.1|app-multimedia|Compliance mode enabled, was '2.5.1'|
...
|folly|2025.09.01.00|2025.10.27.00|runtime-common|Compliance mode enabled, was '2025.10.27.00'|
...
|freetds|1.00.112|1.5.7|runtime-database|Compliance mode enabled, was '1.5.7'|
...
|glab|1.72.0|1.75.0|app-devel|Compliance mode enabled, was '1.75.0'|
...
|hmcl|3.6.20|3.6.18|app-games|Compliance mode enabled, was '3.6.18'<br>Possible downgrade from the current version (3.6.20 -> 3.6.18)|
...
|hypothesis-python|6.97.4|6.143.1|lang-python|Compliance mode enabled, was '6.143.1'|
...
|incus|6.17.0|6.18.0|app-containers|Compliance mode enabled, was '6.18.0'|
...
|kactivitymanagerd|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kcm-wacomtablet|3.2.0|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kde-cli-tools|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kde-gtk-config|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kdecoration|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kdeplasma-addons|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|khotkeys|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kinfocenter|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kmenuedit|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kpipewire|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|ksshaskpass|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|ksystemstats|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kwallet-pam|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kwayland-integration|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kwin|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|kwrited|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|latx|1.6.1|1.6.3|app-emulation||
|layer-shell-qt|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|lego|4.25.1|4.28.0|app-web|Compliance mode enabled, was '4.28.0'|
...
|libclc|18.1.8|21.1.4|runtime-devices|Compliance mode enabled, was '21.1.4'|
...
|libdrm|2.4.126|2.4.128|runtime-display|Compliance mode enabled, was '2.4.128'|
|libdrm+32|2.4.126|2.4.128|runtime-optenv32|Compliance mode enabled, was '2.4.128'|
...
|libguestfs|1.54.1|1.57.5|runtime-virtualization|Compliance mode enabled, was '1.57.5'|
...
|libkscreen|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|libksysguard|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|linux+api|6.12.30|6.12.56|core-devel|Compliance mode enabled, was '6.12.56'|
|linux+api+32|6.12.7|6.12.56|runtime-optenv32|Compliance mode enabled, was '6.12.56'|
...
|llama.cpp|6615|6920|runtime-creativity|Compliance mode enabled, was '6920'|
...
|llvm-18|18.1.8|21.1.4|app-devel|Compliance mode enabled, was '21.1.4'|
|llvm-19|19.1.6|21.1.4|app-devel|Compliance mode enabled, was '21.1.4'|
|llvm-20|20.1.8|21.1.4|app-devel|Compliance mode enabled, was '21.1.4'|
|llvm-runtime+wasi|20.1.8|21.1.4|runtime-wasi|Compliance mode enabled, was '21.1.4'|
...
|milou|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|mise|2025.8.9|2025.11.1|app-devel|Compliance mode enabled, was '2025.11.1'|
...
|mvfst|2025.09.01.00|2025.10.27.00|runtime-network|Compliance mode enabled, was '2025.10.27.00'|
...
|openai-python|1.63.2|2.6.1|lang-python|Compliance mode enabled, was '2.6.1'|
...
|osu-lazer|2025.816.0-lazer|2025.1029.1-lazer|app-games||
...
|oxygen|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|oxygen-icons|5.115.0|6.19.0|desktop-kde|Compliance mode enabled, was '6.19.0'|
|oxygen-sounds|5.25.3|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|pbr|6.0.0|7.0.2|lang-python|Compliance mode enabled, was '7.0.2'|
...
|plasma-browser-integration|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-desktop|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-disks|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-firewall|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-framework|5.115.0|6.19.0|desktop-kde|Compliance mode enabled, was '6.19.0'|
|plasma-integration|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-mobile|5.27.5|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-nano|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-nm|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-pa|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-pk-updates|0.3.2|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-sdk|5.27.12.1|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-settings|22.06|25.07.0|desktop-kde|Compliance mode enabled, was '25.07.0'|
|plasma-systemmonitor|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-thunderbolt|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-vault|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-wayland-protocols|1.10.0|1.19.0|desktop-kde|Compliance mode enabled, was '1.19.0'|
|plasma-welcome|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-workspace|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|plasma-workspace-wallpapers|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|pydantic|2.6.0|2.12.3|lang-python|Compliance mode enabled, was '2.12.3'|
|pydantic-core|2.16.1|2.41.4|lang-python|Compliance mode enabled, was '2.41.4'|
...
|regex|2019.02.21|2025.10.23|lang-python|Compliance mode enabled, was '2025.10.23'|
...
|rocm-llama-cpp|7.0.1|6920|runtime-rocm|Compliance mode enabled, was '6920'|
...
|rocm-smi-lib|7.0.1|7.0.2|runtime-rocm|Compliance mode enabled, was '7.0.2'|
...
|ruri|3.9.2|3.9.3|app-admin|Compliance mode enabled, was '3.9.3'|
|rust-bindgen|0.72.0|0.72.1|lang-rust|Compliance mode enabled, was '0.72.1'|
|rustc|1.90.0|1.91.0|lang-rust|Compliance mode enabled, was '1.91.0'|
...
|sddm-kcm|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
...
|solaar|1.1.14|1.1.16|app-utils|Compliance mode enabled, was '1.1.16'|
...
|systemsettings|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
|systemtap|5.2|5.4|app-utils|Compliance mode enabled, was '5.4'|
...
|tauri-cli|2.8.4|2.9.2|lang-rust|Compliance mode enabled, was '2.9.2'|
...
|teams-for-linux|2.2.1|2.6.8|app-web|Compliance mode enabled, was '2.6.8'|
...
|usage|2.2.2|2.5.2|app-utils|Compliance mode enabled, was '2.5.2'|
...
|v2ray-rules-dat|202510042211|202511012212|runtime-data|Compliance mode enabled, was '202511012212'<br>Versions not comparable: `202510042211` and `202511012212`|
...
|vim|9.1.1837|9.1.1895|app-editors|Compliance mode enabled, was '9.1.1895'|
...
|vscodium|1.105.16954|1.105.17075|app-editors|Compliance mode enabled, was '1.105.17075'|
...
|wangle|2025.09.01.00|2025.10.27.00|runtime-network|Compliance mode enabled, was '2025.10.27.00'|
|warpinator|1.6.3|1.8.10|desktop-cinnamon|Compliance mode enabled, was '1.8.10'|
|warzone2100|4.5.5|4.6.1|app-games||
|watchman|2025.09.01.00|2025.10.27.00|app-utils|Compliance mode enabled, was '2025.10.27.00'|
...
|whisper.cpp|1.7.6|1.8.2|runtime-creativity|Compliance mode enabled, was '1.8.2'|
...
|xdg-desktop-portal-kde|5.27.12|6.5.1|desktop-kde|Compliance mode enabled, was '6.5.1'|
