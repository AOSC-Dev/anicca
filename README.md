...
## Result
![Relative date](https://img.shields.io/date/1776573838?label=Updated)
...
|bazel|8.5.0|9.0.2|app-devel|Compliance mode enabled, was '9.0.2'|
...
|boinc|8.2.8|8.2.10|app-scientific|Compliance mode enabled, was '8.2.10'|
...
|boto3|1.42.54|1.42.91|lang-python|Compliance mode enabled, was '1.42.91'|
|botocore|1.42.54|1.42.91|lang-python|Compliance mode enabled, was '1.42.91'|
...
|cachetools|7.0.4|7.0.5|lang-python|Compliance mode enabled, was '7.0.5'|
...
|ccache|4.12.2|4.13.3|app-devel|Compliance mode enabled, was '4.13.3'|
...
|cherry-studio|1.7.13|1.9.1|app-utils|Compliance mode enabled, was '1.9.1'|
...
|ctags|6.2.20251005.0|6.2.20260329.0|app-devel|Compliance mode enabled, was '6.2.20260329.0'|
...
|ddnet|19.0|19.8.1|app-games|Compliance mode enabled, was '19.8.1'|
...
|docker|29.1.4|29.4.0|app-containers||
...
|easytier|2.4.5|2.6.0|app-network|Compliance mode enabled, was '2.6.0'|
...
|fido2|2.0.0|2.2.0|lang-python|Compliance mode enabled, was '2.2.0'|
...
|firefox|149.0|149.0.2|app-web|Compliance mode enabled, was '149.0.2'|
...
|gearlever|4.4.8|4.5.2|app-utils|Compliance mode enabled, was '4.5.2'|
...
|glances|4.4.1|4.5.3.2|app-admin|Compliance mode enabled, was '4.5.3.2'|
...
|harfbuzz|12.3.0|14.1.0|runtime-desktop|Compliance mode enabled, was '14.1.0'|
|harfbuzz+32|12.3.0|14.1.0|runtime-optenv32|Compliance mode enabled, was '14.1.0'|
...
|iosevka-fonts|34.1.0|34.3.0|desktop-fonts|Compliance mode enabled, was '34.3.0'|
...
|js-140|140.6.0esr|140.9.1|lang-js|Compliance mode enabled, was '140.9.1'|
...
|libsodium|1.0.21|1.0.20-final|runtime-cryptography|Compliance mode enabled, was '1.0.20-FINAL'<br>Possible downgrade from the current version (1.0.21 -> 1.0.20-final)|
...
|llama.cpp|8642|8840|runtime-creativity|Compliance mode enabled, was '8840'|
...
|lxqt-config|1.4.0|2.3.2|desktop-lxqt|Compliance mode enabled, was '2.3.2'|
...
|lxqt-panel|1.4.0|2.3.3|desktop-lxqt|Compliance mode enabled, was '2.3.3'|
...
|miller|6.15.0|6.17.0|app-utils|Compliance mode enabled, was '6.17.0'|
|milou|5.27.12|6.6.4|desktop-kde|Compliance mode enabled, was '6.6.4'|
|mimalloc|3.2.8|3.3.0|runtime-common|Compliance mode enabled, was '3.3.0'|
...
|mise|2026.1.1|2026.4.17|app-devel|Compliance mode enabled, was '2026.4.17'|
...
|motrix-next|3.7.0|3.7.2|app-web|Compliance mode enabled, was '3.7.2'|
...
|mvfst|2026.03.02.00|2026.04.13.00|runtime-network|Compliance mode enabled, was '2026.04.13.00'|
|mxml|3.3.1|4.0.4|runtime-common|Compliance mode enabled, was '4.0.4'|
|mycli|1.66.0|1.68.1|app-database|Compliance mode enabled, was '1.68.1'|
...
|netbird|0.68.1|0.68.3|app-network|Compliance mode enabled, was '0.68.3'|
...
|nghttp2|1.65.0|1.68.1|runtime-web|Compliance mode enabled, was '1.68.1'|
...
|ocrmypdf|17.4.0|17.4.1|app-doc|Compliance mode enabled, was '17.4.1'|
...
|osu-lazer|2026.305.0-lazer|2026.418.0-lazer|app-games||
...
|pcsx2|2.7.181|2.7.274|app-games||
...
|pixi|0.59.0|0.67.0|app-devel|Compliance mode enabled, was '0.67.0'|
...
|proton-bridge|3.21.2|3.24.1|app-web|Compliance mode enabled, was '3.24.1'|
...
|py-filelock|3.14.0|3.28.0|lang-python|Compliance mode enabled, was '3.28.0'|
...
|pybind11|3.0.2|3.0.3|lang-python|Compliance mode enabled, was '3.0.3'|
...
|rclone|1.73.3|1.73.4|app-web|Compliance mode enabled, was '1.73.4'|
...
|rocm-llama-cpp|7.0.1|8840|runtime-rocm|Compliance mode enabled, was '8840'|
...
|rootlesskit|2.3.5|3.0.0|app-admin|Compliance mode enabled, was '3.0.0'|
...
|sing-box|1.13.6|1.13.8|app-proxy|Compliance mode enabled, was '1.13.8'|
...
|sqlglot|30.0.3|30.4.3|lang-python|Compliance mode enabled, was '30.4.3'|
...
|sunshine|2025.924.154138|2026.417.201619|app-multimedia|Compliance mode enabled, was '2026.417.201619'|
...
|the-honkers-railway-launcher|1.14.3|1.14.4|app-games|Compliance mode enabled, was '1.14.4'|
...
|v2ray-rules-dat|202601042214|202604182228|runtime-data|Compliance mode enabled, was '202604182228'<br>Versions not comparable: `202601042214` and `202604182228`|
...
|vim|9.2.0360|9.2.0361|app-editors|Compliance mode enabled, was '9.2.0361'|
...
|wangle|2026.03.02.00|2026.04.13.00|runtime-network|Compliance mode enabled, was '2026.04.13.00'|
|warzone2100|4.6.3|4.7.0|app-games|Compliance mode enabled, was '4.7.0'|
|watchman|2026.03.02.00|2026.04.13.00|groups|Compliance mode enabled, was '2026.04.13.00'|
