...
## Result
![Relative date](https://img.shields.io/date/1742437271?label=Updated)
...
|aoscbootstrap|0.8.4|0.8.5|app-utils|Compliance mode enabled, was '0.8.5'|
|apache-maven|3.9.8|3.9.9|lang-java|Compliance mode enabled, was '3.9.9'|
|apicula|0.14|0.16|app-electronics|Compliance mode enabled, was '0.16'|
...
|apt|2.6.1|2.9.33|app-admin|Compliance mode enabled, was '2.9.33'|
...
|at-spi2-core|2.52.0|2.56.0|desktop-gnome|Compliance mode enabled, was '2.56.0'|
|at-spi2-core+32|2.52.0|2.56.0|runtime-optenv32|Compliance mode enabled, was '2.56.0'|
...
|boto3|1.20.26|1.37.16|lang-python|Compliance mode enabled, was '1.37.16'|
|botocore|1.34.133|1.37.16|lang-python|Compliance mode enabled, was '1.37.16'|
...
|buildah|1.39.2|1.39.3|app-containers|Compliance mode enabled, was '1.39.3'|
...
|ccache|4.10.2|4.11.1|app-devel|Compliance mode enabled, was '4.11.1'|
...
|deno|1.44.1|2.2.4|lang-js|Compliance mode enabled, was '2.2.4'|
...
|edencommon|2024.12.30.00|2025.03.17.00|runtime-common|Compliance mode enabled, was '2025.03.17.00'|
...
|fakeroot|1.37|1.37.1|app-utils|Compliance mode enabled, was '1.37.1'|
...
|fb303|2024.12.30.00|2025.03.17.00|runtime-network|Compliance mode enabled, was '2025.03.17.00'|
...
|firefox|136.0|136.0.2|app-web|Compliance mode enabled, was '136.0.2'|
...
|fizz|2024.12.30.00|2025.03.17.00|app-network|Compliance mode enabled, was '2025.03.17.00'|
...
|folly|2024.12.30.00|2025.03.17.00|runtime-common|Compliance mode enabled, was '2025.03.17.00'|
...
|gh|2.68.1|2.69.0|app-devel|Compliance mode enabled, was '2.69.0'|
...
|gimp|2.10.38|3.0.0|app-creativity|Compliance mode enabled, was '3_0_0'|
...
|gnome-calculator|42.2|48.0|desktop-gnome|Compliance mode enabled, was '48.0'|
...
|google-api-python-client|1.7.11|2.165.0|lang-python|Compliance mode enabled, was '2.165.0'|
...
|hypothesis-python|6.97.4|6.129.4|lang-python|Compliance mode enabled, was '6.129.4'|
...
|jenkins|2.468|2.502|app-admin|Compliance mode enabled, was '2.502'|
...
|level-zero|1.21.2|1.21.3|runtime-common|Compliance mode enabled, was '1.21.3'|
|levenshtein|0.12.0|0.27.1|lang-python|Compliance mode enabled, was '0.27.1'|
|lfortran|0.47.0|0.49.0|app-devel|Compliance mode enabled, was '0.49.0'|
...
|llama.cpp|4879|4927|runtime-creativity|Compliance mode enabled, was '4927'|
...
|llvm-20|20.1.0|20.1.1|app-devel|Compliance mode enabled, was '20.1.1'|
...
|lxgwcleargothic-font|0.300.4|0.342.1|desktop-fonts|Compliance mode enabled, was '0.342.1'|
|lxgwneoxihei-font|1.213|1.215|desktop-fonts|Compliance mode enabled, was '1.215'|
...
|mercurial|6.8.1|6.9.4|app-vcs|Compliance mode enabled, was '6.9.4'|
...
|mise|2025.2.8|2025.3.6|app-devel|Compliance mode enabled, was '2025.3.6'|
...
|mvfst|2024.12.30.00|2025.03.17.00|runtime-network|Compliance mode enabled, was '2025.03.17.00'|
...
|nokogiri|1.18.4|1.18.5|lang-ruby|Compliance mode enabled, was '1.18.5'|
...
|openai-python|1.63.2|1.67.0|lang-python|Compliance mode enabled, was '1.67.0'|
...
|openjdk-8|8u442-ga|8u452-b06|lang-java||
...
|pcp|6.0.1|6.3.6|app-utils|Compliance mode enabled, was '6.3.6'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.232|app-games|Compliance mode enabled, was '2.3.232'|
...
|qownnotes|22.6.1|25.3.3|app-web|Compliance mode enabled, was '25.3.3'|
...
|setuptools-python2|44.1.0|77.0.1|lang-python|Compliance mode enabled, was '77.0.1'|
|setuptools-python3|75.8.0|77.0.1|lang-python|Compliance mode enabled, was '77.0.1'|
...
|shadowsocks-rust|1.22.0|1.23.0|app-network|Compliance mode enabled, was '1.23.0'|
...
|vim|9.1.1198|9.1.1227|app-editors|Compliance mode enabled, was '9.1.1227'|
...
|xarchiver|0.5.4.15|0.5.4.24|app-utils|Compliance mode enabled, was '0.5.4.24'|
