...
## Result
![Relative date](https://img.shields.io/date/1734355407?label=Updated)
...
|boto3|1.20.26|1.35.81|lang-python|Compliance mode enabled, was '1.35.81'|
|botocore|1.34.133|1.35.81|lang-python|Compliance mode enabled, was '1.35.81'|
...
|bzip3|1.4.0|1.5.0|app-utils|Compliance mode enabled, was '1.5.0'|
...
|docker-compose|2.30.3|2.32.0|app-containers|Compliance mode enabled, was '2.32.0'|
...
|freerdp|3.9.0|3.10.1|app-network|Compliance mode enabled, was '3.10.1'|
...
|ghc|9.4.8|9.12.1|lang-haskell|Compliance mode enabled, was '9.12.1'|
...
|helm|3.16.1|3.16.3|app-containers|Compliance mode enabled, was '3.16.3'|
...
|kbd|2.5.1|2.7|app-utils|Compliance mode enabled, was '2.7'|
...
|linux+api|6.12.4|5.19.17|core-devel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.12.4 -> 5.19.17)|
...
|pcsx2|1.6.0<br>+git20210825|2.3.60|app-games|Compliance mode enabled, was '2.3.60'|
...
|perl-yaml-tiny|1.73|1.75|lang-perl|Compliance mode enabled, was '1.75'|
...
|repo|2.45|2.49.3|app-devel|Compliance mode enabled, was '2.49.3'|
...
|ruby-bundler|2.1.4|2.5.23|lang-ruby|Compliance mode enabled, was '2.5.23'|
...
|sequoia-sq|0.36.0|0.40.0|app-cryptography|Compliance mode enabled, was '0.40.0'|
...
|sos|4.4|4.8.1|lang-python|Compliance mode enabled, was '4.8.1'|
...
|typos|1.24.6|1.28.3|app-utils|Compliance mode enabled, was '1.28.3'|
...
|v2ray-rules-dat|202412012212|202412152212|runtime-data|Compliance mode enabled, was '202412152212'<br>Versions not comparable: `202412012212` and `202412152212`|
...
|vim|9.1.0906|9.1.0931|app-editors|Compliance mode enabled, was '9.1.0931'|
