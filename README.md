...
## Result
![Relative date](https://img.shields.io/date/1759375529?label=Updated)
...
|apt|3.0.3|3.1.6|app-admin|Compliance mode enabled, was '3.1.6'|
...
|b4|0.14.2|0.14.3|app-devel|Compliance mode enabled, was '0.14.3'|
...
|boto3|1.40.25|1.40.43|lang-python|Compliance mode enabled, was '1.40.43'|
|botocore|1.40.25|1.40.43|lang-python|Compliance mode enabled, was '1.40.43'|
...
|cockpit|286.1|347|app-admin|Compliance mode enabled, was '347'|
|cockpit-machines|284.1|340|app-admin|Compliance mode enabled, was '340'|
|cockpit-podman|63|113|app-admin|Compliance mode enabled, was '113'|
...
|firefox|143.0.1|143.0.3|app-web|Compliance mode enabled, was '143.0.3'|
...
|gh|2.80.0|2.81.0|app-devel|Compliance mode enabled, was '2.81.0'|
...
|hugo|0.149.0|0.150.1|app-web|Compliance mode enabled, was '0.150.1'|
...
|krita|5.2.9|5.2.13|app-creativity|Compliance mode enabled, was '5.2.13'|
...
|libdrm|2.4.125|2.4.126|runtime-display|Compliance mode enabled, was '2.4.126'|
|libdrm+32|2.4.124|2.4.126|runtime-optenv32|Compliance mode enabled, was '2.4.126'|
...
|libgbinder|1.1.42|1.1.43|runtime-common|Compliance mode enabled, was '1.1.43'|
...
|libindi|2.1.1|2.1.5.1|runtime-scientific|Compliance mode enabled, was '2.1.5.1'|
...
|linux+api|6.12.30|6.12.49|core-devel|Compliance mode enabled, was '6.12.49'|
|linux+api+32|6.12.7|6.12.49|runtime-optenv32|Compliance mode enabled, was '6.12.49'|
...
|llama.cpp|6615|6663|runtime-creativity|Compliance mode enabled, was '6663'|
...
|netbird|0.55.1|0.59.0|app-network|Compliance mode enabled, was '0.59.0'|
...
|openai-python|1.63.2|2.0.1|lang-python|Compliance mode enabled, was '2.0.1'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20251001|lang-python|Compliance mode enabled, was '1.0.2.20251001'|
...
|pydantic-core|2.16.1|2.40.0|lang-python|Compliance mode enabled, was '2.40.0'|
...
|rocm-llama-cpp|6.4.3|6663|runtime-rocm|Compliance mode enabled, was '6663'|
...
|v2ray-rules-dat|202508312212|202510012212|runtime-data|Compliance mode enabled, was '202510012212'<br>Versions not comparable: `202508312212` and `202510012212`|
