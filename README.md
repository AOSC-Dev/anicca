...
## Result
![Relative date](https://img.shields.io/date/1746857643?label=Updated)
...
|bash-startup|0.7.2|0.7.1|runtime-data|Compliance mode enabled, was '0.7.1'<br>Possible downgrade from the current version (0.7.2 -> 0.7.1)|
