...
## Result
![Relative date](https://img.shields.io/date/1735675881?label=Updated)
...
|boto3|1.20.26|1.35.90|lang-python|Compliance mode enabled, was '1.35.90'|
|botocore|1.34.133|1.35.90|lang-python|Compliance mode enabled, was '1.35.90'|
...
|ciel|3.5.2|3.8.5|app-devel|Compliance mode enabled, was '3.8.5'|
...
|ctags|20191203|6.1.20241229.0|app-devel|Compliance mode enabled, was '6.1.20241229.0'<br>Possible downgrade from the current version (20191203 -> 6.1.20241229.0)|
...
|deskflow|1.17.1|1.18.0|app-utils|Compliance mode enabled, was '1.18.0'|
...
|devscripts|2.24.5|2.24.9|app-devel|Compliance mode enabled, was '2.24.9'|
...
|elinks|0.17.0|0.18.0|app-web|Compliance mode enabled, was '0.18.0'|
...
|eza|0.19.0|0.20.14|app-utils|Compliance mode enabled, was '0.20.14'|
...
|fmt|10.2.1|11.1.1|runtime-common|Compliance mode enabled, was '11.1.1'|
...
|gettext|0.22.5|0.23.1|app-devel|Compliance mode enabled, was '0.23.1'|
...
|gitoxide|0.39.0|0.40.0|app-vcs|Compliance mode enabled, was '0.40.0'|
...
|glances|4.0.5|4.3.0.6|app-admin|Compliance mode enabled, was '4.3.0.6'|
...
|hypothesis-python|6.97.4|6.123.2|lang-python|Compliance mode enabled, was '6.123.2'|
...
|intel-gmmlib|22.5.5|22.6.0|runtime-devices|Compliance mode enabled, was '22.6.0'|
...
|kitty|0.36.2|0.38.1|app-utils|Compliance mode enabled, was '0.38.1'|
...
|libxcrypt|4.4.36|4.4.37|core-libs|Compliance mode enabled, was '4.4.37'|
|libxcrypt+32|4.4.36|4.4.37|runtime-optenv32|Compliance mode enabled, was '4.4.37'|
...
|linux+api|6.12.5|6.12.7|core-devel|Compliance mode enabled, was '6.12.7'|
...
|mihomo|1.19.0|1.19.1|app-network|Compliance mode enabled, was '1.19.1'|
...
|nettle|3.10|3.10.1|runtime-cryptography|Compliance mode enabled, was '3.10.1'|
...
|nokogiri|1.16.7|1.18.1|lang-ruby|Compliance mode enabled, was '1.18.1'|
...
|oolite|1.90|1.91.0.7647-241230-5e1c242|app-games|Compliance mode enabled, was '1.91.0.7647-241230-5e1c242'|
...
|osu-lazer|2024.1224.1|2025.101.0|app-games|Compliance mode enabled, was '2025.101.0'|
...
|psutils|3.3.2|3.3.8|lang-python|Compliance mode enabled, was '3.3.8'|
...
|pv|1.6.20|1.9.25|app-utils|Compliance mode enabled, was '1.9.25'|
...
|pyqt-builder|1.12.1|1.17.1|lang-python|Compliance mode enabled, was '1.17.1'|
...
|qownnotes|22.6.1|25.1.0|app-web|Compliance mode enabled, was '25.1.0'|
...
|qtractor|0.9.23|1.5.1|app-multimedia|Compliance mode enabled, was '1.5.1'|
...
|ruamel-yaml|0.17.19|0.18.7|lang-python|Compliance mode enabled, was '0.18.7'|
...
|ruby-ffi|1.10.0|1.17.1|lang-ruby|Compliance mode enabled, was '1.17.1'|
...
|shadow|4.15.1|4.17.0|app-admin|Compliance mode enabled, was '4.17.0'|
...
|streamlink|6.7.4|7.1.1|app-multimedia|Compliance mode enabled, was '7.1.1'|
...
|telegram-desktop|5.9.0|5.9.2|app-web|Compliance mode enabled, was '5.9.2'|
...
|texinfo|7.1|7.2|app-utils|Compliance mode enabled, was '7.2'|
...
|tree-sitter|0.24.3|0.24.6|app-devel|Compliance mode enabled, was '0.24.6'|
...
|typos|1.24.6|1.29.0|app-utils|Compliance mode enabled, was '1.29.0'|
...
|v2ray-rules-dat|202412282210|202412302211|runtime-data|Compliance mode enabled, was '202412302211'<br>Versions not comparable: `202412282210` and `202412302211`|
...
|vim|9.1.0981|9.1.0983|app-editors|Compliance mode enabled, was '9.1.0983'|
...
|x264|0<br>+git20241027|3203|runtime-multimedia|Compliance mode enabled, was '3203'|
|x264+32|20160827.2245|3203|runtime-optenv32|Compliance mode enabled, was '3203'<br>Possible downgrade from the current version (20160827.2245 -> 3203)|
...
|xray|24.12.18|24.12.31|app-network|Compliance mode enabled, was '24.12.31'|
