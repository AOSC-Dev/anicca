...
## Result
![Relative date](https://img.shields.io/date/1734109827?label=Updated)
...
|autobuild4|4.6.1|4.6.0|app-devel|Compliance mode enabled, was '4.6.0'<br>Possible downgrade from the current version (4.6.1 -> 4.6.0)|
...
|boto3|1.20.26|1.35.80|lang-python|Compliance mode enabled, was '1.35.80'|
|botocore|1.34.133|1.35.80|lang-python|Compliance mode enabled, was '1.35.80'|
|bottle|0.12.18|0.13.2|lang-python|Compliance mode enabled, was '0.13.2'|
|bottles|2022.2.28<br>+trento<br>+4|51.16|app-utils|Compliance mode enabled, was '51.16'<br>Possible downgrade from the current version (2022.2.28+trento+4 -> 51.16)|
...
|ctags|20191203|6.1.20241208.0|app-devel|Compliance mode enabled, was '6.1.20241208.0'<br>Possible downgrade from the current version (20191203 -> 6.1.20241208.0)|
...
|intel-compute-runtime|24.39.31294.12|24.48.31907.6|runtime-scientific|Compliance mode enabled, was '24.48.31907.6'|
...
|level-zero|1.18.3|1.19.2|runtime-common|Compliance mode enabled, was '1.19.2'|
...
|libnfs|4.0.0|6.0.1|runtime-network|Compliance mode enabled, was '6.0.1'|
|libnfs-static|4.0.0|6.0.1|runtime-network|Compliance mode enabled, was '6.0.1'|
...
|lpsolve|5.5.2.5|5.6.22|app-scientific|Compliance mode enabled, was '5.6.22'|
...
|perl-image-exiftool|12.50|13.07|lang-perl|Compliance mode enabled, was '13.07'|
...
|qemu|9.0.1|9.2.0|app-virtualization|Compliance mode enabled, was '9.2.0'|
...
|texstudio|4.0.2|4.8.4|app-doc|Compliance mode enabled, was '4.8.4'|
...
|v2ray-rules-dat|202412012212|202412122213|runtime-data|Compliance mode enabled, was '202412122213'<br>Versions not comparable: `202412012212` and `202412122213`|
...
|vim|9.1.0906|9.1.0923|app-editors|Compliance mode enabled, was '9.1.0923'|
...
|waylyrics|0.3.18|0.3.20|app-multimedia|Compliance mode enabled, was '0.3.20'|
...
|xfwm4|4.18.0|4.19.1|desktop-xfce|Compliance mode enabled, was '4.19.1'|
...
|yt-dlp|2024.12.03|2024.12.13|app-multimedia|Compliance mode enabled, was '2024.12.13'|
