...
## Result
![Relative date](https://img.shields.io/date/1753490930?label=Updated)
...
|anubis|1.21.0|1.21.3|app-web|Compliance mode enabled, was '1.21.3'|
...
|apsw|3.30.1|3.50.3.0|lang-python|Compliance mode enabled, was '3.50.3.0'|
...
|ast-grep|0.38.2|0.39.1|app-devel|Compliance mode enabled, was '0.39.1'|
...
|bitwarden|2025.6.1|2025.7.0|app-utils|Compliance mode enabled, was '2025.7.0'|
...
|boto3|1.20.26|1.39.14|lang-python|Compliance mode enabled, was '1.39.14'|
|botocore|1.34.133|1.39.14|lang-python|Compliance mode enabled, was '1.39.14'|
...
|bulky|3.4|3.7|desktop-cinnamon|Compliance mode enabled, was '3.7'|
...
|cherry-studio|1.5.1|1.5.3|app-utils|Compliance mode enabled, was '1.5.3'|
|chezmoi|2.63.0|2.63.1|app-utils|Compliance mode enabled, was '2.63.1'|
...
|chromium|135.0.7049.95|138.0.7204.168|app-web|Compliance mode enabled, was '138.0.7204.168'|
...
|code-server|4.93.1|4.102.2|app-utils|Compliance mode enabled, was '4.102.2'|
...
|crun|1.16.1|1.23|app-admin|Compliance mode enabled, was '1.23'|
...
|devscripts|2.24.5|2.25.16|app-devel|Compliance mode enabled, was '2.25.16'|
...
|dkcli|0.4.6|0.4.7|app-admin|Compliance mode enabled, was '0.4.7'|
...
|edencommon|2025.03.24.00|2025.07.21.00|runtime-common|Compliance mode enabled, was '2025.07.21.00'|
...
|fb303|2025.03.24.00|2025.07.21.00|runtime-network|Compliance mode enabled, was '2025.07.21.00'|
|fbthrift|2025.03.10.00|2025.07.21.00|app-network|Compliance mode enabled, was '2025.07.21.00'|
...
|feeluown-qqmusic|1.0.5|1.0.9|app-multimedia|Compliance mode enabled, was '1.0.9'|
...
|fizz|2025.03.24.00|2025.07.21.00|app-network|Compliance mode enabled, was '2025.07.21.00'|
...
|flashrom|1.3.0|1.6.0|app-admin|Compliance mode enabled, was '1.6.0'|
...
|folly|2025.03.24.00|2025.07.21.00|runtime-common|Compliance mode enabled, was '2025.07.21.00'|
...
|glab|1.63.0|1.64.0|app-devel|Compliance mode enabled, was '1.64.0'|
...
|google-chrome|138.0.7204.157|138.0.7204.168|app-web|Compliance mode enabled, was '138.0.7204.168'|
...
|helix|25.01.1|25.07.1|app-editors|Compliance mode enabled, was '25.07.1'|
...
|hmcl|3.6.14|3.6.15|app-games|Compliance mode enabled, was '3.6.15'|
...
|hypothesis-python|6.97.4|6.136.4|lang-python|Compliance mode enabled, was '6.136.4'|
...
|jenkins|2.468|2.520|app-admin|Compliance mode enabled, was '2.520'|
...
|just|1.42.3|1.42.4|app-devel|Compliance mode enabled, was '1.42.4'|
...
|kodi-inputstream-adaptive|21.5.14|22.2.6-piers|app-multimedia|Compliance mode enabled, was '22.2.6-Piers'|
...
|linux+api|6.12.30|6.12.40|core-devel|Compliance mode enabled, was '6.12.40'|
|linux+api+32|6.12.7|6.12.40|runtime-optenv32|Compliance mode enabled, was '6.12.40'|
...
|llama.cpp|5298|5994|runtime-creativity|Compliance mode enabled, was '5994'|
...
|lxgwcleargothic-font|0.300.4|0.503|desktop-fonts|Compliance mode enabled, was '0.503'|
...
|mise|2025.5.6|2025.7.27|app-devel|Compliance mode enabled, was '2025.7.27'|
...
|nomino|1.3.1|1.6.2|app-utils|Compliance mode enabled, was '1.6.2'|
...
|nvidia|575.64|575.64.05|runtime-display|Compliance mode enabled, was '575.64.05'|
|nvidia-open|575.64|575.64.05|runtime-display|Compliance mode enabled, was '575.64.05'|
...
|obs-studio|31.1.1|31.1.2|app-multimedia|Compliance mode enabled, was '31.1.2'|
...
|oolite|1.90|1.91.0.7685-250725-cf7e686|app-games|Compliance mode enabled, was '1.91.0.7685-250725-cf7e686'|
...
|openai-python|1.63.2|1.97.1|lang-python|Compliance mode enabled, was '1.97.1'|
...
|osu-lazer|2025.724.0|2025.724.2-tachyon|app-games|Compliance mode enabled, was '2025.724.2-tachyon'|
...
|pixi|0.49.0|0.50.1|app-devel|Compliance mode enabled, was '0.50.1'|
...
|pydantic-core|2.16.1|2.37.1|lang-python|Compliance mode enabled, was '2.37.1'|
...
|qownnotes|22.6.1|25.7.8|app-web|Compliance mode enabled, was '25.7.8'|
...
|qtscrcpy|3.1.3|3.3.1|app-utils|Compliance mode enabled, was '3.3.1'|
...
|re2|2024-06-01|2025-07-22|runtime-common||
...
|rocm-bandwidth-test|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
...
|rocm-cmake|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocm-comgr|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
...
|rocm-llama-cpp|6.4.1|5994|runtime-rocm|Compliance mode enabled, was '5994'|
...
|rocm-rocfft|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocm-rocprim|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocm-rocprofiler-register|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocm-rocrand|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocm-rocsolver|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocm-rocsparse|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocm-roctracer|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocm-smi-lib|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocminfo|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
|rocr-runtime|6.4.1|6.4.2|runtime-rocm|Compliance mode enabled, was '6.4.2'|
...
|sticky|1.20|1.25|desktop-cinnamon|Compliance mode enabled, was '1.25'|
...
|sunshine|2025.122.141614|2025.725.33250|app-multimedia|Compliance mode enabled, was '2025.725.33250'|
...
|tailscale|1.84.2|1.86.0|app-network|Compliance mode enabled, was '1.86.0'|
...
|telegram-desktop|5.16.4|5.16.5|app-web|Compliance mode enabled, was '5.16.5'|
...
|unrar|6.2.2|7.1.9|app-utils|Compliance mode enabled, was '7.1.9'|
...
|uv|0.8.0|0.8.3|lang-python|Compliance mode enabled, was '0.8.3'|
|v2ray|5.35.0|5.37.0|app-proxy|Compliance mode enabled, was '5.37.0'|
|v2ray-rules-dat|202501302211|202507242215|runtime-data|Compliance mode enabled, was '202507242215'<br>Versions not comparable: `202501302211` and `202507242215`|
...
|vba-m|2.1.8|2.2.1|app-games|Compliance mode enabled, was '2.2.1'|
...
|virtualenv|20.27.1|20.32.0|lang-python|Compliance mode enabled, was '20.32.0'|
...
|vscode|1.102.1|1.102.2|app-editors|Compliance mode enabled, was '1.102.2'|
|vscodium|1.102.14746|1.102.24914|app-editors|Compliance mode enabled, was '1.102.24914'|
...
|wangle|2025.03.24.00|2025.07.21.00|runtime-network|Compliance mode enabled, was '2025.07.21.00'|
|warpinator|1.6.3|1.8.9|desktop-cinnamon|Compliance mode enabled, was '1.8.9'|
|warzone2100|4.5.3|4.5.5|app-games||
|watchman|2025.03.24.00|2025.07.21.00|app-utils|Compliance mode enabled, was '2025.07.21.00'|
...
|xray|25.6.8|25.7.25|app-proxy|Compliance mode enabled, was '25.7.25'|
|xrdp|0.10.3|0.10.4.1|app-network|Compliance mode enabled, was '0.10.4.1'|
|xreader|4.2.2|4.2.7|app-doc|Compliance mode enabled, was '4.2.7'|
...
|xviewer|3.4.6|3.4.9|app-imaging|Compliance mode enabled, was '3.4.9'|
...
|yq|4.46.1|4.47.1|app-devel|Compliance mode enabled, was '4.47.1'|
|yt-dlp|2025.06.30|2025.07.21|app-multimedia|Compliance mode enabled, was '2025.07.21'|
...
|zed|0.186.8|0.196.6|app-editors|Compliance mode enabled, was '0.196.6'|
...
|zotero|7.0.20|7.0.22|app-productivity|Compliance mode enabled, was '7.0.22'|
