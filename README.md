...
## Result
![Relative date](https://img.shields.io/date/1759026494?label=Updated)
...
|adw-gtk3|6.3|6.4|desktop-themes|Compliance mode enabled, was '6.4'|
...
|bcachefs-tools|1.9.4|1.31.5|app-admin|Compliance mode enabled, was '1.31.5'|
...
|boto3|1.40.25|1.40.40|lang-python|Compliance mode enabled, was '1.40.40'|
|botocore|1.40.25|1.40.40|lang-python|Compliance mode enabled, was '1.40.40'|
...
|damo|2.4.7|2.9.7|app-admin|Compliance mode enabled, was '2.9.7'|
...
|fish|4.0.8|4.1.0|app-shells|Compliance mode enabled, was '4.1.0'|
...
|fonttools|4.53.1|4.60.0|desktop-fonts|Compliance mode enabled, was '4.60.0'|
...
|gdk-pixbuf|2.42.12|2.44.2|runtime-imaging|Compliance mode enabled, was '2.44.2'|
|gdk-pixbuf+32|2.42.12|2.44.2|runtime-optenv32|Compliance mode enabled, was '2.44.2'|
...
|gnote|42.1|48.2|desktop-gnome|Compliance mode enabled, was '48.2'|
...
|graphviz|13.1.2|14.0.0|app-doc|Compliance mode enabled, was '14.0.0'|
...
|gtk-4|4.18.5|4.20.1|desktop-gnome|Compliance mode enabled, was '4.20.1'|
...
|gtkmm-4|4.14.0|4.20.0|desktop-gnome|Compliance mode enabled, was '4.20.0'|
...
|harfbuzz|8.4.0|11.5.1|runtime-desktop|Compliance mode enabled, was '11.5.1'|
|harfbuzz+32|8.4.0|11.5.1|runtime-optenv32|Compliance mode enabled, was '11.5.1'|
...
|igsc|0.9.6|1.0.0|runtime-devices|Compliance mode enabled, was '1.0.0'|
...
|intel-gpu-tools|2.1|2.2|app-admin|Compliance mode enabled, was '2.2'|
...
|kodi-inputstream-adaptive|21.5.14|22.2.8-piers|app-multimedia|Compliance mode enabled, was '22.2.8-Piers'|
...
|libguestfs|1.54.1|1.57.3|runtime-virtualization|Compliance mode enabled, was '1.57.3'|
...
|llama.cpp|6265|6611|runtime-creativity|Compliance mode enabled, was '6611'|
...
|mise|2025.8.9|2025.9.21|app-devel|Compliance mode enabled, was '2025.9.21'|
...
|pandoc|3.6.3|3.8|app-doc|Compliance mode enabled, was '3.8'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.186|app-games|Compliance mode enabled, was '2.5.186'|
...
|praat|6.4.43|6.4.44|app-scientific|Compliance mode enabled, was '6.4.44'|
...
|pypdf|4.0.1|6.1.0|lang-python|Compliance mode enabled, was '6.1.0'|
|pypdf2|1.26.0|6.1.0|lang-python|Compliance mode enabled, was '6.1.0'|
...
|qt6ct|0.10|0.11|app-utils|Compliance mode enabled, was '0.11'|
...
|reportlab|3.5.50|4.4.4|lang-python|Compliance mode enabled, was '4.4.4'|
...
|rocm-llama-cpp|6.4.3|6611|runtime-rocm|Compliance mode enabled, was '6611'|
...
|sunshine|2025.122.141614|2025.927.141921|app-multimedia|Compliance mode enabled, was '2025.927.141921'|
...
|tailscale|1.88.1|1.88.3|app-network|Compliance mode enabled, was '1.88.3'|
...
|teams-for-linux|2.2.1|2.5.8|app-web|Compliance mode enabled, was '2.5.8'|
...
|vim|9.1.1788|9.1.1798|app-editors|Compliance mode enabled, was '9.1.1798'|
...
|watchman|2025.09.01.00|2025.09.22.00|app-utils|Compliance mode enabled, was '2025.09.22.00'|
...
|zed|0.203.5|0.205.6|app-editors|Compliance mode enabled, was '0.205.6'|
