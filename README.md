...
## Result
![Relative date](https://img.shields.io/date/1757459573?label=Updated)
...
|boto3|1.40.25|1.40.27|lang-python|Compliance mode enabled, was '1.40.27'|
|botocore|1.40.25|1.40.27|lang-python|Compliance mode enabled, was '1.40.27'|
...
|chezmoi|2.65.0|2.65.1|app-utils|Compliance mode enabled, was '2.65.1'|
...
|chromium|135.0.7049.95|140.0.7339.127|app-web|Compliance mode enabled, was '140.0.7339.127'|
...
|cinnamon-session|5.8.1|6.4.1|desktop-cinnamon|Compliance mode enabled, was '6.4.1'|
...
|crush|0.7.6|0.7.8|app-utils|Compliance mode enabled, was '0.7.8'|
...
|damo|2.4.7|2.9.6|app-admin|Compliance mode enabled, was '2.9.6'|
...
|discord|0.0.108|0.0.109|app-web|Compliance mode enabled, was '0.0.109'|
...
|edencommon|2025.09.01.00|2025.09.08.00|runtime-common|Compliance mode enabled, was '2025.09.08.00'|
...
|fb303|2025.09.01.00|2025.09.08.00|runtime-network|Compliance mode enabled, was '2025.09.08.00'|
|fbthrift|2025.09.01.00|2025.09.08.00|app-network|Compliance mode enabled, was '2025.09.08.00'|
...
|fcitx5-pinyin-moegirl|20250810|20250909|app-i18n|Compliance mode enabled, was '20250909'|
...
|feh|3.11.1|3.11.2|app-imaging|Compliance mode enabled, was '3.11.2'|
...
|freetype|2.13.3|2.14.0|runtime-desktop|Compliance mode enabled, was '2.14.0'|
|freetype+32|2.13.3|2.14.0|runtime-optenv32|Compliance mode enabled, was '2.14.0'|
...
|gh|2.78.0|2.79.0|app-devel|Compliance mode enabled, was '2.79.0'|
...
|glab|1.67.0|1.68.0|app-devel|Compliance mode enabled, was '1.68.0'|
...
|google-chrome|140.0.7339.80|140.0.7339.127|app-web|Compliance mode enabled, was '140.0.7339.127'|
...
|hmcl|3.6.16|3.6.16.293|app-games|Compliance mode enabled, was '3.6.16.293'|
...
|kernel-tools|6.16.4|5.19.17|app-admin|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.16.4 -> 5.19.17)|
...
|lazygit|0.54.2|0.55.0|app-vcs|Compliance mode enabled, was '0.55.0'|
...
|liferea|1.14.6|1.16.4|app-web|Compliance mode enabled, was '1.16.4'|
...
|llama.cpp|5298|6432|runtime-creativity|Compliance mode enabled, was '6432'|
...
|mvfst|2025.09.01.00|2025.09.08.00|runtime-network|Compliance mode enabled, was '2025.09.08.00'|
...
|netbird|0.55.1|0.36.6|app-network|Compliance mode enabled, was '0.36.6'<br>Possible downgrade from the current version (0.55.1 -> 0.36.6)|
...
|oolite|1.90|1.91.0.7707-250905-d54b799|app-games|Compliance mode enabled, was '1.91.0.7707-250905-d54b799'|
...
|osu-lazer|2025.816.0-lazer|2025.905.0-tachyon|app-games||
...
|p11-kit|0.25.5|0.25.6|runtime-cryptography|Compliance mode enabled, was '0.25.6'|
|p11-kit+32|0.25.5|0.25.6|runtime-optenv32|Compliance mode enabled, was '0.25.6'|
...
|pixi|0.54.1|0.54.2|app-devel|Compliance mode enabled, was '0.54.2'|
...
|pygobject-3|3.48.2|3.54.0|lang-python|Compliance mode enabled, was '3.54.0'|
...
|q|0.19.2|0.19.8|app-network|Compliance mode enabled, was '0.19.8'|
...
|rocm-llama-cpp|6.4.3|6432|runtime-rocm|Compliance mode enabled, was '6432'|
...
|snapper|0.12.2|0.13.0|app-admin|Compliance mode enabled, was '0.13.0'|
...
|trove-classifiers|2025.8.6.13|2025.9.9.12|lang-python|Compliance mode enabled, was '2025.9.9.12'|
...
|unifont|16.0.04|17.0.01|desktop-fonts|Compliance mode enabled, was '17.0.01'|
...
|v2ray-rules-dat|202508312212|202509082213|runtime-data|Compliance mode enabled, was '202509082213'<br>Versions not comparable: `202508312212` and `202509082213`|
...
|vim|9.1.1623|9.1.1747|app-editors|Compliance mode enabled, was '9.1.1747'|
...
|wangle|2025.09.01.00|2025.09.08.00|runtime-network|Compliance mode enabled, was '2025.09.08.00'|
|warpinator|1.6.3|1.8.10|desktop-cinnamon|Compliance mode enabled, was '1.8.10'|
|warzone2100|4.5.5|4.6.0|app-games||
|watchman|2025.09.01.00|2025.09.08.00|groups|Compliance mode enabled, was '2025.09.08.00'|
...
|zed|0.202.7|0.202.8|app-editors|Compliance mode enabled, was '0.202.8'|
...
|zope-component|4.4.1|6.1|lang-python|Compliance mode enabled, was '6.1'|
