...
## Result
![Relative date](https://img.shields.io/date/1745680229?label=Updated)
...
|mise|2025.2.8|2025.4.9|app-devel|Compliance mode enabled, was '2025.4.9'|
...
|p-vector|0.10.0|0.9.2|app-admin|Compliance mode enabled, was '0.9.2'<br>Possible downgrade from the current version (0.10.0 -> 0.9.2)|
