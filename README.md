...
## Result
![Relative date](https://img.shields.io/date/1767395596?label=Updated)
...
|boto3|1.40.25|1.42.20|lang-python|Compliance mode enabled, was '1.42.20'|
|botocore|1.42.6|1.42.20|lang-python|Compliance mode enabled, was '1.42.20'|
...
|box64|0.3.9<br>+git20251227|0.3.8|app-emulation|Compliance mode enabled, was '0.3.8'<br>Possible downgrade from the current version (0.3.9+git20251227 -> 0.3.8)|
...
|chromium|142.0.7444.134|143.0.7499.169|app-web|Compliance mode enabled, was '143.0.7499.169'|
|chrony|4.5|4.8|app-admin|Compliance mode enabled, was '4.8'|
|chrpath|0.16|0.18|app-utils|Compliance mode enabled, was '0.18'|
|ciel|3.9.10|3.9.11|app-devel|Compliance mode enabled, was '3.9.11'|
...
|cosmic-app-library|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-applets|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-bg|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-comp|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-edit|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-files|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-greeter|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-icons|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-idle|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-initial-setup|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-launcher|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-notifications|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-osd|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-panel|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-player|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-randr|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-screenshot|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-session|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-settings|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-settings-daemon|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-store|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-term|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-wallpapers|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
|cosmic-workspaces|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
...
|cppcheck|2.18.3|2.19.1|app-devel|Compliance mode enabled, was '2.19.1'|
...
|crush|0.29.1|0.30.0|app-utils|Compliance mode enabled, was '0.30.0'|
...
|damo|2.4.7|3.0.9|app-admin|Compliance mode enabled, was '3.0.9'|
...
|deploykit-backend|0.9.0|0.9.1|app-admin|Compliance mode enabled, was '0.9.1'|
|deploykit-gui|0.10.3|0.10.4|app-admin|Compliance mode enabled, was '0.10.4'|
...
|devscripts|2.25.30|2.25.33|app-devel|Compliance mode enabled, was '2.25.33'|
...
|doggo|1.1.2|1.1.3|app-network|Compliance mode enabled, was '1.1.3'|
...
|dvc|3.64.2|3.65.0|app-vcs|Compliance mode enabled, was '3.65.0'|
...
|edencommon|2025.09.01.00|2025.12.29.00|runtime-common|Compliance mode enabled, was '2025.12.29.00'|
...
|fb303|2025.09.01.00|2025.12.29.00|runtime-network|Compliance mode enabled, was '2025.12.29.00'|
|fbthrift|2025.09.01.00|2025.12.29.00|app-network|Compliance mode enabled, was '2025.12.29.00'|
...
|feishin|0.22.0|1.1.0|app-multimedia|Compliance mode enabled, was '1.1.0'|
...
|fizz|2025.09.01.00|2025.12.29.00|app-network|Compliance mode enabled, was '2025.12.29.00'|
...
|folly|2025.09.01.00|2025.12.29.00|runtime-common|Compliance mode enabled, was '2025.12.29.00'|
...
|freeciv|3.2.1|3.2.2|app-games|Compliance mode enabled, was '3.2.2'|
...
|gdal|3.12.0|3.12.1|runtime-gis|Compliance mode enabled, was '3.12.1'|
...
|git-credential-oauth|0.16.0|0.17.0|app-vcs|Compliance mode enabled, was '0.17.0'|
...
|goverlay|1.2|1.6.9|app-utils|Compliance mode enabled, was '1.6.9'|
...
|hmcl|3.8.2|3.6.18|app-games|Compliance mode enabled, was '3.6.18'<br>Possible downgrade from the current version (3.8.2 -> 3.6.18)|
...
|hugo|0.153.1|0.154.2|app-web|Compliance mode enabled, was '0.154.2'|
...
|hypothesis-python|6.97.4|6.148.9|lang-python|Compliance mode enabled, was '6.148.9'|
...
|incus|6.19.1|6.20.0|app-containers|Compliance mode enabled, was '6.20.0'|
...
|libpinyin|2.10.2|2.10.3|runtime-i18n|Compliance mode enabled, was '2.10.3'|
...
|llama.cpp|7600|7615|runtime-creativity|Compliance mode enabled, was '7615'|
...
|maturin|1.9.6|1.11.0|lang-python|Compliance mode enabled, was '1.11.0'|
...
|mvfst|2025.09.01.00|2025.12.29.00|runtime-network|Compliance mode enabled, was '2025.12.29.00'|
|mxml|3.2|4.0.4|runtime-common|Compliance mode enabled, was '4.0.4'|
|mycli|1.42.0|1.43.0|app-database|Compliance mode enabled, was '1.43.0'|
...
|ncurses|6.4|6.6+20251231|runtime-common|Compliance mode enabled, was '6.6-20251231'|
|ncurses+32|6.4|6.6+20251231|runtime-optenv32|Compliance mode enabled, was '6.6-20251231'|
...
|netbird|0.59.10|0.61.0|app-network|Compliance mode enabled, was '0.61.0'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.407|app-games|Compliance mode enabled, was '2.5.407'|
...
|praat|6.4.49|6.4.51|app-scientific|Compliance mode enabled, was '6.4.51'|
...
|qgis|3.44.5|3.44.6|app-gis|Compliance mode enabled, was '3.44.6'|
...
|rocm-llama-cpp|7.0.1|7615|runtime-rocm|Compliance mode enabled, was '7615'|
...
|scmrepo|3.5.9|3.6.0|lang-python|Compliance mode enabled, was '3.6.0'|
...
|sdl2-image|2.0.5|3.2.6|runtime-multimedia|Compliance mode enabled, was '3.2.6'|
...
|starship|1.24.1|1.24.2|app-utils|Compliance mode enabled, was '1.24.2'|
...
|sunshine|2025.924.154138|2025.1230.11628|app-multimedia|Compliance mode enabled, was '2025.1230.11628'|
...
|telegram-desktop|6.3.6|6.3.10|app-web|Compliance mode enabled, was '6.3.10'|
...
|tokei|13.0.0|14.0.0|app-devel|Compliance mode enabled, was '14.0.0'|
...
|uv|0.9.20|0.9.21|lang-python|Compliance mode enabled, was '0.9.21'|
|v2ray|5.41.0|5.42.0|app-proxy|Compliance mode enabled, was '5.42.0'|
|v2ray-rules-dat|202510042211|202601012215|runtime-data|Compliance mode enabled, was '202601012215'<br>Versions not comparable: `202510042211` and `202601012215`|
...
|vim|9.1.2006|9.1.2045|app-editors|Compliance mode enabled, was '9.1.2045'|
...
|wangle|2025.09.01.00|2025.12.29.00|runtime-network|Compliance mode enabled, was '2025.12.29.00'|
|warpinator|1.6.3|2.0.2|desktop-cinnamon|Compliance mode enabled, was '2.0.2'|
|warzone2100|4.5.5|4.6.2|app-games||
|watchman|2025.09.01.00|2025.12.29.00|app-utils|Compliance mode enabled, was '2025.12.29.00'|
...
|witr|0.1.5|0.1.6|app-utils|Compliance mode enabled, was '0.1.6'|
...
|xdg-desktop-portal-cosmic|1.0.0|1.0.1|desktop-cosmic|Compliance mode enabled, was '1.0.1'|
...
|yazi|25.5.31|25.12.29|app-utils|Compliance mode enabled, was '25.12.29'|
...
|zfs|2.3.4|2.4.0|app-admin|Compliance mode enabled, was '2.4.0'|
