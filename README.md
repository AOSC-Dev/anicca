...
## Result
![Relative date](https://img.shields.io/date/1774100310?label=Updated)
| Package | Repo Version | New Version | Category | Warnings |
|---------|--------------|-------------|------|----------|
|0ad|0.27.1|0.28.0|app-games|Compliance mode enabled, was '0.28.0'|
|6tunnel|0.13|0.14|app-network|Compliance mode enabled, was '0.14'|
|7-zip|25.01|26.00|app-utils|Compliance mode enabled, was '26.00'|
...
|accountsservice|23.13.9|26.12.8|app-admin|Compliance mode enabled, was '26.12.8'|
...
|ada|3.4.2|3.4.3|runtime-web|Compliance mode enabled, was '3.4.3'|
...
|adwaita-fonts|49.0|50.0|desktop-gnome|Compliance mode enabled, was '50.0'|
...
|ansible|2.12.1|2.20.3|app-admin|Compliance mode enabled, was '2.20.3'|
...
|aosc-media-writer|0.4.3|5.2.8|app-utils|Compliance mode enabled, was '5.2.8'|
...
|asar|4.0.1|4.1.0|app-utils|Compliance mode enabled, was '4.1.0'|
...
|attrs|25.4.0|26.1.0|lang-python|Compliance mode enabled, was '26.1.0'|
...
|b4|0.14.3|0.15.0|app-devel|Compliance mode enabled, was '0.15.0'|
...
|bear|3.1.6|4.0.4|app-devel|Compliance mode enabled, was '4.0.4'|
...
|bind|9.20.18|9.20.20|app-network|Compliance mode enabled, was '9.20.20'|
...
|botan|3.8.1|3.11.0|runtime-cryptography|Compliance mode enabled, was '3.11.0'|
|boto3|1.42.54|1.42.73|lang-python|Compliance mode enabled, was '1.42.73'|
|botocore|1.42.54|1.42.73|lang-python|Compliance mode enabled, was '1.42.73'|
|bottle|0.13.3|0.13.4|lang-python|Compliance mode enabled, was '0.13.4'|
|bottles|2022.2.28<br>+trento<br>+4|62.0|app-utils|Compliance mode enabled, was '62.0'<br>Possible downgrade from the current version (2022.2.28+trento+4 -> 62.0)|
|bovo|23.08.5|25.12.3|desktop-kde|Compliance mode enabled, was '25.12.3'|
|bpftrace|0.24.2|0.25.0|app-admin|Compliance mode enabled, was '0.25.0'|
...
|buf|1.65.0|1.66.1|app-devel|Compliance mode enabled, was '1.66.1'|
...
|calibre|9.4.0|9.5.0|app-doc|Compliance mode enabled, was '9.5.0'|
...
|capnproto|1.3.0|1.4.0|runtime-common|Compliance mode enabled, was '1.4.0'|
...
|ccache|4.12.2|4.13.1|app-devel|Compliance mode enabled, was '4.13.1'|
...
|chardet|5.2.0|7.2.0|lang-python|Compliance mode enabled, was '7.2.0'|
...
|cherry-studio|1.7.13|1.8.2|app-utils|Compliance mode enabled, was '1.8.2'|
...
|chromium|142.0.7444.134|146.0.7680.153|app-web|Compliance mode enabled, was '146.0.7680.153'|
...
|clazy|1.15|1.17|app-devel|Compliance mode enabled, was '1.17'|
...
|cmake|3.31.6|4.3.0|app-devel|Compliance mode enabled, was '4.3.0'|
...
|cockpit|353|358|app-admin|Compliance mode enabled, was '358'|
|cockpit-machines|344|350|app-admin|Compliance mode enabled, was '350'|
|cockpit-podman|117|123|app-admin|Compliance mode enabled, was '123'|
...
|cosmic-app-library|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-applets|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-bg|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-comp|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-edit|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-files|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
...
|cosmic-panel|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-player|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-randr|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-screenshot|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-session|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-settings|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-settings-daemon|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-store|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-term|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-wallpapers|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
|cosmic-workspaces|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
...
|cppcheck|2.19.1|2.20.0|app-devel|Compliance mode enabled, was '2.20.0'|
...
|crush|0.29.1|0.51.2|app-utils|Compliance mode enabled, was '0.51.2'|
...
|ctags|6.2.20251005.0|6.2.20260315.0|app-devel|Compliance mode enabled, was '6.2.20260315.0'|
...
|dart-sass|1.97.3|1.98.0|app-devel|Compliance mode enabled, was '1.98.0'|
|dart-sass-js|1.97.3|1.98.0|app-devel|Compliance mode enabled, was '1.98.0'|
|dart-sdk|3.10.7|3.11.3|lang-dart|Compliance mode enabled, was '3.11.3'|
...
|devscripts|2.25.30|2.26.6|app-devel|Compliance mode enabled, was '2.26.6'|
...
|diff-so-fancy|1.4.4|1.4.6|app-utils|Compliance mode enabled, was '1.4.6'|
...
|docker|29.1.4|29.3.0|app-containers||
|docker-buildx|0.22.0|0.32.1|app-containers|Compliance mode enabled, was '0.32.1'|
...
|doggo|1.1.4|1.1.5|app-network|Compliance mode enabled, was '1.1.5'|
...
|duckdb|1.4.3|1.5.0|app-database|Compliance mode enabled, was '1.5.0'|
...
|dvc|3.64.2|3.67.0|app-vcs|Compliance mode enabled, was '3.67.0'|
...
|easyeffects|7.2.5|8.1.6|app-multimedia|Compliance mode enabled, was '8.1.6'|
|easytier|2.4.5|2.5.0|app-network|Compliance mode enabled, was '2.5.0'|
|edencommon|2025.09.01.00|2026.03.16.00|runtime-common|Compliance mode enabled, was '2026.03.16.00'|
...
|element-desktop|1.12.11|1.12.12|app-web|Compliance mode enabled, was '1.12.12'|
...
|epiphany|49.2|50.2|desktop-gnome|Compliance mode enabled, was '50.2'|
...
|expat|2.7.4|2.7.5|runtime-common|Compliance mode enabled, was '2.7.5'|
|expat+32|2.7.4|2.7.5|runtime-optenv32|Compliance mode enabled, was '2.7.5'|
...
|fb303|2025.09.01.00|2026.03.16.00|runtime-network|Compliance mode enabled, was '2026.03.16.00'|
|fbthrift|2025.09.01.00|2026.03.16.00|app-network|Compliance mode enabled, was '2026.03.16.00'|
...
|firefox|148.0|148.0.2|app-web|Compliance mode enabled, was '148.0.2'|
...
|fizz|2025.09.01.00|2026.03.16.00|app-network|Compliance mode enabled, was '2026.03.16.00'|
...
|fluidsynth|2.5.1|2.5.3|app-multimedia|Compliance mode enabled, was '2.5.3'|
...
|folly|2025.09.01.00|2026.03.16.00|runtime-common|Compliance mode enabled, was '2026.03.16.00'|
...
|freeciv|3.2.2|3.2.3|app-games|Compliance mode enabled, was '3.2.3'|
...
|freetds|1.00.112|1.5.14|runtime-database|Compliance mode enabled, was '1.5.14'|
|frei0r-plugins|2.5.1|2.5.5|runtime-multimedia|Compliance mode enabled, was '2.5.5'|
...
|frp|0.67.0|0.68.0|app-proxy|Compliance mode enabled, was '0.68.0'|
...
|gamescope|3.16.18|3.16.22|desktop-wm|Compliance mode enabled, was '3.16.22'|
...
|gdu|5.34.1|5.34.2|app-utils|Compliance mode enabled, was '5.34.2'|
...
|gimp|3.2.0|3.2.0.windows-fixes|app-creativity|Compliance mode enabled, was '3.2.0.windows-fixes'<br>Possible downgrade from the current version (3.2.0 -> 3.2.0.windows-fixes)|
...
|glab|1.80.4|1.89.0|app-devel|Compliance mode enabled, was '1.89.0'|
|glances|4.4.0|4.5.2|app-admin|Compliance mode enabled, was '4.5.2'|
...
|goreleaser|2.13.1|2.14.3|lang-golang|Compliance mode enabled, was '2.14.3'|
|goverlay|1.2|1.7.5|app-utils|Compliance mode enabled, was '1.7.5'|
|gparted|1.8.0|1.8.1|app-admin|Compliance mode enabled, was '1.8.1'|
...
|grpc|1.72.0|1.78.1|app-network|Compliance mode enabled, was '1.78.1'|
...
|gtk-3|3.24.43|3.24.51|desktop-gnome|Compliance mode enabled, was '3.24.51'|
...
|halloy|2025.8|2026.4|app-web|Compliance mode enabled, was '2026.4'|
|handbrake|1.10.1|1.11.0|app-multimedia|Compliance mode enabled, was '1.11.0'|
|hardinfo|0.5.1<br>+git20220724|0.5.1|app-utils|Compliance mode enabled, was '0.5.1'|
|harfbuzz|12.3.0|13.2.1|runtime-desktop|Compliance mode enabled, was '13.2.1'|
|harfbuzz+32|12.3.0|13.2.1|runtime-optenv32|Compliance mode enabled, was '13.2.1'|
...
|hdf5|1.14.6|2.1.0|runtime-scientific|Compliance mode enabled, was '2.1.0'|
...
|hmcl|3.11.2|3.6.18|app-games|Compliance mode enabled, was '3.6.18'<br>Possible downgrade from the current version (3.11.2 -> 3.6.18)|
...
|hugo|0.154.3|0.158.0|app-web|Compliance mode enabled, was '0.158.0'|
...
|hypothesis-python|6.97.4|6.151.9|lang-python|Compliance mode enabled, was '6.151.9'|
...
|i3status-rust|0.35.0|0.36.0|desktop-wm|Compliance mode enabled, was '0.36.0'|
|iana-etc|20260310|20260321|runtime-data|Compliance mode enabled, was '20260321'|
...
|imagemagick|6.9.13-37|6.9.13-42|app-utils||
|imagemagick+7|7.1.1<br>+32|7.1.2+17|app-utils|Compliance mode enabled, was '7.1.2-17'|
...
|iosevka-fonts|34.1.0|34.2.1|desktop-fonts|Compliance mode enabled, was '34.2.1'|
...
|ipython|8.32.0|9.11.0|lang-python|Compliance mode enabled, was '9.11.0'|
...
|jmol|14.30.0|16.3.53|app-scientific|Compliance mode enabled, was '16.3.53'|
...
|js-140|140.6.0esr|140.8.0|lang-js|Compliance mode enabled, was '140.8.0'|
...
|jsonpointer|2.3|3.1.0|lang-python|Compliance mode enabled, was '3.1.0'|
...
|kea|2.6.3|3.1.6|app-network|Compliance mode enabled, was '3.1.6'|
|keditbookmarks|23.08.5|25.12.3|desktop-kde|Compliance mode enabled, was '25.12.3'|
|keepassxc|2.7.11|2.7.12|app-utils|Compliance mode enabled, was '2.7.12'|
...
|kmscon|9.3.1|9.3.2|app-utils|Compliance mode enabled, was '9.3.2'|
...
|krita|5.2.15|5.2.16|app-creativity|Compliance mode enabled, was '5.2.16'|
...
|kweathercore|0.7|26.03.80|desktop-kde|Compliance mode enabled, was '26.03.80'|
...
|labwc|0.9.3|0.9.6|desktop-wm|Compliance mode enabled, was '0.9.6'|
...
|lego|4.31.0|4.33.0|app-web|Compliance mode enabled, was '4.33.0'|
...
|lfortran|0.57.0|0.61.0|app-devel|Compliance mode enabled, was '0.61.0'|
...
|libc+wasi|22|31|runtime-wasi|Compliance mode enabled, was '31'|
...
|libcap-ng|0.8.5|0.9.1|runtime-common|Compliance mode enabled, was '0.9.1'|
...
|libclc|18.1.8|22.1.1|runtime-devices|Compliance mode enabled, was '22.1.1'|
...
|libgcrypt|1.11.0|1.12.1|runtime-cryptography|Compliance mode enabled, was '1.12.1'|
...
|libindi|2.1.7|2.1.9|runtime-scientific|Compliance mode enabled, was '2.1.9'|
...
|libp11|0.4.16|0.4.18|runtime-cryptography|Compliance mode enabled, was '0.4.18'|
...
|libphonenumber|8.13.38|9.0.26|runtime-i18n|Compliance mode enabled, was '9.0.26'|
...
|libreoffice|26.2.0.3|26.2.2.2|app-productivity|Compliance mode enabled, was '26.2.2.2'|
...
|libupnp|1.14.16|1.18.3|runtime-network|Compliance mode enabled, was '1.18.3'|
...
|libvips|8.18.0|8.18.1|runtime-imaging|Compliance mode enabled, was '8.18.1'|
|libvirt|11.9.0|12.1.0|app-virtualization|Compliance mode enabled, was '12.1.0'|
...
|libwebsockets|4.4.1|4.5.7|runtime-web|Compliance mode enabled, was '4.5.7'|
...
|libxnvctrl|590.48.01|595.45.04|runtime-display|Compliance mode enabled, was '595.45.04'|
|libxnvctrl+32|590.48.01|595.45.04|runtime-optenv32|Compliance mode enabled, was '595.45.04'|
...
|linux+api|6.12.74|6.12.77|core-devel|Compliance mode enabled, was '6.12.77'|
|linux+api+32|6.12.7|6.12.77|runtime-optenv32|Compliance mode enabled, was '6.12.77'|
...
|listenbrainz-mpd|2.3.9|2.4.0|app-multimedia|Compliance mode enabled, was '2.4.0'|
|lksctp-tools|1.0.17|1.0.21|app-network|Compliance mode enabled, was '1.0.21'|
|llama.cpp|8400|8461|runtime-creativity|Compliance mode enabled, was '8461'|
...
|llvm+32|20.1.8|22.1.1|runtime-optenv32|Compliance mode enabled, was '22.1.1'|
|llvm-20|20.1.8|22.1.1|app-devel|Compliance mode enabled, was '22.1.1'|
|llvm-21|21.1.8|22.1.1|app-devel|Compliance mode enabled, was '22.1.1'|
|llvm-runtime+wasi|20.1.8|22.1.1|runtime-wasi|Compliance mode enabled, was '22.1.1'|
...
|lsof|4.99.3|4.99.6|app-utils|Compliance mode enabled, was '4.99.6'|
|lsp-plugins|1.2.25|1.2.27|app-multimedia|Compliance mode enabled, was '1.2.27'|
...
|matplotlib-inline|0.1.7|9.11.0|lang-python|Compliance mode enabled, was '9.11.0'|
|matugen|3.1.0|4.0.0|app-utils|Compliance mode enabled, was '4.0.0'|
...
|mdadm|4.4|4.6|app-admin|Compliance mode enabled, was '4.6'|
...
|mise|2026.1.1|2026.3.9|app-devel|Compliance mode enabled, was '2026.3.9'|
...
|mpmath|1.1.0|1.4.1|lang-python|Compliance mode enabled, was '1.4.1'|
...
|musicfox|4.7.1|4.8.0|app-multimedia|Compliance mode enabled, was '4.8.0'|
|musl|1.2.5|1.2.6|app-devel|Compliance mode enabled, was '1.2.6'|
...
|mvfst|2025.09.01.00|2026.03.16.00|runtime-network|Compliance mode enabled, was '2026.03.16.00'|
|mxml|3.3.1|4.0.4|runtime-common|Compliance mode enabled, was '4.0.4'|
|mycli|1.42.0|1.66.0|app-database|Compliance mode enabled, was '1.66.0'|
...
|ncbi-vdb|3.3.0|3.4.0|app-scientific|Compliance mode enabled, was '3.4.0'|
|ncurses|6.6|6.6+20260314|runtime-common|Compliance mode enabled, was '6.6-20260314'|
|ncurses+32|6.6|6.6+20260314|runtime-optenv32|Compliance mode enabled, was '6.6-20260314'|
...
|nexttrace|1.5.0|1.6.1|app-network|Compliance mode enabled, was '1.6.1'|
...
|nginx|1.28.0<br>+brotli1.0.0~rc1<br>+git20231009|1.29.6|app-web|Compliance mode enabled, was '1.29.6'|
|ngspice|35|45.2|app-electronics|Compliance mode enabled, was '45.2'|
|ngtcp2|1.5.0|1.21.0|runtime-web|Compliance mode enabled, was '1.21.0'|
...
|noctalia-qs|0.0.4|0.0.9|runtime-desktop|Compliance mode enabled, was '0.0.9'|
|nodejs-22|22.22.0|22.22.1|lang-js|Compliance mode enabled, was '22.22.1'|
|nodejs-24|24.13.1|24.14.0|lang-js|Compliance mode enabled, was '24.14.0'|
...
|noto-fonts|2025.12.01|2026.03.01|desktop-fonts||
...
|nss+32|3.113|3.121|runtime-optenv32|Compliance mode enabled, was '3.121'|
...
|ocrmypdf|16.5.0|17.3.0|app-doc|Compliance mode enabled, was '17.3.0'|
...
|openai-python|2.26.0|2.29.0|lang-python|Compliance mode enabled, was '2.29.0'|
...
|openexr|3.1.8|3.4.7|runtime-imaging|Compliance mode enabled, was '3.4.7'|
|openimagedenoise|2.3.0|2.4.1|runtime-imaging|Compliance mode enabled, was '2.4.1'|
|openimageio|2.5.19.1|3.1.11.0|runtime-imaging|Compliance mode enabled, was '3.1.11.0'|
|openjdk-11|11.0.28-ga|11.0.31+6|lang-java||
|openjdk-17|17.0.16-ga|17.0.19+7|lang-java||
|openjdk-21|21.0.8-ga|21.0.11+7|lang-java||
...
|openvswitch|3.6.0|3.7.0|app-network|Compliance mode enabled, was '3.7.0'|
...
|parallel|20250422|20260222|app-utils|Compliance mode enabled, was '20260222'|
...
|pbs-installer|2026.2.11|2026.3.20|lang-python|Compliance mode enabled, was '2026.3.20'|
...
|pcsx2|2.7.181|2.7.209|app-games||
...
|perl|5.36.3|5.42.1|lang-perl|Compliance mode enabled, was '5.42.1'|
...
|perl-clone|0.46|0.48|lang-perl|Compliance mode enabled, was '0.48'|
...
|perl-xml-parser|2.44|2.51|lang-perl|Compliance mode enabled, was '2.51'|
...
|php|8.5.1|8.5.4|app-devel|Compliance mode enabled, was '8.5.4'|
...
|pikepdf|8.15.1|10.5.1|app-doc|Compliance mode enabled, was '10.5.1'|
...
|pipx|1.8.0|1.10.1|lang-python|Compliance mode enabled, was '1.10.1'|
...
|plasma-settings|22.06|26.03.80|desktop-kde|Compliance mode enabled, was '26.03.80'|
...
|poppler|25.07.0|26.03.0|groups|Compliance mode enabled, was '26.03.0'|
...
|powershell|7.4.5|7.6.0|app-shells|Compliance mode enabled, was '7.6.0'|
...
|proton-bridge|3.21.2|3.23.1|app-web|Compliance mode enabled, was '3.23.1'|
...
|ptyxis|49.3|50.1|desktop-gnome|Compliance mode enabled, was '50.1'|
|publicsuffixlist|1.0.2.20250809|1.0.2.20260318|lang-python|Compliance mode enabled, was '1.0.2.20260318'|
...
|puremagic|1.30|2.1.0|lang-python|Compliance mode enabled, was '2.1.0'|
...
|pyasn1|0.6.1|0.6.3|lang-python|Compliance mode enabled, was '0.6.3'|
...
|pydantic-core|2.41.5|2.42.0|lang-python|Compliance mode enabled, was '2.42.0'|
...
|pygobject-3|3.54.3|3.56.1|lang-python|Compliance mode enabled, was '3.56.1'|
...
|pyopenssl|25.3.0|26.0.0|lang-python|Compliance mode enabled, was '26.0.0'|
|pyparsing|3.2.3|3.3.2|lang-python|Compliance mode enabled, was '3.3.2'|
|pypdf|6.5.0|6.9.1|lang-python|Compliance mode enabled, was '6.9.1'|
|pypdf2|1.26.0|6.9.1|lang-python|Compliance mode enabled, was '6.9.1'|
...
|rclone|1.72.1|1.73.2|app-web|Compliance mode enabled, was '1.73.2'|
|rcloneshuttle|0.1.7|0.1.9|app-web|Compliance mode enabled, was '0.1.9'|
...
|rocm-aqlprofile|7.2.0|7.13.60800|runtime-rocm|Compliance mode enabled, was '7.13.60800'|
|rocm-bandwidth-test|6.4.3|20250912.42|runtime-rocm|Compliance mode enabled, was '20250912-42'|
|rocm-clr|7.2.0|7.13.60800|runtime-rocm|Compliance mode enabled, was '7.13.60800'|
...
|rocm-core|7.2.0|7.13.60800|runtime-rocm|Compliance mode enabled, was '7.13.60800'|
...
|rocm-llama-cpp|7.0.1|8461|runtime-rocm|Compliance mode enabled, was '8461'|
...
|rocm-rocprofiler-register|7.2.0|7.13.60800|runtime-rocm|Compliance mode enabled, was '7.13.60800'|
...
|rocm-roctracer|7.2.0|7.13.60800|runtime-rocm|Compliance mode enabled, was '7.13.60800'|
|rocm-smi-lib|7.2.0|7.13.60800|runtime-rocm|Compliance mode enabled, was '7.13.60800'|
|rocminfo|7.2.0|7.13.60800|runtime-rocm|Compliance mode enabled, was '7.13.60800'|
|rocr-runtime|7.2.0|7.13.60800|runtime-rocm|Compliance mode enabled, was '7.13.60800'|
...
|sip|6.12.0|6.15.2|lang-python|Compliance mode enabled, was '6.15.2'|
|sip-4|4.19.25|6.15.2|lang-python|Compliance mode enabled, was '6.15.2'|
|skanlite|23.08.5|25.12.3|desktop-kde|Compliance mode enabled, was '25.12.3'|
...
|snapd|2.74.1|2.75.1|app-admin|Compliance mode enabled, was '2.75.1'|
...
|spacebar|23.01.0|26.03.80|desktop-kde|Compliance mode enabled, was '26.03.80'|
...
|spirv-llvm-translator|20.1.4|22.1.0|app-devel|Compliance mode enabled, was '22.1.0'|
|spirv-llvm-translator+32|20.1.4|22.1.0|runtime-optenv32|Compliance mode enabled, was '22.1.0'|
...
|sqlglot|28.1.0|30.0.3|lang-python|Compliance mode enabled, was '30.0.3'|
|sqlite|3500400|3.52.0|app-database|Possible downgrade from the current version (3500400 -> 3.52.0)|
|sqlite+32|3.46.1|3.52.0|runtime-optenv32|Compliance mode enabled, was '3.52.0'|
...
|sra-tools|3.3.0|3.4.0|app-scientific|Compliance mode enabled, was '3.4.0'|
...
|sunshine|2025.924.154138|2026.319.232111|app-multimedia|Compliance mode enabled, was '2026.319.232111'|
...
|systemd|259|260|app-admin|Compliance mode enabled, was '260'|
...
|taglib|2.0.2|2.2.1|runtime-multimedia|Compliance mode enabled, was '2.2.1'|
|taglib+32|1.13.1|2.2.1|runtime-optenv32|Compliance mode enabled, was '2.2.1'|
|tagparser|11.5.1|12.5.2|runtime-multimedia|Compliance mode enabled, was '12.5.2'|
|tailscale|1.96.2|1.96.3|app-network|Compliance mode enabled, was '1.96.3'|
...
|teams-for-linux|2.2.1|2.7.12|app-web|Compliance mode enabled, was '2.7.12'|
...
|texlive|20250308|2026|app-doc|Compliance mode enabled, was '2026'<br>Possible downgrade from the current version (20250308 -> 2026)|
...
|thunderbird|148.0|148.0.1|app-web|Compliance mode enabled, was '148.0.1'|
...
|tor|0.4.8.19|0.4.9.5|app-proxy|Compliance mode enabled, was '0.4.9.5'|
...
|tree-sitter|0.25.3|0.26.7|app-devel|Compliance mode enabled, was '0.26.7'|
...
|uv|0.10.10|0.10.12|lang-python|Compliance mode enabled, was '0.10.12'|
|v2ray-rules-dat|202601042214|202603202222|runtime-data|Compliance mode enabled, was '202603202222'<br>Versions not comparable: `202601042214` and `202603202222`|
...
|vim|9.2.0209|9.2.0219|app-editors|Compliance mode enabled, was '9.2.0219'|
...
|vpl-gpu-rt|26.1.2|26.1.4|runtime-multimedia|Compliance mode enabled, was '26.1.4'|
...
|wangle|2025.09.01.00|2026.03.16.00|runtime-network|Compliance mode enabled, was '2026.03.16.00'|
|warzone2100|4.5.5|4.6.3|app-games||
|watchman|2025.09.01.00|2026.03.16.00|app-utils|Compliance mode enabled, was '2026.03.16.00'|
...
|webkit2gtk|2.50.3|2.52.0|runtime-web|Compliance mode enabled, was '2.52.0'|
...
|weechat|4.8.1|4.8.2|app-web|Compliance mode enabled, was '4.8.2'|
|weka|3.9.2|8.0.0|app-scientific|Compliance mode enabled, was '8.0.0'|
|werkzeug|3.0.6|3.1.6|lang-python|Compliance mode enabled, was '3.1.6'|
...
|whisper.cpp|1.8.3|1.8.4|runtime-creativity|Compliance mode enabled, was '1.8.4'|
...
|wlroots|0.19.2|0.19.3|runtime-display|Compliance mode enabled, was '0.19.3'|
...
|wrapt|2.1.1|2.1.2|lang-python|Compliance mode enabled, was '2.1.2'|
...
|xapian-core|1.4.18|2.0.0|runtime-common|Compliance mode enabled, was '2.0.0'|
...
|xdg-desktop-portal-cosmic|1.0.3|1.0.8|desktop-cosmic|Compliance mode enabled, was '1.0.8'|
...
|xfe|2.1.4|2.1.5|app-utils|Compliance mode enabled, was '2.1.5'|
...
|xournalpp|1.3.1|1.3.3|runtime-productivity|Compliance mode enabled, was '1.3.3'|
...
|zed|0.222.4|0.228.0|app-editors|Compliance mode enabled, was '0.228.0'|
...
|zotero|8.0.2|8.0.3|app-productivity|Compliance mode enabled, was '8.0.3'|
