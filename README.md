...
## Result
![Relative date](https://img.shields.io/date/1767132837?label=Updated)
...
|ab-download-manager|1.8.2|1.8.3|app-web|Compliance mode enabled, was '1.8.3'|
...
|bottom|0.11.4|0.12.2|app-admin|Compliance mode enabled, was '0.12.2'|
...
|debian-ports-archive-keyring|2025.04.05|2025.12.30|runtime-data|Compliance mode enabled, was '2025.12.30'|
...
|elinks|0.18.0|0.19.0|app-web|Compliance mode enabled, was '0.19.0'|
...
|fast-float|8.1.0|8.2.1|runtime-common|Compliance mode enabled, was '8.2.1'|
...
|feishin|0.22.0|1.0.2|app-multimedia|Compliance mode enabled, was '1.0.2'|
...
|ggml|0.9.4<br>+git20251217|0.9.4|runtime-scientific|Compliance mode enabled, was '0.9.4'|
...
|hugo|0.153.1|0.153.5|app-web|Compliance mode enabled, was '0.153.5'|
...
|imhex|1.37.4|1.38.1|app-editors|Compliance mode enabled, was '1.38.1'|
...
|libheif|1.20.2|1.21.0|runtime-imaging|Compliance mode enabled, was '1.21.0'|
...
|llama.cpp|7571|7585|runtime-creativity|Compliance mode enabled, was '7585'|
|lldpd|1.0.18|1.0.20|app-network|Compliance mode enabled, was '1.0.20'|
|llfuse|1.4.1|1.5.2|lang-python|Compliance mode enabled, was '1.5.2'|
...
|lxgwcleargothic-font|0.508|0.520|desktop-fonts|Compliance mode enabled, was '0.520'|
...
|mlt|7.34.1|7.36.0|runtime-multimedia|Compliance mode enabled, was '7.36.0'|
...
|ncurses|6.4|6.5+20251227|runtime-common|Compliance mode enabled, was '6.5-20251227'|
|ncurses+32|6.4|6.5+20251227|runtime-optenv32|Compliance mode enabled, was '6.5-20251227'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.405|app-games|Compliance mode enabled, was '2.5.405'|
...
|rocm-llama-cpp|7.0.1|7585|runtime-rocm|Compliance mode enabled, was '7585'|
...
|shotcut|25.10.9|25.12.30|app-creativity|Compliance mode enabled, was '25.12.30'|
...
|tuwunel|1.4.5|1.4.8|app-web|Compliance mode enabled, was '1.4.8'|
...
|types-psutil|7.0.0.20251001|7.2.0.20251228|lang-python|Compliance mode enabled, was '7.2.0.20251228'|
...
|typos|1.40.0|1.40.1|app-utils|Compliance mode enabled, was '1.40.1'|
...
|uv|0.9.18|0.9.21|lang-python|Compliance mode enabled, was '0.9.21'|
|v2ray|5.41.0|5.42.0|app-proxy|Compliance mode enabled, was '5.42.0'|
|v2ray-rules-dat|202510042211|202512292214|runtime-data|Compliance mode enabled, was '202512292214'<br>Versions not comparable: `202510042211` and `202512292214`|
...
|vim|9.1.2006|9.1.2031|app-editors|Compliance mode enabled, was '9.1.2031'|
...
|witr|0.1.2|0.1.3|app-utils|Compliance mode enabled, was '0.1.3'|
