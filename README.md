...
|ab-download-manager|1.6.1|1.6.3|app-web|Compliance mode enabled, was '1.6.3'|
...
|aiohttp|3.7.4.post0|3.12.9|lang-python|Compliance mode enabled, was '3.12.9'|
...
|boto3|1.20.26|1.38.30|lang-python|Compliance mode enabled, was '1.38.30'|
|botocore|1.34.133|1.38.30|lang-python|Compliance mode enabled, was '1.38.30'|
...
|buildah|1.40.0|1.40.1|app-containers|Compliance mode enabled, was '1.40.1'|
...
|containers-common|0.63.0|0.63.1|runtime-containers||
...
|corefreq|20170301|2.0.6|app-utils|Compliance mode enabled, was '2.0.6'<br>Possible downgrade from the current version (20170301 -> 2.0.6)|
...
|cython|3.1.0|3.1.1|lang-python|Compliance mode enabled, was '3.1.1'|
|czmq|4.2.0|4.2.1|runtime-common|Compliance mode enabled, was '4.2.1'|
|damo|2.4.7|2.8.3|app-admin|Compliance mode enabled, was '2.8.3'|
...
|dnscontrol|4.20.0|4.21.0|app-network|Compliance mode enabled, was '4.21.0'|
...
|fan2go|0.9.0|0.9.2|app-utils|Compliance mode enabled, was '0.9.2'|
...
|fastfetch|2.44.0|2.45.0|app-utils|Compliance mode enabled, was '2.45.0'|
...
|fb303|2025.03.24.00|2025.06.02.00|runtime-network|Compliance mode enabled, was '2025.06.02.00'|
|fbthrift|2025.03.10.00|2025.06.02.00|app-network|Compliance mode enabled, was '2025.06.02.00'|
...
|firefox|139.0|139.0.1|app-web|Compliance mode enabled, was '139.0.1'|
...
|fizz|2025.03.24.00|2025.06.02.00|app-network|Compliance mode enabled, was '2025.06.02.00'|
...
|folly|2025.03.24.00|2025.06.02.00|runtime-common|Compliance mode enabled, was '2025.06.02.00'|
...
|fonttools|4.53.1|4.58.1|desktop-fonts|Compliance mode enabled, was '4.58.1'|
...
|glab|1.58.0|1.59.2|app-devel|Compliance mode enabled, was '1.59.2'|
...
|gnome-maps|42.3|48.3|desktop-gnome|Compliance mode enabled, was '48.3'|
...
|grpc|1.72.0|1.72.1|app-network|Compliance mode enabled, was '1.72.1'|
...
|hypothesis-python|6.97.4|6.135.0|lang-python|Compliance mode enabled, was '6.135.0'|
...
|kweathercore|0.7|25.04.1|desktop-kde|Compliance mode enabled, was '25.04.1'|
...
|lazygit|0.48.0|0.51.1|app-vcs|Compliance mode enabled, was '0.51.1'|
...
|libphonenumber|8.13.38|9.0.6|runtime-i18n|Compliance mode enabled, was '9.0.6'|
...
|llama.cpp|5298|5595|runtime-creativity|Compliance mode enabled, was '5595'|
...
|maturin|1.8.1|1.8.6|lang-python|Compliance mode enabled, was '1.8.6'|
...
|mise|2025.5.6|2025.6.0|app-devel|Compliance mode enabled, was '2025.6.0'|
...
|mold|2.38.0|2.40.0|app-devel|Compliance mode enabled, was '2.40.0'|
...
|mvfst|2025.03.24.00|2025.06.02.00|runtime-network|Compliance mode enabled, was '2025.06.02.00'|
...
|openai-python|1.63.2|1.84.0|lang-python|Compliance mode enabled, was '1.84.0'|
...
|osu-lazer|2025.530.0|2025.605.2|app-games|Compliance mode enabled, was '2025.605.2'|
...
|passt|2024_10_30.ee7d0b6|2025_05_12.8ec1341|app-network||
...
|pmbootstrap|3.4.0|3.4.2|app-utils|Compliance mode enabled, was '3.4.2'|
...
|proj|9.2.1|9.6.1|app-gis|Compliance mode enabled, was '9.6.1'|
...
|ruamel-yaml|0.17.19|0.18.12|lang-python|Compliance mode enabled, was '0.18.12'|
...
|scipy|1.6.3|1.15.3|lang-python|Compliance mode enabled, was '1.15.3'|
...
|sqlite|3500000|3.50.0|app-database|Possible downgrade from the current version (3500000 -> 3.50.0)|
|sqlite+32|3.46.1|3.50.0|runtime-optenv32|Compliance mode enabled, was '3.50.0'|
...
|sunshine|2025.122.141614|2025.531.135549|app-multimedia|Compliance mode enabled, was '2025.531.135549'|
...
|syncthing|1.29.6|1.29.7|app-network|Compliance mode enabled, was '1.29.7'|
...
|tailscale|1.84.0|1.84.1|app-network|Compliance mode enabled, was '1.84.1'|
...
|telegram-desktop|5.14.3|5.15.0|app-web|Compliance mode enabled, was '5.15.0'|
...
|typos|1.32.0|1.33.1|app-utils|Compliance mode enabled, was '1.33.1'|
...
|vim|9.1.1418|9.1.1432|app-editors|Compliance mode enabled, was '9.1.1432'|
...
|vulkan-headers|1.4.309.0|1.4.316|runtime-display|Compliance mode enabled, was '1.4.316'|
|vulkan-headers+32|1.4.309.0|1.4.316|runtime-optenv32|Compliance mode enabled, was '1.4.316'|
...
|watchman|2025.03.24.00|2025.06.02.00|app-utils|Compliance mode enabled, was '2025.06.02.00'|
...
|x264|0<br>+git20241027|3219|runtime-multimedia|Compliance mode enabled, was '3219'|
|x264+32|0<br>+git20241027|3219|runtime-optenv32|Compliance mode enabled, was '3219'|
...
|yubikey-manager|4.0.1|5.7.0|app-devices|Compliance mode enabled, was '5.7.0'|
