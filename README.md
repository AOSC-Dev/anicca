...
## Result
![Relative date](https://img.shields.io/date/1736993372?label=Updated)
...
|autobuild4|4.7.6|4.7.7|app-devel|Compliance mode enabled, was '4.7.7'|
...
|bitwarden|2024.12.1|2025.1.0|app-utils|Compliance mode enabled, was '2025.1.0'|
...
|boto3|1.20.26|1.36.0|lang-python|Compliance mode enabled, was '1.36.0'|
|botocore|1.34.133|1.36.0|lang-python|Compliance mode enabled, was '1.36.0'|
...
|gst-libav-1-0+32|1.16.2|1.25.1|runtime-optenv32|Compliance mode enabled, was '1.25.1'|
|gst-plugins-bad-1-0+32|1.16.2|1.25.1|runtime-optenv32|Compliance mode enabled, was '1.25.1'|
|gst-plugins-base-1-0+32|1.16.2|1.25.1|runtime-optenv32|Compliance mode enabled, was '1.25.1'|
|gst-plugins-good-1-0+32|1.16.2|1.25.1|runtime-optenv32|Compliance mode enabled, was '1.25.1'|
|gst-plugins-ugly-1-0+32|1.16.2|1.25.1|runtime-optenv32|Compliance mode enabled, was '1.25.1'|
|gstreamer|1.24.7|1.25.1|runtime-multimedia|Compliance mode enabled, was '1.25.1'|
|gstreamer-1-0+32|1.16.2|1.25.1|groups|Compliance mode enabled, was '1.25.1'|
...
|hypothesis-python|6.97.4|6.123.17|lang-python|Compliance mode enabled, was '6.123.17'|
...
|lact|0.5.6|0.7.0|app-admin|Compliance mode enabled, was '0.7.0'|
...
|libgee|0.20.6|0.20.7|desktop-gnome|Compliance mode enabled, was '0.20.7'|
...
|nomino|1.3.1|1.5.2|app-utils|Compliance mode enabled, was '1.5.2'|
...
|pam-u2f|1.3.0|1.3.1|runtime-admin|Compliance mode enabled, was '1.3.1'|
...
|pandoc|3.6.1|3.6.2|app-doc|Compliance mode enabled, was '3.6.2'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.110|app-games|Compliance mode enabled, was '2.3.110'|
...
|rsync|3.4.0|3.4.1|app-network|Compliance mode enabled, was '3.4.1'|
...
|s3transfer|0.5.0|0.11.0|lang-python|Compliance mode enabled, was '0.11.0'|
...
|sunshine|0.23.1|2025.115.190029|app-multimedia|Compliance mode enabled, was '2025.115.190029'|
...
|syncthing|1.29.1|1.29.2|app-network|Compliance mode enabled, was '1.29.2'|
...
|v2ray-rules-dat|202412282210|202501152211|runtime-data|Compliance mode enabled, was '202501152211'<br>Versions not comparable: `202412282210` and `202501152211`|
...
|vim|9.1.1006|9.1.1019|app-editors|Compliance mode enabled, was '9.1.1019'|
...
|watchman|4.9.0|2025.01.13.00|app-utils|Compliance mode enabled, was '2025.01.13.00'|
...
|xdg-user-dirs-gtk|0.11|0.12|desktop-gnome|Compliance mode enabled, was '0.12'|
...
|zed|0.168.3|0.169.2|app-editors|Compliance mode enabled, was '0.169.2'|
