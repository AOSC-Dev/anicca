...
## Result
![Relative date](https://img.shields.io/date/1732183889?label=Updated)
...
|autobuild4|4.4.0|4.4.1|app-devel|Compliance mode enabled, was '4.4.1'|
...
|boto3|1.20.26|1.35.66|lang-python|Compliance mode enabled, was '1.35.66'|
|botocore|1.34.133|1.35.66|lang-python|Compliance mode enabled, was '1.35.66'|
...
|cloudflared|2024.11.0|2024.11.1|app-network|Compliance mode enabled, was '2024.11.1'|
...
|composer|2.7.7|2.8.3|app-devel|Compliance mode enabled, was '2.8.3'|
...
|deno|1.44.1|2.1.0|lang-js|Compliance mode enabled, was '2.1.0'|
...
|deploykit-gui|0.8.3|0.9.1|app-admin|Compliance mode enabled, was '0.9.1'|
...
|duplicity|3.0.1|3.0.3.1|app-utils|Compliance mode enabled, was '3.0.3.1'|
|easy-rsa|3.2.0|3.2.1|app-cryptography|Compliance mode enabled, was '3.2.1'|
|easyeffects|7.1.9|7.2.0|app-multimedia|Compliance mode enabled, was '7.2.0'|
...
|eza|0.19.0|0.20.9|app-utils|Compliance mode enabled, was '0.20.9'|
...
|ghex|46.0|46.1|desktop-gnome|Compliance mode enabled, was '46.1'|
...
|grpc|1.64.0|1.68.0|app-network|Compliance mode enabled, was '1.68.0'|
...
|gtk-4|4.16.5|4.16.6|desktop-gnome|Compliance mode enabled, was '4.16.6'|
...
|hypothesis-python|6.97.4|6.119.3|lang-python|Compliance mode enabled, was '6.119.3'|
...
|just|1.36.0|1.37.0|app-devel|Compliance mode enabled, was '1.37.0'|
...
|libclc|18.1.8|19.1.4|runtime-devices|Compliance mode enabled, was '19.1.4'|
...
|libinput|1.26.2|1.27.0|runtime-devices|Compliance mode enabled, was '1.27.0'|
...
|libphonenumber|8.13.38|8.13.50|runtime-i18n|Compliance mode enabled, was '8.13.50'|
...
|linux+kernel+lts|6.6.61|5.10.230|runtime-kernel|Compliance mode enabled, was '5.10.230'<br>Possible downgrade from the current version (6.6.61 -> 5.10.230)|
...
|llvm|18.1.8|19.1.4|app-devel|Compliance mode enabled, was '19.1.4'|
|llvm+32|14.0.6|19.1.4|runtime-optenv32|Compliance mode enabled, was '19.1.4'|
|llvm-runtime+wasi|18.1.8|19.1.4|runtime-wasi|Compliance mode enabled, was '19.1.4'|
...
|mihomo-party|1.5.6|1.5.11|app-network|Compliance mode enabled, was '1.5.11'|
...
|mupdf|1.24.10|1.24.11|app-doc|Compliance mode enabled, was '1.24.11'|
...
|ocrmypdf|16.5.0|16.6.2|app-doc|Compliance mode enabled, was '16.6.2'|
...
|oolite|1.90|1.91.0.7645-241119-222d325|app-games|Compliance mode enabled, was '1.91.0.7645-241119-222d325'|
...
|passt|2024_10_30.ee7d0b6|2024_11_21.238c69f|app-network||
...
|pcsx2|1.6.0<br>+git20210825|2.3.21|app-games|Compliance mode enabled, was '2.3.21'|
...
|php|8.3.11|8.4.1|app-devel|Compliance mode enabled, was '8.4.1'|
...
|pydantic|2.6.0|2.10.0|lang-python|Compliance mode enabled, was '2.10.0'|
...
|qemu|9.0.1|9.1.2|app-virtualization|Compliance mode enabled, was '9.1.2'|
...
|qownnotes|22.6.1|24.11.3|app-web|Compliance mode enabled, was '24.11.3'|
...
|re2c|3.1|4.0|runtime-common|Compliance mode enabled, was '4.0'|
...
|showmethekey|1.14.0|1.16.0|app-utils|Compliance mode enabled, was '1.16.0'|
...
|sudo|1.9.16|1.9.16p1|app-admin|Compliance mode enabled, was '1_9_16p1'<br>Possible downgrade from the current version (1.9.16 -> 1.9.16p1)|
...
|telegram-desktop|5.8.1|5.8.2|app-web|Compliance mode enabled, was '5.8.2'|
...
|v2ray-rules-dat|202411192212|202411202212|runtime-data|Compliance mode enabled, was '202411202212'<br>Versions not comparable: `202411192212` and `202411202212`|
...
|vim|9.1.0794|9.1.0880|app-editors|Compliance mode enabled, was '9.1.0880'|
...
|vscodium|1.94.2.24286|1.95.3.24321|app-editors|Compliance mode enabled, was '1.95.3.24321'|
...
|vulkan-headers|1.3.283.0|1.3.302|runtime-display|Compliance mode enabled, was '1.3.302'|
|vulkan-headers+32|1.3.283.0|1.3.302|runtime-optenv32|Compliance mode enabled, was '1.3.302'|
...
|yarl|1.9.4|1.17.2|lang-python|Compliance mode enabled, was '1.17.2'|
...
|zed|0.161.2|0.162.3|app-editors|Compliance mode enabled, was '0.162.3'|
