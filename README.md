...
## Result
![Relative date](https://img.shields.io/date/1766646980?label=Updated)
...
|alsa-lib|1.2.13|1.2.15.1|runtime-multimedia|Compliance mode enabled, was '1.2.15.1'|
|alsa-lib+32|1.2.13|1.2.15.1|runtime-optenv32|Compliance mode enabled, was '1.2.15.1'|
|alsa-ucm-conf|1.2.12|1.2.15.1|runtime-multimedia|Compliance mode enabled, was '1.2.15.1'|
|alsa-utils|1.2.14|1.2.15.1|app-multimedia|Compliance mode enabled, was '1.2.15.1'|
...
|angie|1.10.3|1.11.0|app-web|Compliance mode enabled, was '1.11.0'|
...
|boto3|1.40.25|1.42.16|lang-python|Compliance mode enabled, was '1.42.16'|
|botocore|1.42.6|1.42.16|lang-python|Compliance mode enabled, was '1.42.16'|
...
|bottom|0.11.4|0.12.0|app-admin|Compliance mode enabled, was '0.12.0'|
|bovo|23.08.5|25.12.0|desktop-kde|Compliance mode enabled, was '25.12.0'|
|box64|0.3.9<br>+git20251218|0.3.8|app-emulation|Compliance mode enabled, was '0.3.8'<br>Possible downgrade from the current version (0.3.9+git20251218 -> 0.3.8)|
...
|darktable|5.2.1|5.4.0|app-creativity|Compliance mode enabled, was '5.4.0'|
...
|devscripts|2.25.30|2.25.32|app-devel|Compliance mode enabled, was '2.25.32'|
...
|edencommon|2025.09.01.00|2025.12.22.00|runtime-common|Compliance mode enabled, was '2025.12.22.00'|
...
|fb303|2025.09.01.00|2025.12.22.00|runtime-network|Compliance mode enabled, was '2025.12.22.00'|
|fbthrift|2025.09.01.00|2025.12.22.00|app-network|Compliance mode enabled, was '2025.12.22.00'|
...
|folly|2025.09.01.00|2025.12.22.00|runtime-common|Compliance mode enabled, was '2025.12.22.00'|
...
|furo|2024.8.6|2025.12.19|app-doc|Compliance mode enabled, was '2025.12.19'|
...
|gitoxide|0.46.0|0.48.0|app-vcs|Compliance mode enabled, was '0.48.0'|
...
|gpsd|3.25|3.27.2|app-scientific|Compliance mode enabled, was '3.27.2'|
...
|hugo|0.153.0|0.153.2|app-web|Compliance mode enabled, was '0.153.2'|
...
|kodi-inputstream-adaptive|21.5.14|22.3.5-piers|app-multimedia|Compliance mode enabled, was '22.3.5-Piers'|
...
|libcdio|2.1.0|2.3.0|runtime-devices|Compliance mode enabled, was '2.3.0'|
|libcdio+32|2.1.0|2.3.0|runtime-optenv32|Compliance mode enabled, was '2.3.0'|
...
|libraw|0.20.0|0.21.5|runtime-imaging|Compliance mode enabled, was '0.21.5'|
...
|libva|2.22.0|2.23.0|runtime-multimedia|Compliance mode enabled, was '2.23.0'|
|libva+32|2.22.0|2.23.0|runtime-optenv32|Compliance mode enabled, was '2.23.0'|
...
|libvpl-tools|1.4.0|1.5.0|app-multimedia|Compliance mode enabled, was '1.5.0'|
...
|llama.cpp|7091|7531|runtime-creativity|Compliance mode enabled, was '7531'|
...
|mpv|0.40.0|0.41.0|app-multimedia|Compliance mode enabled, was '0.41.0'|
...
|mvfst|2025.09.01.00|2025.12.22.00|runtime-network|Compliance mode enabled, was '2025.12.22.00'|
|mxml|3.2|4.0.4|runtime-common|Compliance mode enabled, was '4.0.4'|
|mycli|1.41.2|1.42.0|app-database|Compliance mode enabled, was '1.42.0'|
...
|ncurses|6.4|6.5+20251220|runtime-common|Compliance mode enabled, was '6.5-20251220'|
|ncurses+32|6.4|6.5+20251220|runtime-optenv32|Compliance mode enabled, was '6.5-20251220'|
...
|netbird|0.59.10|0.60.9|app-network|Compliance mode enabled, was '0.60.9'|
...
|nodeenv|1.9.1|1.10.0|lang-python|Compliance mode enabled, was '1.10.0'|
...
|oma|1.23.0|1.23.1|app-admin|Compliance mode enabled, was '1.23.1'|
...
|openal-soft|1.23.1|1.25.0|runtime-multimedia|Compliance mode enabled, was '1.25.0'|
|openal-soft+32|1.23.1|1.25.0|runtime-optenv32|Compliance mode enabled, was '1.25.0'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.402|app-games|Compliance mode enabled, was '2.5.402'|
...
|praat|6.4.48|6.4.49|app-scientific|Compliance mode enabled, was '6.4.49'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20251223|lang-python|Compliance mode enabled, was '1.0.2.20251223'|
...
|pypsutil|5.9.8|7.2.0|lang-python|Compliance mode enabled, was '7.2.0'|
...
|qmidiarp|0.7.1|0.7.2|app-multimedia|Compliance mode enabled, was '0.7.2'|
...
|qtractor|1.5.9|1.5.10|app-multimedia|Compliance mode enabled, was '1.5.10'|
...
|sphinx-theme-builder|0.2.0b2|0.3.2|app-doc||
...
|sunshine|2025.924.154138|2025.1224.25230|app-multimedia|Compliance mode enabled, was '2025.1224.25230'|
...
|v2ray-rules-dat|202510042211|202512242215|runtime-data|Compliance mode enabled, was '202512242215'<br>Versions not comparable: `202510042211` and `202512242215`|
...
|vim|9.1.2006|9.1.2017|app-editors|Compliance mode enabled, was '9.1.2017'|
...
|vpl-gpu-rt|25.4.5|25.4.6|runtime-multimedia|Compliance mode enabled, was '25.4.6'|
...
|vscodium|1.106.37943|1.107.18605|app-editors|Compliance mode enabled, was '1.107.18605'|
...
|wangle|2025.09.01.00|2025.12.22.00|runtime-network|Compliance mode enabled, was '2025.12.22.00'|
|warpinator|1.6.3|2.0.2|desktop-cinnamon|Compliance mode enabled, was '2.0.2'|
|warzone2100|4.5.5|4.6.2|app-games||
|watchman|2025.09.01.00|2025.12.22.00|app-utils|Compliance mode enabled, was '2025.12.22.00'|
...
|wcslib|8.3|8.5|runtime-scientific|Compliance mode enabled, was '8.5'|
...
|wireplumber|0.5.12|0.5.13|app-multimedia|Compliance mode enabled, was '0.5.13'|
