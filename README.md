...
## Result
![Relative date](https://img.shields.io/date/1738620706?label=Updated)
...
|abseil-cpp|20240722.0|20240722.1|runtime-common|Compliance mode enabled, was '20240722.1'|
...
|boto3|1.20.26|1.36.12|lang-python|Compliance mode enabled, was '1.36.12'|
|botocore|1.34.133|1.36.12|lang-python|Compliance mode enabled, was '1.36.12'|
...
|buildah|1.38.1|1.39.0|app-containers|Compliance mode enabled, was '1.39.0'|
...
|cargo-release|0.25.10|0.25.16|lang-rust|Compliance mode enabled, was '0.25.16'|
...
|chromium|131.0.6778.264|132.0.6834.159|app-web|Compliance mode enabled, was '132.0.6834.159'|
...
|debian-ports-archive-keyring|2025.01.01|2025.02.01|app-admin|Compliance mode enabled, was '2025.02.01'|
...
|discord|0.0.82|0.0.83|app-web|Compliance mode enabled, was '0.0.83'|
...
|dnscontrol|4.15.5|4.15.6|app-network|Compliance mode enabled, was '4.15.6'|
...
|gdb|16.1|16.2|app-devel|Compliance mode enabled, was '16.2'|
...
|hugo|0.139.3|0.143.0|app-web|Compliance mode enabled, was '0.143.0'|
...
|jenkins|2.468|2.495|app-admin|Compliance mode enabled, was '2.495'|
...
|kubo|0.29.0|0.33.0|app-network|Compliance mode enabled, was '0.33.0'|
...
|linux+kernel+lts|6.12.11|5.10.234|runtime-kernel|Compliance mode enabled, was '5.10.234'<br>Possible downgrade from the current version (6.12.11 -> 5.10.234)|
...
|lxgwcleargothic-font|0.300.4|0.337|desktop-fonts|Compliance mode enabled, was '0.337'|
|lxgwneoxihei-font|1.200|1.212|desktop-fonts|Compliance mode enabled, was '1.212'|
...
|memcached|1.6.29|1.6.35|app-admin|Compliance mode enabled, was '1.6.35'|
...
|mitmproxy|11.0.0|11.1.0|app-network||
...
|nodejs-20|20.18.1|20.18.2|lang-js|Compliance mode enabled, was '20.18.2'|
...
|papirus-icon-theme|20240501|20250201|desktop-themes|Compliance mode enabled, was '20250201'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.137|app-games|Compliance mode enabled, was '2.3.137'|
...
|qownnotes|22.6.1|25.2.1|app-web|Compliance mode enabled, was '25.2.1'|
...
|rpi-firmware-boot|1.20241126|1.20250127|runtime-kernel||
...
|rustc|1.84.0|1.84.1|lang-rust|Compliance mode enabled, was '1.84.1'|
...
|sdl2|2.30.4|3.2.2|runtime-multimedia|Compliance mode enabled, was '3.2.2'|
...
|telegram-desktop|5.10.6|5.10.7|app-web|Compliance mode enabled, was '5.10.7'|
...
|tig|2.5.10|2.5.11|app-utils|Compliance mode enabled, was '2.5.11'|
...
|tsukimi|0.18.3|0.19.0|app-multimedia|Compliance mode enabled, was '0.19.0'|
...
|tuned|2.24.1|2.25.0|app-admin|Compliance mode enabled, was '2.25.0'|
...
|typos|1.29.4|1.29.5|app-utils|Compliance mode enabled, was '1.29.5'|
...
|uv|0.5.25|0.5.26|lang-python|Compliance mode enabled, was '0.5.26'|
|v2ray|5.25.1|5.26.0|app-network|Compliance mode enabled, was '5.26.0'|
|v2ray-rules-dat|202501302211|202502022211|runtime-data|Compliance mode enabled, was '202502022211'<br>Versions not comparable: `202501302211` and `202502022211`|
...
|vim|9.1.1043|9.1.1074|app-editors|Compliance mode enabled, was '9.1.1074'|
...
|vscodium|1.96.4.25017|1.96.4.25026|app-editors|Compliance mode enabled, was '1.96.4.25026'|
...
|xfce4-panel|4.20.0|4.20.2|desktop-xfce|Compliance mode enabled, was '4.20.2'|
...
|zed|0.170.2|0.171.6|app-editors|Compliance mode enabled, was '0.171.6'|
