...
## Result
![Relative date](https://img.shields.io/date/1773613130?label=Updated)
...
|boto3|1.42.54|1.42.68|lang-python|Compliance mode enabled, was '1.42.68'|
|botocore|1.42.54|1.42.68|lang-python|Compliance mode enabled, was '1.42.68'|
...
|cherry-studio|1.7.13|1.7.25|app-utils|Compliance mode enabled, was '1.7.25'|
...
|cli-helpers|1.1.0|2.11.0|lang-python|Compliance mode enabled, was '2.11.0'|
...
|crush|0.29.1|0.49.0|app-utils|Compliance mode enabled, was '0.49.0'|
...
|edencommon|2025.09.01.00|2026.03.09.00|runtime-common|Compliance mode enabled, was '2026.03.09.00'|
...
|fb303|2025.09.01.00|2026.03.09.00|runtime-network|Compliance mode enabled, was '2026.03.09.00'|
|fbthrift|2025.09.01.00|2026.03.09.00|app-network|Compliance mode enabled, was '2026.03.09.00'|
...
|feishin|1.6.0|1.8.0|app-multimedia|Compliance mode enabled, was '1.8.0'|
...
|fizz|2025.09.01.00|2026.03.09.00|app-network|Compliance mode enabled, was '2026.03.09.00'|
...
|folly|2025.09.01.00|2026.03.09.00|runtime-common|Compliance mode enabled, was '2026.03.09.00'|
...
|gmic|3.6.6|3.7.2|runtime-imaging|Compliance mode enabled, was '3.7.2'|
...
|hugo|0.154.3|0.157.0|app-web|Compliance mode enabled, was '0.157.0'|
...
|kitty|0.45.0|0.46.0|app-utils|Compliance mode enabled, was '0.46.0'|
...
|libfilezilla|0.54.1|0.38.1|runtime-network|Compliance mode enabled, was '0.38.1'<br>Possible downgrade from the current version (0.54.1 -> 0.38.1)|
...
|llama.cpp|8232|8358|runtime-creativity|Compliance mode enabled, was '8358'|
...
|marco|1.28.1|1.28.2|desktop-mate|Compliance mode enabled, was '1.28.2'|
...
|mate-notification-daemon|1.28.3|1.28.5|desktop-mate|Compliance mode enabled, was '1.28.5'|
|mate-panel|1.28.4|1.28.7|desktop-mate|Compliance mode enabled, was '1.28.7'|
|mate-terminal|1.28.1|1.28.2|desktop-mate|Compliance mode enabled, was '1.28.2'|
...
|mvfst|2025.09.01.00|2026.03.09.00|runtime-network|Compliance mode enabled, was '2026.03.09.00'|
|mxml|3.3.1|4.0.4|runtime-common|Compliance mode enabled, was '4.0.4'|
|mycli|1.42.0|1.64.0|app-database|Compliance mode enabled, was '1.64.0'|
...
|orca|49.5|50.0.4|desktop-gnome|Compliance mode enabled, was '50.0.4'|
...
|pcsx2|2.7.181|2.7.183|app-games||
...
|pipewire|1.6.0|1.6.1|app-multimedia|Compliance mode enabled, was '1.6.1'|
...
|python-tabulate|0.9.0|0.10.0|lang-python|Compliance mode enabled, was '0.10.0'|
...
|rocm-llama-cpp|7.0.1|8358|runtime-rocm|Compliance mode enabled, was '8358'|
...
|setuptools-python2|44.1.0|82.0.1|lang-python|Compliance mode enabled, was '82.0.1'|
...
|sing-box|1.13.2|1.13.3|app-proxy|Compliance mode enabled, was '1.13.3'|
...
|sunshine|2025.924.154138|2026.314.174349|app-multimedia|Compliance mode enabled, was '2026.314.174349'|
...
|v2ray-rules-dat|202601042214|202603142220|runtime-data|Compliance mode enabled, was '202603142220'<br>Versions not comparable: `202601042214` and `202603142220`|
...
|vim|9.2.0|9.2.0173|app-editors|Compliance mode enabled, was '9.2.0173'|
...
|wangle|2025.09.01.00|2026.03.09.00|runtime-network|Compliance mode enabled, was '2026.03.09.00'|
|warzone2100|4.5.5|4.6.3|app-games||
|watchman|2025.09.01.00|2026.03.09.00|app-utils|Compliance mode enabled, was '2026.03.09.00'|
