...
## Result
![Relative date](https://img.shields.io/date/1771331821?label=Updated)
...
|boto3|1.40.25|1.42.50|lang-python|Compliance mode enabled, was '1.42.50'|
|botocore|1.42.6|1.42.50|lang-python|Compliance mode enabled, was '1.42.50'|
...
|chromium|142.0.7444.134|145.0.7632.75|app-web|Compliance mode enabled, was '145.0.7632.75'|
...
|cinnamon-session|5.8.1|6.6.3|desktop-cinnamon|Compliance mode enabled, was '6.6.3'|
...
|cinny-desktop|4.10.2|4.10.3|app-web|Compliance mode enabled, was '4.10.3'|
...
|coherent.build|0.35.2|0.36.1|lang-python|Compliance mode enabled, was '0.36.1'|
...
|cosmic-icons|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
|cosmic-idle|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
|cosmic-initial-setup|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
|cosmic-launcher|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
|cosmic-notifications|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
|cosmic-osd|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
|cosmic-panel|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
|cosmic-player|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
|cosmic-randr|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
...
|cosmic-workspaces|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
...
|crush|0.29.1|0.43.0|app-utils|Compliance mode enabled, was '0.43.0'|
...
|ctags|6.2.20251005.0|6.2.20260215.0|app-devel|Compliance mode enabled, was '6.2.20260215.0'|
...
|damo|2.4.7|3.1.5|app-admin|Compliance mode enabled, was '3.1.5'|
...
|deno|2.6.8|2.6.9|lang-js|Compliance mode enabled, was '2.6.9'|
...
|ed|1.22.4|1.22.5|app-editors|Compliance mode enabled, was '1.22.5'|
|edencommon|2025.09.01.00|2026.02.16.00|runtime-common|Compliance mode enabled, was '2026.02.16.00'|
...
|fb303|2025.09.01.00|2026.02.16.00|runtime-network|Compliance mode enabled, was '2026.02.16.00'|
|fbthrift|2025.09.01.00|2026.02.16.00|app-network|Compliance mode enabled, was '2026.02.16.00'|
...
|firefox|147.0.3|147.0.4|app-web|Compliance mode enabled, was '147.0.4'|
...
|fizz|2025.09.01.00|2026.02.16.00|app-network|Compliance mode enabled, was '2026.02.16.00'|
...
|folly|2025.09.01.00|2026.02.16.00|runtime-common|Compliance mode enabled, was '2026.02.16.00'|
...
|freetds|1.00.112|1.5.12|runtime-database|Compliance mode enabled, was '1.5.12'|
...
|glab|1.80.4|1.85.2|app-devel|Compliance mode enabled, was '1.85.2'|
|glances|4.4.0|4.5.0.4|app-admin|Compliance mode enabled, was '4.5.0.4'|
...
|glycin|2.0.5|2.0.8|desktop-gnome|Compliance mode enabled, was '2.0.8'|
...
|gnome-shell|42.4|49.4|desktop-gnome|Compliance mode enabled, was '49.4'|
...
|google-chrome|144.0.7559.132|145.0.7632.75|app-web|Compliance mode enabled, was '145.0.7632.75'|
...
|hmcl|3.10.2|3.6.18|app-games|Compliance mode enabled, was '3.6.18'<br>Possible downgrade from the current version (3.10.2 -> 3.6.18)|
...
|incus-ui-canonical|0.18.2|0.19.5|app-containers|Compliance mode enabled, was '0.19.5'|
...
|kcptun|20241227|20260213|app-proxy|Compliance mode enabled, was '20260213'|
...
|libguestfs|1.54.1|1.59.3|runtime-virtualization|Compliance mode enabled, was '1.59.3'|
...
|libquotient|0.8.2|0.9.6|runtime-web|Compliance mode enabled, was '0.9.6'|
...
|libreoffice|25.8.4.2|26.2.1.1|app-productivity|Compliance mode enabled, was '26.2.1.1'|
...
|linux+api|6.12.68|6.12.73|core-devel|Compliance mode enabled, was '6.12.73'|
|linux+api+32|6.12.7|6.12.73|runtime-optenv32|Compliance mode enabled, was '6.12.73'|
...
|linux+kernel+retro|5.10.204|5.10.250|runtime-kernel|Compliance mode enabled, was '5.10.250'|
|linux+kernel+retro+minimal|5.15.17|5.10.250|runtime-kernel|Compliance mode enabled, was '5.10.250'<br>Possible downgrade from the current version (5.15.17 -> 5.10.250)|
|linux-kernel|6.18.8|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.18.8 -> 5.19.17)|
|linux-kernel-2k0300|6.12.59|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.12.59 -> 5.19.17)|
|linux-kernel-rc|6.18.0|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.18.0 -> 5.19.17)|
|linux-kernel-retro|5.10.204|5.10.250|runtime-kernel|Compliance mode enabled, was '5.10.250'|
...
|llama.cpp|7966|8077|runtime-creativity|Compliance mode enabled, was '8077'|
...
|maturin|1.9.6|1.12.2|lang-python|Compliance mode enabled, was '1.12.2'|
...
|mise|2026.1.1|2026.2.13|app-devel|Compliance mode enabled, was '2026.2.13'|
...
|mutter|42.4|49.4|desktop-gnome|Compliance mode enabled, was '49.4'|
|mvfst|2025.09.01.00|2026.02.16.00|runtime-network|Compliance mode enabled, was '2026.02.16.00'|
|mxml|3.3.1|4.0.4|runtime-common|Compliance mode enabled, was '4.0.4'|
|mycli|1.42.0|1.54.1|app-database|Compliance mode enabled, was '1.54.1'|
...
|navidrome|0.59.0|0.60.3|app-multimedia|Compliance mode enabled, was '0.60.3'|
...
|ncurses|6.4|6.6+20260214|runtime-common|Compliance mode enabled, was '6.6-20260214'|
|ncurses+32|6.4|6.6+20260214|runtime-optenv32|Compliance mode enabled, was '6.6-20260214'|
...
|netbird|0.63.0|0.65.1|app-network|Compliance mode enabled, was '0.65.1'|
...
|nss|3.119|3.120.1|runtime-cryptography|Compliance mode enabled, was '3.120.1'|
|nss+32|3.113|3.120.1|runtime-optenv32|Compliance mode enabled, was '3.120.1'|
...
|numix-icon-theme-circle|25.10.14|26.02.11|desktop-themes|Compliance mode enabled, was '26.02.11'|
...
|ocrmypdf|16.5.0|17.2.0|app-doc|Compliance mode enabled, was '17.2.0'|
...
|openai-python|1.63.2|2.21.0|lang-python|Compliance mode enabled, was '2.21.0'|
...
|openjdk-11|11.0.28-ga|11.0.31+2|lang-java||
|openjdk-17|17.0.16-ga|17.0.19+2|lang-java||
|openjdk-21|21.0.8-ga|21.0.11+2|lang-java||
|openjdk-22|22.0.2-ga|22.0.2+9|lang-java||
|openjdk-23|23.0.2-ga|23.0.2+7|lang-java||
|openjdk-24|24.0.2-ga|24.0.2+12|lang-java||
|openjdk-8|8u462-ga|8u492-b03|lang-java||
...
|pcsx2|1.6.0<br>+git20210825|2.7.127|app-games|Compliance mode enabled, was '2.7.127'|
...
|pillow|12.0.0|12.1.1|lang-python|Compliance mode enabled, was '12.1.1'|
...
|poppler|25.07.0|26.02.0|groups|Compliance mode enabled, was '26.02.0'|
...
|presenterm|0.15.1|0.16.0|app-productivity|Compliance mode enabled, was '0.16.0'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20260217|lang-python|Compliance mode enabled, was '1.0.2.20260217'|
...
|py-filelock|3.14.0|3.24.2|lang-python|Compliance mode enabled, was '3.24.2'|
...
|pybind11|2.13.6|3.0.2|lang-python|Compliance mode enabled, was '3.0.2'|
...
|python-zxing-cpp|2.3.0|3.0.1|lang-python|Compliance mode enabled, was '3.0.1'|
...
|redis|8.4.0|8.6.0|app-database|Compliance mode enabled, was '8.6.0'|
...
|remmina|1.4.40|1.4.42|app-network|Compliance mode enabled, was '1.4.42'|
...
|rocm-aqlprofile|7.2.0|7.12.60430|runtime-rocm|Compliance mode enabled, was '7.12.60430'|
|rocm-bandwidth-test|6.4.3|20250912.42|runtime-rocm|Compliance mode enabled, was '20250912-42'|
|rocm-clr|7.2.0|7.12.60430|runtime-rocm|Compliance mode enabled, was '7.12.60430'|
...
|rocm-core|7.2.0|7.12.60430|runtime-rocm|Compliance mode enabled, was '7.12.60430'|
...
|rocm-llama-cpp|7.0.1|8077|runtime-rocm|Compliance mode enabled, was '8077'|
...
|rocm-rocprofiler-register|7.2.0|7.12.60430|runtime-rocm|Compliance mode enabled, was '7.12.60430'|
...
|rocm-roctracer|7.2.0|7.12.60430|runtime-rocm|Compliance mode enabled, was '7.12.60430'|
|rocm-smi-lib|7.2.0|7.12.60430|runtime-rocm|Compliance mode enabled, was '7.12.60430'|
|rocminfo|7.2.0|7.12.60430|runtime-rocm|Compliance mode enabled, was '7.12.60430'|
|rocr-runtime|7.2.0|7.12.60430|runtime-rocm|Compliance mode enabled, was '7.12.60430'|
...
|sunshine|2025.924.154138|2026.215.224211|app-multimedia|Compliance mode enabled, was '2026.215.224211'|
...
|teams-for-linux|2.2.1|2.7.5|app-web|Compliance mode enabled, was '2.7.5'|
...
|usage|2.10.0|2.17.0|app-utils|Compliance mode enabled, was '2.17.0'|
...
|uv|0.9.28|0.10.3|lang-python|Compliance mode enabled, was '0.10.3'|
|v2ray|5.44.1|5.45.1|app-proxy|Compliance mode enabled, was '5.45.1'|
|v2ray-rules-dat|202601042214|202602162221|runtime-data|Compliance mode enabled, was '202602162221'<br>Versions not comparable: `202601042214` and `202602162221`|
|v2raya|2.2.7.3|2.3.1|app-proxy|Compliance mode enabled, was '2.3.1'|
...
|vim|9.1.2103|9.2.0014|app-editors|Compliance mode enabled, was '9.2.0014'|
...
|virtualenv|20.35.4|20.37.0|lang-python|Compliance mode enabled, was '20.37.0'|
...
|vscode|1.109.2|1.109.4|app-editors|Compliance mode enabled, was '1.109.4'|
|vscodium|1.108.20787|1.109.41146|app-editors|Compliance mode enabled, was '1.109.41146'|
...
|vulkan-extensionlayer|1.4.335.0|1.4.343|runtime-display|Compliance mode enabled, was '1.4.343'|
...
|vulkan-validationlayers|1.4.335.0|1.4.343|runtime-display|Compliance mode enabled, was '1.4.343'|
|waffle|1.8.0|1.8.1|runtime-common|Compliance mode enabled, was '1.8.1'|
|wangle|2025.09.01.00|2026.02.16.00|runtime-network|Compliance mode enabled, was '2026.02.16.00'|
|warpinator|1.6.3|2.0.3|desktop-cinnamon|Compliance mode enabled, was '2.0.3'|
|warzone2100|4.5.5|4.6.3|app-games||
|watchman|2025.09.01.00|2026.02.16.00|app-utils|Compliance mode enabled, was '2026.02.16.00'|
...
|weston|14.0.2|14.0.97|runtime-display|Compliance mode enabled, was '14.0.97'|
...
|xdg-desktop-portal-cosmic|1.0.3|1.0.6|desktop-cosmic|Compliance mode enabled, was '1.0.6'|
...
|z3|4.15.4|4.15.8|app-devel|Compliance mode enabled, was '4.15.8'|
...
|zathura|2026.02.03|2026.02.09|app-doc|Compliance mode enabled, was '2026.02.09'|
|zeal|0.7.0|0.7.2|app-doc|Compliance mode enabled, was '0.7.2'|
|zed|0.222.4|0.223.3|app-editors|Compliance mode enabled, was '0.223.3'|
...
|zxing-cpp|2.3.0|3.0.1|app-utils|Compliance mode enabled, was '3.0.1'|
