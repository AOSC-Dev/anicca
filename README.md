...
## Result
![Relative date](https://img.shields.io/date/1766406287?label=Updated)
...
|ab-download-manager|1.8.0|1.8.1|app-web|Compliance mode enabled, was '1.8.1'|
...
|aosc-community-wallpapers-extras-2023|2023.10.1|2025.12.2|desktop-themes|Compliance mode enabled, was '2025.12.2'|
|aosc-community-wallpapers-extras-2024|2024.04.4|2025.12.2|desktop-themes|Compliance mode enabled, was '2025.12.2'|
...
|boto3|1.40.25|1.42.14|lang-python|Compliance mode enabled, was '1.42.14'|
|botocore|1.42.6|1.42.14|lang-python|Compliance mode enabled, was '1.42.14'|
...
|goverlay|1.2|1.6.5|app-utils|Compliance mode enabled, was '1.6.5'|
...
|gpsd|3.25|3.27.1|app-scientific|Compliance mode enabled, was '3.27.1'|
...
|hugo|0.153.0|0.153.1|app-web|Compliance mode enabled, was '0.153.1'|
...
|i3|4.24|4.25|desktop-wm|Compliance mode enabled, was '4.25'|
...
|llama.cpp|7091|7503|runtime-creativity|Compliance mode enabled, was '7503'|
...
|net-snmp|5.9.4|5.9.5|app-network|Compliance mode enabled, was '5.9.5'|
|netavark|1.13.0|1.17.1|runtime-containers|Compliance mode enabled, was '1.17.1'|
|netbird|0.59.10|0.60.8|app-network|Compliance mode enabled, was '0.60.8'|
...
|onefetch|2.21.0|2.26.1|app-utils|Compliance mode enabled, was '2.26.1'|
|oolite|1.90|1.91.0.7729-251221-f5066bd|app-games|Compliance mode enabled, was '1.91.0.7729-251221-f5066bd'|
...
|pcsx2|1.6.0<br>+git20210825|2.5.398|app-games|Compliance mode enabled, was '2.5.398'|
...
|publicsuffixlist|1.0.2.20250809|1.0.2.20251222|lang-python|Compliance mode enabled, was '1.0.2.20251222'|
...
|rocm-llama-cpp|7.0.1|7503|runtime-rocm|Compliance mode enabled, was '7503'|
...
|types-setuptools|80.9.0.20250822|80.9.0.20251221|lang-python|Compliance mode enabled, was '80.9.0.20251221'|
...
|v2ray-rules-dat|202510042211|202512212214|runtime-data|Compliance mode enabled, was '202512212214'<br>Versions not comparable: `202510042211` and `202512212214`|
...
|vim|9.1.1837|9.1.2006|app-editors|Compliance mode enabled, was '9.1.2006'|
|virtiofsd|1.13.2|1.13.3|app-virtualization|Compliance mode enabled, was '1.13.3'|
|vlc|3.0.22|3.0.23+2|app-multimedia|Compliance mode enabled, was '3.0.23-2'|
...
|xournalpp|1.2.5|1.3.1|runtime-productivity|Compliance mode enabled, was '1.3.1'|
...
|zed|0.217.1|0.217.3|app-editors|Compliance mode enabled, was '0.217.3'|
