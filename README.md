...
## Result
![Relative date](https://img.shields.io/date/1787224707?label=Updated)
...
|apsw|3.53.4.0|3.53.3.1|lang-python|Compliance mode enabled, was '3.53.3.1'<br>Possible downgrade from the current version (3.53.4.0 -> 3.53.3.1)|
...
|boto3|1.43.62|1.43.75|lang-python|Compliance mode enabled, was '1.43.75'|
|botocore|1.43.62|1.43.75|lang-python|Compliance mode enabled, was '1.43.75'|
...
|cherry-studio|2.0.4|2.0.8|app-utils|Compliance mode enabled, was '2.0.8'|
...
|croc|10.4.3|11.2.3|app-utils|Compliance mode enabled, was '11.2.3'|
...
|crush|0.89.0|0.90.0|app-utils|Compliance mode enabled, was '0.90.0'|
...
|dart-sass|1.99.0|1.103.0|app-devel|Compliance mode enabled, was '1.103.0'|
|dart-sass-js|1.99.0|1.103.0|app-devel|Compliance mode enabled, was '1.103.0'|
...
|feedparser|6.0.14|6.0.13|lang-python|Compliance mode enabled, was '6.0.13'<br>Possible downgrade from the current version (6.0.14 -> 6.0.13)|
...
|fsspec|2026.7.0|2026.6.0|lang-python|Compliance mode enabled, was '2026.6.0'<br>Possible downgrade from the current version (2026.7.0 -> 2026.6.0)|
...
|fvm|4.1.0|4.1.4|lang-dart|Compliance mode enabled, was '4.1.4'|
|fwupd|2.1.7|2.1.6|app-admin|Compliance mode enabled, was '2.1.6'<br>Possible downgrade from the current version (2.1.7 -> 2.1.6)|
...
|go|1.26.5<br>+tools0.48.0|1.27.0|lang-golang|Compliance mode enabled, was '1.27.0'|
...
|gradle|9.6.1|9.7.1|lang-java|Compliance mode enabled, was '9.7.1'|
...
|kopeninghours|23.08.5|26.08.0|desktop-kde|Compliance mode enabled, was '26.08.0'|
...
|liferea|1.16.7|2.0|app-web|Compliance mode enabled, was '2.0'|
...
|linux+api|6.18.35|6.18.45|core-devel|Compliance mode enabled, was '6.18.45'|
|linux+api+32|6.12.7|6.12.104|runtime-optenv32|Compliance mode enabled, was '6.12.104'|
...
|llama.cpp|10453|0.1.2|runtime-creativity|Compliance mode enabled, was '0.1.2'<br>Possible downgrade from the current version (10453 -> 0.1.2)|
...
|mate-control-center|1.28.1|1.29.0|desktop-mate|Compliance mode enabled, was '1.29.0'|
...
|mesa|26.1.5|26.2.1|runtime-display||
|mesa+32|26.1.5|26.2.1|runtime-optenv32||
|mesa-pvr-ddk119|22.1.3<br>+vf2sdk3.8.2|26.2.1|runtime-display|Compliance mode enabled, was '26.2.1'|
...
|mise|2026.1.1|2026.8.9|app-devel|Compliance mode enabled, was '2026.8.9'|
...
|multipath-tools|0.13.0|0.14.4|app-admin|Compliance mode enabled, was '0.14.4'|
...
|nginx|1.30.4<br>+brotli1.0.0~rc1<br>+git20231009|1.31.4|app-web|Compliance mode enabled, was '1.31.4'|
...
|nodejs-22|22.23.2|22.23.1|lang-js|Compliance mode enabled, was '22.23.1'<br>Possible downgrade from the current version (22.23.2 -> 22.23.1)|
|nodejs-24|24.19.0|24.18.1|lang-js|Compliance mode enabled, was '24.18.1'<br>Possible downgrade from the current version (24.19.0 -> 24.18.1)|
...
|openai-python|2.26.0|3.3.1|lang-python|Compliance mode enabled, was '3.3.1'|
...
|openclaude|0.23.0|0.29.1|app-utils|Compliance mode enabled, was '0.29.1'|
...
|opentofu|1.11.2|1.12.6|app-admin|Compliance mode enabled, was '1.12.6'|
...
|pcsx2|2.7.181|2.7.523|app-games||
...
|reasonix|1.17.21|1.30.0|app-vibe|Compliance mode enabled, was '1.30.0'|
...
|rocm-amdsmi|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-aqlprofile|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-bandwidth-test|6.4.3|20250912.42|runtime-rocm|Compliance mode enabled, was '20250912-42'|
|rocm-clr|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
...
|rocm-core|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-cuid|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
...
|rocm-hipfile|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
...
|rocm-llama-cpp|7.0.1|0.1.2|runtime-rocm|Compliance mode enabled, was '0.1.2'<br>Possible downgrade from the current version (7.0.1 -> 0.1.2)|
...
|rocm-rdc|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-rocblas|7.14|7.14.0|runtime-rocm|Compliance mode enabled, was '7.14.0'|
|rocm-rocdecode|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-rocfft|7.14|7.14.0|runtime-rocm|Compliance mode enabled, was '7.14.0'|
|rocm-rocjpeg|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-rocprim|7.14|7.14.0|runtime-rocm|Compliance mode enabled, was '7.14.0'|
|rocm-rocprofiler-register|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-rocprofiler-sdk|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-rocrand|7.14|7.14.0|runtime-rocm|Compliance mode enabled, was '7.14.0'|
|rocm-rocshmem|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
...
|rocm-roctracer|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-rvs|7.2.4|20250912.42|runtime-rocm|Compliance mode enabled, was '20250912-42'|
|rocm-smi-lib|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocm-transfer-bench|1.64.00|20250912.42|runtime-rocm|Compliance mode enabled, was '20250912-42'|
|rocminfo|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
|rocr-runtime|7.14|10.1.62310|runtime-rocm|Compliance mode enabled, was '10.1.62310'|
...
|teams-for-linux|2.2.1|2.17.0|app-web|Compliance mode enabled, was '2.17.0'|
...
|tsukimi|26.8.1|26.8.4|app-multimedia|Compliance mode enabled, was '26.8.4'|
...
|v2ray-rules-dat|202601042214|202608192217|runtime-data|Compliance mode enabled, was '202608192217'<br>Versions not comparable: `202601042214` and `202608192217`|
...
|vim|9.2.0976|9.2.0984|app-editors|Compliance mode enabled, was '9.2.0984'|
...
|yt-dlp|2026.07.04|2026.08.19|app-multimedia|Compliance mode enabled, was '2026.08.19'|
...
|zed|1.13.2|1.16.1|app-editors|Compliance mode enabled, was '1.16.1'|
|zellij|0.44.3|0.45.0|app-utils|Compliance mode enabled, was '0.45.0'|
