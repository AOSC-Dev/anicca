...
## Result
![Relative date](https://img.shields.io/date/1772083035?label=Updated)
...
|boto3|1.42.54|1.42.57|lang-python|Compliance mode enabled, was '1.42.57'|
|botocore|1.42.54|1.42.57|lang-python|Compliance mode enabled, was '1.42.57'|
...
|cherry-studio|1.7.13|1.7.21|app-utils|Compliance mode enabled, was '1.7.21'|
...
|crush|0.29.1|0.45.1|app-utils|Compliance mode enabled, was '0.45.1'|
...
|deno|2.6.10|2.7.1|lang-js|Compliance mode enabled, was '2.7.1'|
...
|freerdp|3.17.2|3.23.0|app-network|Compliance mode enabled, was '3.23.0'|
...
|goreleaser|2.13.1|2.14.1|lang-golang|Compliance mode enabled, was '2.14.1'|
...
|krita|5.2.14|5.2.16|app-creativity|Compliance mode enabled, was '5.2.16'|
...
|kubo|0.39.0|0.40.0|app-proxy|Compliance mode enabled, was '0.40.0'|
...
|libreoffice|25.8.4.2|26.2.1.2|app-productivity|Compliance mode enabled, was '26.2.1.2'|
...
|llama.cpp|7966|8156|runtime-creativity|Compliance mode enabled, was '8156'|
...
|mesa|25.3.5|26.0.1|runtime-display||
|mesa+32|25.3.2|26.0.1|runtime-optenv32||
|mesa-pvr-ddk119|22.1.3<br>+vf2sdk3.8.2|26.0.1|runtime-display|Compliance mode enabled, was '26.0.1'|
...
|mycli|1.42.0|1.57.0|app-database|Compliance mode enabled, was '1.57.0'|
...
|openjdk-17|17.0.16-ga|17.0.19+4|lang-java||
|openjdk-21|21.0.8-ga|21.0.11+4|lang-java||
...
|pcsx2|1.6.0<br>+git20210825|2.7.143|app-games|Compliance mode enabled, was '2.7.143'|
...
|rocm-llama-cpp|7.0.1|8156|runtime-rocm|Compliance mode enabled, was '8156'|
...
|showmethekey|1.19.0|1.20.0|app-utils|Compliance mode enabled, was '1.20.0'|
...
|sunshine|2025.924.154138|2026.225.33545|app-multimedia|Compliance mode enabled, was '2026.225.33545'|
...
|swaybg|1.2.1|1.2.2|app-utils|Compliance mode enabled, was '1.2.2'|
|sweeper|23.08.5|25.12.2|desktop-kde|Compliance mode enabled, was '25.12.2'|
|swiftclient|4.6.0|4.10.0|lang-python|Compliance mode enabled, was '4.10.0'|
...
|tailscale|1.94.1|1.94.2|app-network|Compliance mode enabled, was '1.94.2'|
...
|v2ray-rules-dat|202601042214|202602252226|runtime-data|Compliance mode enabled, was '202602252226'<br>Versions not comparable: `202601042214` and `202602252226`|
...
|vim|9.2.0|9.2.0061|app-editors|Compliance mode enabled, was '9.2.0061'|
...
|virtualenv|20.35.4|21.0.0|lang-python|Compliance mode enabled, was '21.0.0'|
...
|zed|0.222.4|0.225.9|app-editors|Compliance mode enabled, was '0.225.9'|
