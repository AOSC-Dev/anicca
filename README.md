...
## Result
![Relative date](https://img.shields.io/date/1716127951?label=Updated)
...
|fim|0.7<br>+git20240221|0.7.1|app-utils|Compound version number '0.7+git20240221'<br>Version number indicates a snapshot (+git) is used|
