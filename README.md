...
## Result
![Relative date](https://img.shields.io/date/1773876218?label=Updated)
...
|blueprint-compiler|0.18.0|0.20.0|app-devel|Compliance mode enabled, was '0.20.0'|
...
|boto3|1.42.54|1.42.71|lang-python|Compliance mode enabled, was '1.42.71'|
|botocore|1.42.54|1.42.71|lang-python|Compliance mode enabled, was '1.42.71'|
...
|cherry-studio|1.7.13|1.8.1|app-utils|Compliance mode enabled, was '1.8.1'|
...
|code-server|4.107.0|4.111.0|app-utils|Compliance mode enabled, was '4.111.0'|
...
|crush|0.29.1|0.50.1|app-utils|Compliance mode enabled, was '0.50.1'|
...
|deno|2.7.5|2.7.6|lang-js|Compliance mode enabled, was '2.7.6'|
...
|dune|3.20.2|3.21.1|lang-ocaml|Compliance mode enabled, was '3.21.1'|
...
|easyeffects|7.2.5|8.1.5|app-multimedia|Compliance mode enabled, was '8.1.5'|
...
|gmic|3.6.6|3.7.3|runtime-imaging|Compliance mode enabled, was '3.7.3'|
...
|godot|4.5.1|4.6.1|app-devel|Compliance mode enabled, was '4.6.1'|
...
|google-chrome|146.0.7680.80|146.0.7680.153|app-web|Compliance mode enabled, was '146.0.7680.153'|
...
|gradle|9.3.0|9.4.0|lang-java|Compliance mode enabled, was '9.4.0'|
...
|gstreamer|1.26.10|1.28.1|runtime-multimedia|Compliance mode enabled, was '1.28.1'|
...
|harfbuzz|12.3.0|13.1.1|runtime-desktop|Compliance mode enabled, was '13.1.1'|
|harfbuzz+32|12.3.0|13.1.1|runtime-optenv32|Compliance mode enabled, was '13.1.1'|
...
|htslib|1.21|1.23.1|app-scientific|Compliance mode enabled, was '1.23.1'|
...
|iana-etc|20260310|20260318|runtime-data|Compliance mode enabled, was '20260318'|
...
|kicad|9.0.6|9.0.8|app-electronics|Compliance mode enabled, was '9.0.8'|
...
|kubernetes|1.34.1|1.35.2|app-containers|Compliance mode enabled, was '1.35.2'|
...
|lego|4.31.0|4.32.0|app-web|Compliance mode enabled, was '4.32.0'|
...
|libde265|1.0.16|1.0.17|runtime-multimedia|Compliance mode enabled, was '1.0.17'|
...
|libreoffice|26.2.0.3|26.2.2.1|app-productivity|Compliance mode enabled, was '26.2.2.1'|
...
|llama.cpp|8400|8412|runtime-creativity|Compliance mode enabled, was '8412'|
...
|nokogiri|1.18.10|1.19.1|lang-ruby|Compliance mode enabled, was '1.19.1'|
...
|nsd|4.7.0|4.14.1|app-network|Compliance mode enabled, was '4.14.1'|
...
|pandoc|3.6.3|3.9.0.1|app-doc|Compliance mode enabled, was '3.9.0.1'|
...
|pyside6|6.10.1|6.10.2|lang-python|Compliance mode enabled, was '6.10.2'|
...
|rocm-llama-cpp|7.0.1|8412|runtime-rocm|Compliance mode enabled, was '8412'|
...
|samba|4.23.4|4.24.0|app-network|Compliance mode enabled, was '4.24.0'|
|samtools|1.21|1.23.1|app-scientific|Compliance mode enabled, was '1.23.1'|
...
|sqlglot|28.1.0|30.0.1|lang-python|Compliance mode enabled, was '30.0.1'|
...
|sunshine|2025.924.154138|2026.318.135110|app-multimedia|Compliance mode enabled, was '2026.318.135110'|
...
|tailscale|1.94.2|1.96.2|app-network|Compliance mode enabled, was '1.96.2'|
...
|uv|0.10.10|0.10.11|lang-python|Compliance mode enabled, was '0.10.11'|
|v2ray-rules-dat|202601042214|202603172227|runtime-data|Compliance mode enabled, was '202603172227'<br>Versions not comparable: `202601042214` and `202603172227`|
...
|vim|9.2.0|9.2.0192|app-editors|Compliance mode enabled, was '9.2.0192'|
...
|wireshark|4.6.2|4.6.4|app-network|Compliance mode enabled, was '4.6.4'|
