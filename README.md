...
## Result
![Relative date](https://img.shields.io/date/1724857864?label=Updated)
...
|ast-grep|0.26.1|0.26.3|app-devel|Compliance mode enabled, was '0.26.3'|
...
|boto3|1.20.26|1.35.7|lang-python|Compliance mode enabled, was '1.35.7'|
|botocore|1.34.133|1.35.7|lang-python|Compliance mode enabled, was '1.35.7'|
...
|containerd|1.7.20|1.7.21|app-containers|Compliance mode enabled, was '1.7.21'|
|containers-common|0.59.2|0.60.2|runtime-containers||
|convertall|0.7.5|1.0.1|app-utils|Compliance mode enabled, was '1.0.1'|
|coreboot-utils|24.05|24.08|app-admin|Compliance mode enabled, was '24.08'|
...
|ctags|20191203|6.1.20240825.0|app-devel|Compliance mode enabled, was '6.1.20240825.0'<br>Possible downgrade from the current version (20191203 -> 6.1.20240825.0)|
...
|hugo|0.131.0|0.133.1|app-web|Compliance mode enabled, was '0.133.1'|
...
|ibus-table|1.14.1|1.17.7|app-i18n|Compliance mode enabled, was '1.17.7'|
...
|imagemagick|6.9.13<br>+14|6.9.13+15|app-utils|Compliance mode enabled, was '6.9.13-15'|
|imagemagick+7|7.1.1<br>+32|7.1.1+37|app-utils|Compliance mode enabled, was '7.1.1-37'|
...
|iosevka-fonts|28.0.5|31.4.0|desktop-fonts|Compliance mode enabled, was '31.4.0'|
...
|jenkins|2.468|2.474|app-admin|Compliance mode enabled, was '2.474'|
...
|kernel-tools|6.10.6|5.19.17|app-admin|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.10.6 -> 5.19.17)|
...
|libphonenumber|8.13.38|8.13.44|runtime-i18n|Compliance mode enabled, was '8.13.44'|
...
|linux+kernel|6.10.6|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.10.6 -> 5.19.17)|
...
|mlt|7.22.0|7.26.0|runtime-multimedia|Compliance mode enabled, was '7.26.0'|
...
|oma|1.8.0|1.12.13|app-admin|Compliance mode enabled, was '1.12.13'|
|onig|6.9.5<br>+rev1|6.9.9|runtime-common|Compliance mode enabled, was '6.9.9'|
|oolite|1.90|1.91.0.7623-240824-ee8bc5c|app-games|Compliance mode enabled, was '1.91.0.7623-240824-ee8bc5c'|
...
|pcsx2|1.6.0<br>+git20210825|2.1.109|app-games|Compliance mode enabled, was '2.1.109'|
...
|perl-mail-spf|2.9.0|3.20240827|lang-perl|Compliance mode enabled, was '3.20240827'|
...
|vim|9.1.0446|9.1.0698|app-editors|Compliance mode enabled, was '9.1.0698'|
