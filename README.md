...
## Result
![Relative date](https://img.shields.io/date/1731776798?label=Updated)
...
|bash-startup|0.6.8|0.6.7|runtime-data|Compliance mode enabled, was '0.6.7'<br>Possible downgrade from the current version (0.6.8 -> 0.6.7)|
