...
## Result
![Relative date](https://img.shields.io/date/1738912264?label=Updated)
...
|apt|2.6.1|2.9.27|app-admin|Compliance mode enabled, was '2.9.27'|
...
|boto3|1.20.26|1.36.15|lang-python|Compliance mode enabled, was '1.36.15'|
|botocore|1.34.133|1.36.15|lang-python|Compliance mode enabled, was '1.36.15'|
...
|cloudflared|2025.1.1|2025.2.0|app-network|Compliance mode enabled, was '2025.2.0'|
...
|damo|2.4.7|2.6.6|app-admin|Compliance mode enabled, was '2.6.6'|
...
|diffutils|3.10|3.11|app-utils|Compliance mode enabled, was '3.11'|
...
|dnscontrol|4.15.5|4.16.0|app-network|Compliance mode enabled, was '4.16.0'|
...
|edencommon|2024.12.30.00|2025.02.03.00|runtime-common|Compliance mode enabled, was '2025.02.03.00'|
...
|eza|0.19.0|0.20.19|app-utils|Compliance mode enabled, was '0.20.19'|
...
|fb303|2024.12.30.00|2025.02.03.00|runtime-network|Compliance mode enabled, was '2025.02.03.00'|
|fbthrift|2024.12.30.00|2025.02.03.00|app-network|Compliance mode enabled, was '2025.02.03.00'|
...
|flatbuffers|2.0.6|25.1.24|runtime-common|Compliance mode enabled, was '25.1.24'|
...
|folly|2024.12.30.00|2025.02.03.00|runtime-common|Compliance mode enabled, was '2025.02.03.00'|
...
|gcr|3.41.1|4.3.1|desktop-gnome|Compliance mode enabled, was '4.3.1'|
...
|josepy|1.13.0|1.15.0|lang-python|Compliance mode enabled, was '1.15.0'|
...
|kcm-wacomtablet|3.2.0|6.2.91|desktop-kde|Compliance mode enabled, was '6.2.91'|
...
|kernel-tools|6.13.1|5.19.17|app-admin|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.13.1 -> 5.19.17)|
...
|libindi|2.0.5|2.1.2|runtime-scientific|Compliance mode enabled, was '2.1.2'|
...
|libreoffice|24.8.4.2|25.2.0.3|app-productivity|Compliance mode enabled, was '25.2.0.3'|
...
|linux+api|6.12.7|6.12.12|core-devel|Compliance mode enabled, was '6.12.12'|
...
|linux+kernel|6.13.1|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.13.1 -> 5.19.17)|
...
|linux+kernel+lts|6.12.12|5.10.234|runtime-kernel|Compliance mode enabled, was '5.10.234'<br>Possible downgrade from the current version (6.12.12 -> 5.10.234)|
...
|linux-kernel|6.13.1|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.13.1 -> 5.19.17)|
|linux-kernel-lts|6.12.12|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.12.12 -> 5.19.17)|
|linux-kernel-rc|6.14.0|5.19.17|runtime-kernel|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.14.0 -> 5.19.17)|
|linux-kernel-retro|5.10.204|5.10.234|runtime-kernel|Compliance mode enabled, was '5.10.234'|
|linux-kernel-retro-minimal|5.15.17|5.10.234|runtime-kernel|Compliance mode enabled, was '5.10.234'<br>Possible downgrade from the current version (5.15.17 -> 5.10.234)|
...
|llama.cpp|4615|4658|runtime-creativity|Compliance mode enabled, was '4658'|
...
|mvfst|2024.12.30.00|2025.02.03.00|runtime-network|Compliance mode enabled, was '2025.02.03.00'|
...
|ncurses|6.4|6.5+20250201|runtime-common|Compliance mode enabled, was '6.5-20250201'|
|ncurses+32|6.4|6.5+20250201|runtime-optenv32|Compliance mode enabled, was '6.5-20250201'|
...
|osu-lazer|2025.122.0|2025.204.0|app-games|Compliance mode enabled, was '2025.204.0'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.144|app-games|Compliance mode enabled, was '2.3.144'|
...
|perl-image-exiftool|12.50|13.18|lang-perl|Compliance mode enabled, was '13.18'|
...
|poppler|22.08.0|25.02.0|groups|Compliance mode enabled, was '25.02.0'|
...
|python-evdev|1.7.1|1.8.0|lang-python|Compliance mode enabled, was '1.8.0'|
...
|qownnotes|22.6.1|25.2.2|app-web|Compliance mode enabled, was '25.2.2'|
...
|vim|9.1.1043|9.1.1081|app-editors|Compliance mode enabled, was '9.1.1081'|
...
|vpl-gpu-rt|25.1.0|25.1.1|runtime-multimedia|Compliance mode enabled, was '25.1.1'|
...
|vscodium|1.96.4.25017|1.97.0.25037|app-editors|Compliance mode enabled, was '1.97.0.25037'|
...
|zed|0.172.8|0.172.9|app-editors|Compliance mode enabled, was '0.172.9'|
