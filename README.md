...
## Result
![Relative date](https://img.shields.io/date/1737770689?label=Updated)
...
|boto3|1.20.26|1.36.6|lang-python|Compliance mode enabled, was '1.36.6'|
|botocore|1.34.133|1.36.6|lang-python|Compliance mode enabled, was '1.36.6'|
...
|chromium|131.0.6778.264|132.0.6834.110|app-web|Compliance mode enabled, was '132.0.6834.110'|
...
|composer|2.7.7|2.8.5|app-devel|Compliance mode enabled, was '2.8.5'|
...
|ctags|20191203|6.1.20250119.0|app-devel|Compliance mode enabled, was '6.1.20250119.0'<br>Possible downgrade from the current version (20191203 -> 6.1.20250119.0)|
...
|deprecated|1.2.14|1.2.17|lang-python|Compliance mode enabled, was '1.2.17'|
...
|eza|0.19.0|0.20.18|app-utils|Compliance mode enabled, was '0.20.18'|
...
|fb303|2024.12.30.00|2025.01.20.00|runtime-network|Compliance mode enabled, was '2025.01.20.00'|
|fbthrift|2024.12.30.00|2025.01.20.00|app-network|Compliance mode enabled, was '2025.01.20.00'|
|fcgi|2.4.2|2.4.4|runtime-web|Compliance mode enabled, was '2.4.4'|
|fcitx5|5.1.11|5.1.12|app-i18n|Compliance mode enabled, was '5.1.12'|
|fcitx5-anthy|5.1.5|5.1.6|app-i18n|Compliance mode enabled, was '5.1.6'|
|fcitx5-chewing|5.1.6|5.1.7|app-i18n|Compliance mode enabled, was '5.1.7'|
|fcitx5-chinese-addons|5.1.7|5.1.8|app-i18n|Compliance mode enabled, was '5.1.8'|
|fcitx5-configtool|5.1.7|5.1.8|app-i18n|Compliance mode enabled, was '5.1.8'|
|fcitx5-hangul|5.1.5|5.1.6|app-i18n|Compliance mode enabled, was '5.1.6'|
|fcitx5-kkc|5.1.5|5.1.6|app-i18n|Compliance mode enabled, was '5.1.6'|
|fcitx5-libthai|5.1.4|5.1.5|app-i18n|Compliance mode enabled, was '5.1.5'|
|fcitx5-lua|5.0.13|5.0.14|app-i18n|Compliance mode enabled, was '5.0.14'|
|fcitx5-m17n|5.1.2|5.1.3|app-i18n|Compliance mode enabled, was '5.1.3'|
...
|fcitx5-qt|5.1.8|5.1.9|app-i18n|Compliance mode enabled, was '5.1.9'|
|fcitx5-rime|5.1.9|5.1.10|app-i18n|Compliance mode enabled, was '5.1.10'|
|fcitx5-sayura|5.1.2|5.1.3|app-i18n|Compliance mode enabled, was '5.1.3'|
|fcitx5-skk|5.1.5|5.1.6|app-i18n|Compliance mode enabled, was '5.1.6'|
|fcitx5-unikey|5.1.5|5.1.6|app-i18n|Compliance mode enabled, was '5.1.6'|
...
|folly|2024.12.30.00|2025.01.20.00|runtime-common|Compliance mode enabled, was '2025.01.20.00'|
...
|fonttools|4.53.1|4.55.6|desktop-fonts|Compliance mode enabled, was '4.55.6'|
...
|grpc|1.64.0|1.70.0|app-network|Compliance mode enabled, was '1.70.0'|
...
|hugo|0.139.3|0.142.0|app-web|Compliance mode enabled, was '0.142.0'|
...
|hypothesis-python|6.97.4|6.124.3|lang-python|Compliance mode enabled, was '6.124.3'|
...
|jenkins|2.468|2.494|app-admin|Compliance mode enabled, was '2.494'|
...
|libime|1.1.9|1.1.10|runtime-i18n|Compliance mode enabled, was '1.1.10'|
...
|libseccomp|2.5.5|2.6.0|runtime-common|Compliance mode enabled, was '2.6.0'|
...
|linux+api|6.12.7|6.12.11|core-devel|Compliance mode enabled, was '6.12.11'|
...
|m1n1|1.4.14|1.4.18|runtime-kernel||
...
|mpmath|1.1.0|1.4.0~a3|lang-python|Compliance mode enabled, was '1.4.0a3'|
...
|ncurses|6.4|6.5+20250118|runtime-common|Compliance mode enabled, was '6.5-20250118'|
|ncurses+32|6.4|6.5+20250118|runtime-optenv32|Compliance mode enabled, was '6.5-20250118'|
...
|pcsx2|1.6.0<br>+git20210825|2.3.130|app-games|Compliance mode enabled, was '2.3.130'|
...
|perl-image-exiftool|12.50|13.15|lang-perl|Compliance mode enabled, was '13.15'|
...
|qownnotes|22.6.1|25.1.5|app-web|Compliance mode enabled, was '25.1.5'|
...
|telegram-desktop|5.10.4|5.10.5|app-web|Compliance mode enabled, was '5.10.5'|
...
|v2ray-rules-dat|202412282210|202501242211|runtime-data|Compliance mode enabled, was '202501242211'<br>Versions not comparable: `202412282210` and `202501242211`|
...
|which|2.21|2.22|app-utils|Compliance mode enabled, was '2.22'|
