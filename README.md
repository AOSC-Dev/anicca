...
## Result
![Relative date](https://img.shields.io/date/1746461767?label=Updated)
...
|bleachbit|4.6.2|5.0.0|app-utils|Compliance mode enabled, was '5.0.0'|
...
|chromium|135.0.7049.95|136.0.7103.59|app-web|Compliance mode enabled, was '136.0.7103.59'|
...
|cloud-init|24.4.1|25.1.2|app-admin|Compliance mode enabled, was '25.1.2'|
...
|cryptography|40.0.0|44.0.3|lang-python|Compliance mode enabled, was '44.0.3'|
...
|cxxopts|3.2.0|3.2.1|runtime-common|Compliance mode enabled, was '3.2.1'|
...
|damo|2.4.7|2.7.8|app-admin|Compliance mode enabled, was '2.7.8'|
...
|enchant-2|2.3.1|2.8.4|app-i18n|Compliance mode enabled, was '2.8.4'|
...
|fb303|2025.03.24.00|2025.04.28.00|runtime-network|Compliance mode enabled, was '2025.04.28.00'|
|fbthrift|2025.03.10.00|2025.04.28.00|app-network|Compliance mode enabled, was '2025.04.28.00'|
...
|feeluown|4.1.10|4.1.11|app-multimedia|Compliance mode enabled, was '4.1.11'|
...
|firefox|138.0|138.0.1|app-web|Compliance mode enabled, was '138.0.1'|
...
|fizz|2025.03.24.00|2025.04.28.00|app-network|Compliance mode enabled, was '2025.04.28.00'|
...
|folly|2025.03.24.00|2025.04.28.00|runtime-common|Compliance mode enabled, was '2025.04.28.00'|
...
|gettext|0.24|0.24.1|app-devel|Compliance mode enabled, was '0.24.1'|
...
|google-api-python-client|1.7.11|2.169.0|lang-python|Compliance mode enabled, was '2.169.0'|
...
|gtk-4|4.18.4|4.18.5|desktop-gnome|Compliance mode enabled, was '4.18.5'|
...
|ibus-table|1.14.1|1.17.12|app-i18n|Compliance mode enabled, was '1.17.12'|
...
|ipython|8.32.0|9.2.0|lang-python|Compliance mode enabled, was '9.2.0'|
...
|iwd|3.2|3.7|app-network|Compliance mode enabled, was '3.7'|
...
|kddockwidgets|1.3.1|2.2.4|runtime-desktop|Compliance mode enabled, was '2.2.4'|
...
|kea|2.6.1|2.7.8|app-network|Compliance mode enabled, was '2.7.8'|
...
|kernel-tools|6.14.5|5.19.17|app-admin|Compliance mode enabled, was '5.19.17'<br>Possible downgrade from the current version (6.14.5 -> 5.19.17)|
...
|lazygit|0.48.0|0.50.0|app-vcs|Compliance mode enabled, was '0.50.0'|
...
|libclc|18.1.8|20.1.4|runtime-devices|Compliance mode enabled, was '20.1.4'|
...
|libcpuid|0.7.1|0.8.0|runtime-common|Compliance mode enabled, was '0.8.0'|
...
|libpng|1.6.44|1.6.48|runtime-imaging|Compliance mode enabled, was '1.6.48'|
|libpng+32|1.6.44|1.6.48|runtime-optenv32|Compliance mode enabled, was '1.6.48'|
...
|libvirt|10.5.0|11.3.0|app-virtualization|Compliance mode enabled, was '11.3.0'|
|libvirt-python|10.5.0|11.3.0|runtime-virtualization|Compliance mode enabled, was '11.3.0'|
...
|linux+api|6.12.23|6.12.27|core-devel|Compliance mode enabled, was '6.12.27'|
|linux+api+32|6.12.7|6.12.27|runtime-optenv32|Compliance mode enabled, was '6.12.27'|
...
|linux+kernel+lts|6.12.26|5.10.237|runtime-kernel|Compliance mode enabled, was '5.10.237'<br>Possible downgrade from the current version (6.12.26 -> 5.10.237)|
...
|llvm-18|18.1.8|20.1.4|app-devel|Compliance mode enabled, was '20.1.4'|
|llvm-19|19.1.6|20.1.4|app-devel|Compliance mode enabled, was '20.1.4'|
|llvm-runtime+wasi|18.1.8|20.1.4|runtime-wasi|Compliance mode enabled, was '20.1.4'|
...
|lxml|4.7.1|5.4.0|lang-python|Compliance mode enabled, was '5.4.0'|
...
|matplotlib-inline|0.1.7|9.2.0|lang-python|Compliance mode enabled, was '9.2.0'|
...
|mesa|25.0.4|25.0.5|runtime-display||
|mesa+32|25.0.4|25.0.5|runtime-optenv32||
|mesa-amber|21.3.9|25.0.5|runtime-display|Compliance mode enabled, was '25.0.5'|
|mesa-pvr-ddk119|22.1.3<br>+vf2sdk3.8.2|25.0.5|runtime-display|Compliance mode enabled, was '25.0.5'|
...
|mise|2025.2.8|2025.5.0|app-devel|Compliance mode enabled, was '2025.5.0'|
|mission-center|0.6.2|1.0.0|app-utils|Compliance mode enabled, was '1.0.0'|
...
|mold|2.38.0|2.39.0|app-devel|Compliance mode enabled, was '2.39.0'|
...
|multidict|5.1.0|6.4.3|lang-python|Compliance mode enabled, was '6.4.3'|
...
|mvfst|2025.03.24.00|2025.04.28.00|runtime-network|Compliance mode enabled, was '2025.04.28.00'|
...
|ncurses|6.4|6.5+20250503|runtime-common|Compliance mode enabled, was '6.5-20250503'|
|ncurses+32|6.4|6.5+20250503|runtime-optenv32|Compliance mode enabled, was '6.5-20250503'|
...
|oolite|1.90|1.91.0.7669-250505-6b11f83|app-games|Compliance mode enabled, was '1.91.0.7669-250505-6b11f83'|
...
|openai-python|1.63.2|1.77.0|lang-python|Compliance mode enabled, was '1.77.0'|
...
|openjdk-17|17.0.15-ga|17.0.16+1|lang-java||
|openjdk-21|21.0.7-ga|21.0.8+1|lang-java||
...
|pcsx2|1.6.0<br>+git20210825|2.3.322|app-games|Compliance mode enabled, was '2.3.322'|
...
|perl-crypt-openssl-rsa|0.33|0.34|lang-perl|Compliance mode enabled, was '0.34'|
...
|pip|22.3.1|25.1.1|lang-python|Compliance mode enabled, was '25.1.1'|
...
|pixman|0.43.0|0.46.0|runtime-display|Compliance mode enabled, was '0.46.0'|
...
|pkgsite-tools|0.3.4|0.4.0|app-utils|Compliance mode enabled, was '0.4.0'|
...
|poppler|25.04.0|25.05.0|runtime-doc|Compliance mode enabled, was '25.05.0'|
...
|qownnotes|22.6.1|25.5.2|app-web|Compliance mode enabled, was '25.5.2'|
...
|razergenie|0.9.0|1.3.0|app-devices|Compliance mode enabled, was '1.3.0'|
...
|rclone|1.69.1|1.69.2|app-web|Compliance mode enabled, was '1.69.2'|
...
|scipy|1.6.3|1.15.2|lang-python|Compliance mode enabled, was '1.15.2'|
...
|sdl2|2.30.4|2.32.6|runtime-multimedia|Compliance mode enabled, was '2.32.6'|
|sdl2+32|2.30.4|2.32.6|runtime-optenv32|Compliance mode enabled, was '2.32.6'|
...
|setuptools-python2|44.1.0|80.3.1|lang-python|Compliance mode enabled, was '80.3.1'|
|setuptools-python3|75.8.0|80.3.1|lang-python|Compliance mode enabled, was '80.3.1'|
...
|sing-box|1.11.9|1.11.10|app-network|Compliance mode enabled, was '1.11.10'|
...
|sqlcipher|4.5.6|4.8.0|app-database|Compliance mode enabled, was '4.8.0'|
...
|sslh|1.19c|2.2.3|app-network|Compliance mode enabled, was '2.2.3'|
...
|twm|1.0.11|1.0.13|desktop-wm|Compliance mode enabled, was '1.0.13'|
...
|typing-extensions|4.12.2|4.13.2|lang-python|Compliance mode enabled, was '4.13.2'|
...
|uim|1.8.8|1.9.3|app-i18n|Compliance mode enabled, was '1.9.3'|
...
|v2ray-rules-dat|202501302211|202505042212|runtime-data|Compliance mode enabled, was '202505042212'<br>Versions not comparable: `202501302211` and `202505042212`|
...
|vscodium|1.99.32704|1.99.32846|app-editors|Compliance mode enabled, was '1.99.32846'|
...
|wangle|2025.03.24.00|2025.04.28.00|runtime-network|Compliance mode enabled, was '2025.04.28.00'|
|warpinator|1.6.3|1.8.8|desktop-cinnamon|Compliance mode enabled, was '1.8.8'|
|warzone2100|4.5.3|4.5.5|app-games||
|watchman|2025.03.24.00|2025.04.28.00|groups|Compliance mode enabled, was '2025.04.28.00'|
...
|yq|4.45.1|4.45.2|app-devel|Compliance mode enabled, was '4.45.2'|
...
|zed|0.183.10|0.184.10|app-editors|Compliance mode enabled, was '0.184.10'|
